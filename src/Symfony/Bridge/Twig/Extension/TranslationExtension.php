...
class TranslationExtension extends AbstractExtension
{
    ...
    private \Twig\NodeVisitor\NodeVisitorInterface|null|\Symfony\Bridge\Twig\NodeVisitor\TranslationNodeVisitor $translationNodeVisitor = null;
    ...
    public function transchoice($message, $count, array $arguments = [], $domain = null, $locale = null)
    {
        ...
        return $this->translator->transChoice($message, $count, ['%count%' => $count, ...$arguments], $domain, $locale);
    }
