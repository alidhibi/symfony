...
class DoctrineExtensionTest extends TestCase
{
    ...
    public function testFixManagersAutoMappings(array $originalEm1, array $originalEm2, array $expectedEm1, array $expectedEm2)
    {
        ...
        $this->assertEquals($newEmConfigs['em1'], ['auto_mapping' => false, ...$expectedEm1]);
        $this->assertEquals($newEmConfigs['em2'], ['auto_mapping' => false, ...$expectedEm2]);
    }
    ...
    {
        return new ContainerBuilder(new ParameterBag(['kernel.bundles' => ['FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle'], 'kernel.cache_dir' => __DIR__, 'kernel.debug' => false, 'kernel.environment' => 'test', 'kernel.name' => 'kernel', 'kernel.root_dir' => __DIR__, ...$data]));
    }
}
