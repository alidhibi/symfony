...
{
    private \Symfony\Bridge\Doctrine\PropertyInfo\DoctrineExtractor $extractor;
    ...
    public function testGetProperties()
    {
        ...
        // Associations
        $expected = [...$expected, 'foo', 'bar', 'indexedRguid', 'indexedBar', 'indexedFoo', 'indexedBaz', 'indexedByDt', 'indexedByCustomType', 'indexedBuz'];
