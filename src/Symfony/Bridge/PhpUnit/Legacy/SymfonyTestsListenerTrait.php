...
class SymfonyTestsListenerTrait
{
    ...
    private int $state = -1;
    private string|array|bool $skippedFile = false;
    private $wasSkipped = array();
    private array $isSkipped = array();
    private $expectedDeprecations = array();
    private array $gatheredDeprecations = array();
    private $previousErrorHandler;
    private ?array $testsWithWarnings = null;
    private $error;
    private string|bool $runsInSeparateProcess = false;
