...
class UrlGenerator implements UrlGeneratorInterface, ConfigurableRequirementsInterface
{
     ...
     * @return string|null
     */
    protected function doGenerate($variables, array $defaults, $requirements, $tokens, $parameters, $name, $referenceType, $hostTokens, array $requiredSchemes = [])
    {
        ...
        if ((self::ABSOLUTE_URL === $referenceType || self::NETWORK_PATH === $referenceType) && ('' !== $host || ('' !== $scheme && 'http' !== $scheme && 'https' !== $scheme))) {
            $port = '';
