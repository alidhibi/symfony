...
class RouteTest extends TestCase
{
    ...
    public function testOptions(): void
    {
        ...
        $this->assertEquals(['compiler_class' => \Symfony\Component\Routing\RouteCompiler::class, 'foo' => 'bar'], $route->getOptions(), '->setOptions() sets the options');
        ...
        $this->assertEquals(['foo' => 'foo', 'bar' => 'bar', 'compiler_class' => \Symfony\Component\Routing\RouteCompiler::class], $route->getOptions(), '->addDefaults() keep previous defaults');
    }
    ...
    public function testDefaults(): void
    {
        ...
        $route->setDefault('_controller', $closure = static fn(): string => 'Hello');
     ...
     */
    public function testSetInvalidRequirement(string|array $req): void
    {
     ...
     */
    public function testSerializeWhenCompiledWithClass(): void
    {
        $route = new Route('/', [], [], ['compiler_class' => '\\' . \Symfony\Component\Routing\Tests\Fixtures\CustomRouteCompiler::class]);
        $this->assertInstanceOf('\\' . \Symfony\Component\Routing\Tests\Fixtures\CustomCompiledRoute::class, $route->compile(), '->compile() returned a proper route');

        $serialized = serialize($route);
        try {
            $unserialized = unserialize($serialized);
            $this->assertInstanceOf('\\' . \Symfony\Component\Routing\Tests\Fixtures\CustomCompiledRoute::class, $unserialized->compile(), 'the unserialized route compiled successfully');
     ...
     */
    public function testSerializedRepresentationKeepsWorking(): void
    {
