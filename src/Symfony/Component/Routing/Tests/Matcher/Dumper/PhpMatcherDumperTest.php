...
class PhpMatcherDumperTest extends TestCase
{
    ...
    public function getRouteCollections(): array
    {
        ...
        return [
           ...
           [$redirectCollection, 'url_matcher2.php', ['base_class' => \Symfony\Component\Routing\Tests\Fixtures\RedirectableUrlMatcher::class]],
           [$rootprefixCollection, 'url_matcher3.php', []],
           [$headMatchCasesCollection, 'url_matcher4.php', []],
           [$groupOptimisedCollection, 'url_matcher5.php', ['base_class' => \Symfony\Component\Routing\Tests\Fixtures\RedirectableUrlMatcher::class]],
           [$trailingSlashCollection, 'url_matcher6.php', []],
           [$trailingSlashCollection, 'url_matcher7.php', ['base_class' => \Symfony\Component\Routing\Tests\Fixtures\RedirectableUrlMatcher::class]],
        ];
    }

    private function generateDumpedMatcher(RouteCollection $collection, bool $redirectableStub = false): string
    {
        $options = ['class' => $this->matcherClass];

        if ($redirectableStub) {
            $options['base_class'] = '\\' . \Symfony\Component\Routing\Tests\Matcher\Dumper\RedirectableUrlMatcherStub::class;
        }
...
{
    public function redirect($path, $route, $scheme = null): void
    {
    }
}
