...
class TraceableUrlMatcherTest extends UrlMatcherTest
{
     ...
     * @return mixed[]
     */
    public function getLevels($traces): array
    {
        $levels = [];
    ...
    protected function getUrlMatcher(RouteCollection $routes, RequestContext $context = null): \Symfony\Component\Routing\Matcher\TraceableUrlMatcher
    {
