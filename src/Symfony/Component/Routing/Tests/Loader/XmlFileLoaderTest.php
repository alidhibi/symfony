...
class XmlFileLoaderTest extends TestCase
{
    ...
    {
        $loader = new XmlFileLoader($this->getMockBuilder(\Symfony\Component\Config\FileLocator::class)->getMock());
    ...
    public function testUtf8Route(): void
    {
     ...
     * @dataProvider getPathsToInvalidFiles
     */
    public function testLoadThrowsExceptionWithInvalidFileEvenWithoutSchemaValidation(string $filePath): void
    {
        $this->expectException('InvalidArgumentException');
