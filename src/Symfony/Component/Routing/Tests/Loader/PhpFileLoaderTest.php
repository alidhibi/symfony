...
class PhpFileLoaderTest extends TestCase
{
    ...
    {
        $loader = new PhpFileLoader($this->getMockBuilder(\Symfony\Component\Config\FileLocator::class)->getMock());
    ...
    public function testThatDefiningVariableInConfigFileHasNoSideEffects(): void
    {
        ...
        $this->assertContainsOnly(\Symfony\Component\Config\Resource\ResourceInterface::class, $resources);
