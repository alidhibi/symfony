...
class AnnotationClassLoaderTest extends AbstractAnnotationLoaderTest
{
    ...
    {
        $this->expectException('InvalidArgumentException');
        $this->loader->load(\Symfony\Component\Routing\Tests\Fixtures\AnnotatedClasses\AbstractClass::class);
    }

    /**
     * @dataProvider provideTestSupportsChecksResource
     */
    public function testSupportsChecksResource(?string $resource, bool $expectedSupports): void
    {
     ...
     */
    public function testLoad(string $className, array $routeData = [], array $methodArgs = []): void
    {
    ...
    public function testClassRouteLoad(): void
    {
        ...
        $routeCollection = $this->loader->load(\Symfony\Component\Routing\Tests\Fixtures\AnnotatedClasses\BarClass::class);
    ...
    public function testInvokableClassRouteLoadWithMethodAnnotation(): void
    {
        $classRouteData = [
            'name' => 'route1',
            'path' => '/',
        ...
        $routeCollection = $this->loader->load(\Symfony\Component\Routing\Tests\Fixtures\AnnotatedClasses\BazClass::class);
    ...
    public function testInvokableClassRouteLoadWithClassAnnotation(): void
    {
        $classRouteData = [
            'name' => 'route1',
            'path' => '/',
    ...
    public function testDefaultRouteName(): void
    {
        ...
        $routeCollection = $this->loader->load(\Symfony\Component\Routing\Tests\Fixtures\AnnotatedClasses\EncodingClass::class);
    ...
    private function getAnnotatedRoute($data): \Symfony\Component\Routing\Annotation\Route
    {
