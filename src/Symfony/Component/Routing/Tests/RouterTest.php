...
{
    private ?\Symfony\Component\Routing\Router $router = null;
    ...
    public function provideMatcherOptionsPreventingCaching(): array
    {
        return [
            ['cache_dir'],
            ['matcher_cache_class'],
    ...
    public function provideGeneratorOptionsPreventingCaching(): array
    {
        return [
            ['cache_dir'],
