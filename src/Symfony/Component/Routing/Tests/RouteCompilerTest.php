...
class RouteCompilerTest extends TestCase
{
    ...
    {
        $r = new \ReflectionClass(\Symfony\Component\Routing\Route::class);
     ...
     */
    public function testCompileImplicitUtf8Data(string $name, array $arguments, string $prefix, string $regex, array $variables, array $tokens, string $deprecationType): void
    {
        $r = new \ReflectionClass(\Symfony\Component\Routing\Route::class);
        $route = $r->newInstanceArgs($arguments);
    ...
    public function provideCompileImplicitUtf8Data(): array
    {
        return [
            [
                'Static UTF-8 route',
     ...
     */
    public function testRouteWithVariableNameStartingWithADigit(string $name): void
    {
    ...
    public function getVariableNamesStartingWithADigit(): array
    {
        return [
           ['09'],
           ['123'],
     ...
     */
    public function testCompileWithHost(string $name, array $arguments, string $prefix, string $regex, array $variables, array $pathVariables, array $tokens, string $hostRegex, array $hostVariables, array $hostTokens): void
    {
        $r = new \ReflectionClass(\Symfony\Component\Routing\Route::class);
        $route = $r->newInstanceArgs($arguments);
    ...
    public function provideCompileWithHostData(): array
    {
        return [
            [
