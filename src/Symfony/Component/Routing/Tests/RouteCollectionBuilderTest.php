...
class RouteCollectionBuilderTest extends TestCase
{
    public function testImport(): void
    {
        ...
        $this->assertInstanceOf(\Symfony\Component\Routing\RouteCollectionBuilder::class, $importedRoutes);
    ...
    public function testAdd(): void
    {
        ...
        $this->assertInstanceOf(\Symfony\Component\Routing\Route::class, $addedRoute);
     ...
     */
    public function testFlushPrefixesPaths(string $collectionPrefix, string $routePath, string $expectedPath): void
    {
        $routes = new RouteCollectionBuilder();
    ...
    public function providePrefixTests(): array
    {
        return [
    ...
    public function testAddsThePrefixOnlyOnceWhenLoadingMultipleCollections(): void
    {
