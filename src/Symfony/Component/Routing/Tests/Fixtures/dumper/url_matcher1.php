...
class ProjectUrlMatcher extends Symfony\Component\Routing\Matcher\UrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        // route3
        if (preg_match('#^b\\.example\\.com$#sDi', $host, $hostMatches) && '/c2/route3' === $pathinfo) {
            return ['_route' => 'route3'];

        }

        // route4
        if (preg_match('#^a\\.example\\.com$#sDi', $host, $hostMatches) && '/route4' === $pathinfo) {
            return ['_route' => 'route4'];

        }

        // route5
        if (preg_match('#^c\\.example\\.com$#sDi', $host, $hostMatches) && '/route5' === $pathinfo) {
        ...
        if (preg_match('#^(?P<var1>[^\\.]++)\\.example\\.com$#sDi', $host, $hostMatches) && 0 === strpos($pathinfo, '/route1')) {
            // route11
            if ('/route11' === $pathinfo) {
        ...
        // route15
        if (preg_match('#^c\\.example\\.com$#sDi', $host, $hostMatches) && (0 === strpos($pathinfo, '/route15') && preg_match('#^/route15/(?P<name>[^/]++)$#sD', $pathinfo, $matches))) {
