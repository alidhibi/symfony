...
class RouteCompiler implements RouteCompilerInterface
{
     ...
     * @internal
     */
    final const VARIABLE_MAXIMUM_LENGTH = 32;
     ...
     *                                   a PCRE subpattern
     */
    public static function compile(Route $route): \Symfony\Component\Routing\CompiledRoute
    {
        $hostVariables = [];
        $variables = [];
        $hostRegex = null;
     ...
     */
    private static function findNextSeparator(array $pattern, $useUtf8)
    {
        if ('' == $pattern) {
    ...
    private static function computeRegexp(array $tokens, $index, $firstOptional)
    {
        ...
        } elseif (0 === $index && 0 === $firstOptional) {
            // Variable tokens
