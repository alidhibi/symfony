...
class Route implements \Serializable
{
     ...
     * @return $this
     */
    public function setPath($pattern): static
    {
     ...
     */
    public function hasScheme($scheme): bool
    {
     ...
     * @return $this
     */
    public function setDefault($name, $default): static
    {
        $this->defaults[$name] = $default;
        $this->compiled = null;
    ...
    private function sanitizeRequirement($key, $regex): string
    {
        if (!\is_string($regex)) {
