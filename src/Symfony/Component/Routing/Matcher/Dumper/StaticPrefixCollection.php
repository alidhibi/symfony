...
class StaticPrefixCollection
{
     ...
     * @param mixed  $route
     */
    public function addRoute($prefix, $route): void
    {
     ...
     *
     */
    private function groupWithItem(array $item, string $prefix, $route): ?\Symfony\Component\Routing\Matcher\Dumper\StaticPrefixCollection
    {
     ...
     */
    private function accepts($prefix): bool
    {
     ...
     */
    private function detectCommonPrefix($prefix, $anotherPrefix): string|bool
    {
