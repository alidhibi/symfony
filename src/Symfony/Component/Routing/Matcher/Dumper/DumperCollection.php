...
{
    private ?\Symfony\Component\Routing\Matcher\Dumper\DumperCollection $parent = null;
    ...
    {
        return ($this->parent instanceof \Symfony\Component\Routing\Matcher\Dumper\DumperCollection) ? $this->parent->getRoot() : $this;
    }
     ...
     */
    protected function getParent(): ?\Symfony\Component\Routing\Matcher\Dumper\DumperCollection
    {
        return $this->parent;
    }
