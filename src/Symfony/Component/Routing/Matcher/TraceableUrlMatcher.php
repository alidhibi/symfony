...
{
    final const ROUTE_DOES_NOT_MATCH = 0;

    final const ROUTE_ALMOST_MATCHES = 1;

    final const ROUTE_MATCHES = 2;
    ...
    private function addTrace(string $log, int $level = self::ROUTE_DOES_NOT_MATCH, $name = null, $route = null): void
    {
        $this->traces[] = [
            'log' => $log,
            'name' => $name,
