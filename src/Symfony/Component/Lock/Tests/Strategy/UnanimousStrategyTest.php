...
{
    private \Symfony\Component\Lock\Strategy\UnanimousStrategy $strategy;
    ...
    public function provideMetResults(): \Generator
    {
    ...
    public function provideIndeterminate(): \Generator
    {
     ...
     */
    public function testMet(int $success, int $failure, int $total, bool $isMet): void
    {
     ...
     */
    public function testCanBeMet(int $success, int $failure, int $total, bool $isMet): void
    {
