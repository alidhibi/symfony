...
trait ExpiringStoreTestTrait
{
    ...
    public function testExpiration(): void
    {
        ...
        $store->save($key);
        $store->putOffExpiration($key, 2 * $clockDelay / 1_000_000);
    ...
    {
        $this->expectException('\\' . \Symfony\Component\Lock\Exception\LockExpiredException::class);
        $key = new Key(uniqid(__METHOD__, true));
        ...
        $store->save($key);
        $store->putOffExpiration($key, 1 / 1_000_000);
    }
