...
{
    final const FORMAT = 'csv';

    final const DELIMITER_KEY = 'csv_delimiter';

    final const ENCLOSURE_KEY = 'csv_enclosure';

    final const ESCAPE_CHAR_KEY = 'csv_escape_char';

    final const KEY_SEPARATOR_KEY = 'csv_key_separator';

    final const HEADERS_KEY = 'csv_headers';
    ...
    public function encode($data, $format, array $context = []): string|bool
    {
        ...
        $headers = [...array_values($headers), ...array_diff($this->extractHeaders($data), $headers)];
