...
{
    public static function createClassMetadata($withParent = false, $withInterface = false): \Symfony\Component\Serializer\Mapping\ClassMetadata
    {
        $expected = new ClassMetadata(\Symfony\Component\Serializer\Tests\Fixtures\GroupDummy::class);
    ...
    public static function createXmlCLassMetadata(): \Symfony\Component\Serializer\Mapping\ClassMetadata
    {
        $expected = new ClassMetadata(\Symfony\Component\Serializer\Tests\Fixtures\GroupDummy::class);
