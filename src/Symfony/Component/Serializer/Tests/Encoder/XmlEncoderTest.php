...
XML;
        ...
        $this->assertSame(['@index' => 182_077_241_760_011_681_341_821_060_401_202_210_011_000_045_913_000_000_017_100.0, '#' => 'Name'], $this->encoder->decode($source, 'xml'));
    }
...
XML;
    ...
    public function testDecodeFloatAttributeWithZeroWholeNumber(): void
    {
        $source = <<<XML
<?xml version="1.0"?>
...
XML;
    ...
    public function testDoesNotTypeCastStringsStartingWith0(): void
    {
        $source = <<<XML
<?xml version="1.0"?>
...
XML;
    ...
    protected function getObject(): \Symfony\Component\Serializer\Tests\Fixtures\Dummy
    {
        $obj = new Dummy();
        $obj->foo = 'foo';
        $obj->bar = ['a', 'b'];
...
XML;
    ...
    public function testEncodeXmlWithDomNodeValue(): void
    {
        $expectedXml = <<<'XML'
<?xml version="1.0"?>
...
XML;
    ...
    public function testNotEncodableValueExceptionMessageForAResource(): void
    {
    ...
    private function createXmlEncoderWithDateTimeNormalizer(): \Symfony\Component\Serializer\Encoder\XmlEncoder
    {
    ...
    {
        $mock = $this->getMockBuilder('\\' . \Symfony\Component\Serializer\Normalizer\CustomNormalizer::class)->getMock();
