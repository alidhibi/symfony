...
{
    final const TEST_GIF_DATA = 'data:image/gif;base64,R0lGODdhAQABAIAAAP///////ywAAAAAAQABAAACAkQBADs=';

    final const TEST_TXT_DATA = 'data:text/plain,K%C3%A9vin%20Dunglas%0A';

    final const TEST_TXT_CONTENT = "Kévin Dunglas\n";

    private \Symfony\Component\Serializer\Normalizer\DataUriNormalizer $normalizer;
    ...
    public function testSupportsDenormalization(): void
    {
        ...
        $this->assertTrue($this->normalizer->supportsDenormalization(self::TEST_TXT_DATA, \Symfony\Component\HttpFoundation\File\File::class));
    }
    ...
    {
        $file = $this->normalizer->denormalize(self::TEST_GIF_DATA, \Symfony\Component\HttpFoundation\File\File::class);
     ...
     */
    public function testValidData($uri): void
    {
