...
{
    protected \Symfony\Component\Serializer\Encoder\ChainEncoder $encoder;

    protected \Symfony\Component\Serializer\Encoder\ChainDecoder $decoder;
    ...
    public function normalize($data, $format = null, array $context = [])
    {
        ...
        if (($normalizer = $this->getNormalizer($data, $format, $context)) !== null) {
        ...
        throw new NotNormalizableValueException('An unexpected value could not be normalized: '.(\is_resource($data) ? sprintf('%s resource', get_resource_type($data)) : var_export($data, true)));
    }
    ...
    public function denormalize($data, $type, $format = null, array $context = [])
    {
        ...
        if (($normalizer = $this->getDenormalizer($data, $type, $format, $context)) !== null) {
     ...
     *
     */
    private function getNormalizer($data, $format, array $context): ?\Symfony\Component\Serializer\Normalizer\NormalizerInterface
    {
     ...
     *
     */
    private function getDenormalizer($data, $class, $format, array $context): ?\Symfony\Component\Serializer\Normalizer\DenormalizerInterface
    {
        foreach ($this->normalizers as $normalizer) {
