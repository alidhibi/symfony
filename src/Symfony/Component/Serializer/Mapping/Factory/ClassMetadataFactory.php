...
class ClassMetadataFactory implements ClassMetadataFactoryInterface
{
    ...
    private readonly \Symfony\Component\Serializer\Mapping\Loader\LoaderInterface $loader;

    private ?\Doctrine\Common\Cache\Cache $cache = null;
    ...
    public function getMetadataFor($value)
    {
        ...
        if ($this->cache instanceof \Doctrine\Common\Cache\Cache) {
