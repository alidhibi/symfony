...
class ExpressionLanguageTest extends TestCase
{
     ...
     */
    public function testIsAuthenticated(\Symfony\Component\Security\Core\Authentication\Token\AnonymousToken|\Symfony\Component\Security\Core\Authentication\Token\RememberMeToken|\Symfony\Component\Security\Core\Authentication\Token\UsernamePasswordToken|null $token, string $expression, bool $result, array $roles = []): void
    {
        $anonymousTokenClass = \Symfony\Component\Security\Core\Authentication\Token\AnonymousToken::class;
        $rememberMeTokenClass = \Symfony\Component\Security\Core\Authentication\Token\RememberMeToken::class;
