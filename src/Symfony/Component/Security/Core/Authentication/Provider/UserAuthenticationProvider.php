    ...
    public function authenticate(TokenInterface $token)
    {
        ...
        try {
            ...
            if ($this->hideUserNotFoundExceptions) {
                throw new BadCredentialsException('Bad credentials.', 0, $usernameNotFoundException);
            }

            $usernameNotFoundException->setUsername($username);
        ...
        try {
            ...
            if ($this->hideUserNotFoundExceptions && ($authenticationException instanceof AccountStatusException || $authenticationException instanceof BadCredentialsException)) {
