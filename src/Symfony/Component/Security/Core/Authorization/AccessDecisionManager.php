...
{
    final const STRATEGY_AFFIRMATIVE = 'affirmative';

    final const STRATEGY_CONSENSUS = 'consensus';

    final const STRATEGY_UNANIMOUS = 'unanimous';

    private $voters;

    private readonly string $strategy;

    private readonly bool $allowIfAllAbstainDecisions;

    private readonly bool $allowIfEqualGrantedDeniedDecisions;
     ...
     */
    private function vote($voter, TokenInterface $token, $subject, array $attributes)
    {
