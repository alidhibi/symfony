...
{
    private readonly \Symfony\Component\Ldap\LdapInterface $ldap;
    ...
    private readonly array|string $defaultSearch;
    ...
    public function loadUserByUsername($username)
    {
        try {
            ...
            throw new UsernameNotFoundException(sprintf('User "%s" not found.', $username), 0, $connectionException);
        }
     ...
     *
     */
    protected function loadUser($username, Entry $entry): \Symfony\Component\Security\Core\User\User
    {
        $password = null;
