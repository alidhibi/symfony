...
{
    private readonly \Symfony\Component\Security\Core\Authentication\Token\TokenInterface $source;
     ...
     */
    public function getSource(): \Symfony\Component\Security\Core\Authentication\Token\TokenInterface
    {
        return $this->source;
    }
}
