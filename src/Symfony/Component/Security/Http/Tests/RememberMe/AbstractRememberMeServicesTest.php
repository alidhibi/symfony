...
class AbstractRememberMeServicesTest extends TestCase
{
    ...
    public function testAutoLoginReturnsNullAfterLoginFail(): void
    {
        $service = $this->getService(null, ['name' => 'foo', 'path' => null, 'domain' => null]);
    ...
    public function provideOptionsForLogout(): array
    {
        return [
     ...
     */
    public function testLoginSuccessWhenRememberMeParameterWithPathIsPositive(string|bool $value): void
    {
     ...
     * @dataProvider getPositiveRememberMeParameterValues
     */
    public function testLoginSuccessWhenRememberMeParameterIsPositive(string|bool $value): void
    {
        $service = $this->getService(null, ['name' => 'foo', 'always_remember_me' => false, 'remember_me_parameter' => 'foo', 'path' => null, 'domain' => null]);
    ...
    public function getPositiveRememberMeParameterValues(): array
    {
        return [
            ['true'],
            ['1'],
    ...
    protected function getService($userProvider = null, $options = [], $logger = null)
    {
        ...
        return $this->getMockForAbstractClass(\Symfony\Component\Security\Http\RememberMe\AbstractRememberMeServices::class, [
