...
class CsrfTokenClearingLogoutHandlerTest extends TestCase
{
    ...
    private \Symfony\Component\Security\Csrf\TokenStorage\SessionTokenStorage $csrfTokenStorage;

    private \Symfony\Component\Security\Http\Logout\CsrfTokenClearingLogoutHandler $csrfTokenClearingLogoutHandler;
    ...
    public function testCsrfTokenCookieWithSameNamespaceIsRemoved(): void
    {
    ...
    public function testCsrfTokenCookieWithDifferentNamespaceIsNotRemoved(): void
    {
