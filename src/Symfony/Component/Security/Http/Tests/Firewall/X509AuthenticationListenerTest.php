...
class X509AuthenticationListenerTest extends TestCase
{
     ...
     */
    public function testGetPreAuthenticatedData(string $user, string $credentials): void
    {
        $serverVars = [];
        if ('' !== $user) {
    ...
    public static function dataProviderGetPreAuthenticatedData(): array
    {
        return [
     ...
     */
    public function testGetPreAuthenticatedDataNoUser(string $emailAddress, string $credentials): void
    {
    ...
    public static function dataProviderGetPreAuthenticatedDataNoUser(): \Generator
    {
