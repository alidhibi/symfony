...
{
    private ?\Symfony\Component\Security\Http\Firewall\UsernamePasswordJsonAuthenticationListener $listener = null;

    private function createListener(array $options = [], bool $success = true, bool $matchCheckPath = true): void
    {
    ...
    public function testNoErrorOnMissingSessionStrategy(): void
    {
        $this->createListener();
        $request = new Request([], [], [], [], [], ['HTTP_CONTENT_TYPE' => 'application/json'], '{"username": "dunglas", "password": "foo"}');
    ...
    public function testMigratesViaSessionStrategy(): void
    {
        $this->createListener();
        $request = new Request([], [], [], [], [], ['HTTP_CONTENT_TYPE' => 'application/json'], '{"username": "dunglas", "password": "foo"}');
        $this->configurePreviousSession($request);
    ...
    private function configurePreviousSession(Request $request): void
    {
