...
class TokenBasedRememberMeServices extends AbstractRememberMeServices
{
    ...
    protected function processAutoLoginCookie(array $cookieParts, Request $request)
    {
        ...
        if (!hash_equals($this->generateCookieHash($class, $username, $expires, $user->getPassword()), $hash)) {
     ...
     *
     */
    protected function generateCookieHash(string $class, string $username, $expires, $password): string
    {
