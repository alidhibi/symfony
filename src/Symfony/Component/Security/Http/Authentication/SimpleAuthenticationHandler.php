...
{
    protected \Symfony\Component\Security\Http\Authentication\AuthenticationSuccessHandlerInterface $successHandler;

    protected \Symfony\Component\Security\Http\Authentication\AuthenticationFailureHandlerInterface $failureHandler;

    protected \Symfony\Component\Security\Core\Authentication\SimpleAuthenticatorInterface $simpleAuthenticator;
