...
class HttpUtils
{
    ...
    private \Symfony\Component\Routing\Matcher\UrlMatcherInterface|\Symfony\Component\Routing\Matcher\RequestMatcherInterface|null $urlMatcher = null;
     ...
     */
    public function createRedirectResponse(Request $request, $path, $status = 302): \Symfony\Component\HttpFoundation\RedirectResponse
    {
     ...
     */
    public function checkRequestPath(Request $request, $path): bool
    {
        if ('/' !== $path[0]) {
            try {
    ...
    public function generateUri($request, $path)
    {
        ...
        if (!$this->urlGenerator instanceof \Symfony\Component\Routing\Generator\UrlGeneratorInterface) {
