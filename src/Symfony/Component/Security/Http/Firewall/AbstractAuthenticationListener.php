...
abstract class AbstractAuthenticationListener implements ListenerInterface
{
    ...
    protected \Symfony\Component\Security\Core\Authentication\AuthenticationManagerInterface $authenticationManager;

    protected $providerKey;

    protected \Symfony\Component\Security\Http\HttpUtils $httpUtils;
    ...
    private readonly \Symfony\Component\Security\Http\Authentication\AuthenticationSuccessHandlerInterface $successHandler;

    private readonly \Symfony\Component\Security\Http\Authentication\AuthenticationFailureHandlerInterface $failureHandler;
    ...
    public function __construct(TokenStorageInterface $tokenStorage, AuthenticationManagerInterface $authenticationManager, SessionAuthenticationStrategyInterface $sessionStrategy, HttpUtils $httpUtils, $providerKey, AuthenticationSuccessHandlerInterface $successHandler, AuthenticationFailureHandlerInterface $failureHandler, array $options = [], LoggerInterface $logger = null, EventDispatcherInterface $dispatcher = null)
    {
        ...
        $this->options = ['check_path' => '/login_check', 'login_path' => '/login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false, 'failure_path' => null, 'failure_forward' => false, 'require_previous_session' => true, ...$options];
        $this->logger = $logger;
    ...
    final public function handle(GetResponseEvent $event): void
    {
        ...
        try {
            ...
            $response = $this->onFailure($request, $authenticationException);
        }
