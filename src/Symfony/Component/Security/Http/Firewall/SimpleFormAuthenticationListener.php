...
{
    private readonly \Symfony\Component\Security\Http\Authentication\SimpleFormAuthenticatorInterface $simpleAuthenticator;

    private ?\Symfony\Component\Security\Csrf\CsrfTokenManagerInterface $csrfTokenManager = null;
    ...
    {
        if (!$simpleAuthenticator instanceof \Symfony\Component\Security\Http\Authentication\SimpleFormAuthenticatorInterface) {
        ...
        $options = ['username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true, ...$options];
    ...
    {
        if ($this->csrfTokenManager instanceof \Symfony\Component\Security\Csrf\CsrfTokenManagerInterface) {
