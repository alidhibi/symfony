...
class SimplePreAuthenticationListener implements ListenerInterface
{
    ...
    private \Symfony\Component\Security\Core\Authentication\AuthenticationManagerInterface $authenticationManager;
    private $providerKey;
    private \Symfony\Component\Security\Http\Authentication\SimplePreAuthenticatorInterface $simpleAuthenticator;
