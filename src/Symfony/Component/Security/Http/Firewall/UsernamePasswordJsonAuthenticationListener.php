...
class UsernamePasswordJsonAuthenticationListener implements ListenerInterface
{
    ...
    private ?\Symfony\Component\Security\Http\Authentication\AuthenticationSuccessHandlerInterface $successHandler = null;

    private ?\Symfony\Component\Security\Http\Authentication\AuthenticationFailureHandlerInterface $failureHandler = null;
    ...
    public function __construct(TokenStorageInterface $tokenStorage, AuthenticationManagerInterface $authenticationManager, HttpUtils $httpUtils, $providerKey, AuthenticationSuccessHandlerInterface $successHandler = null, AuthenticationFailureHandlerInterface $failureHandler = null, array $options = [], LoggerInterface $logger = null, EventDispatcherInterface $eventDispatcher = null, PropertyAccessorInterface $propertyAccessor = null)
    {
        ...
        $this->options = ['username_path' => 'username', 'password_path' => 'password', ...$options];
    ...
    private function onSuccess(Request $request, TokenInterface $token): ?\Symfony\Component\HttpFoundation\Response
    {
        ...
        if (!$this->successHandler instanceof \Symfony\Component\Security\Http\Authentication\AuthenticationSuccessHandlerInterface) {
    ...
    private function onFailure(Request $request, AuthenticationException $failed): \Symfony\Component\HttpFoundation\Response
    {
        if ($this->logger instanceof \Psr\Log\LoggerInterface) {
        ...
        if (!$this->failureHandler instanceof \Symfony\Component\Security\Http\Authentication\AuthenticationFailureHandlerInterface) {
