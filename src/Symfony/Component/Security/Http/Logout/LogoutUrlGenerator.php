...
class LogoutUrlGenerator
{
     ...
     * @return string The logout URL
     */
    private function generateLogoutUrl($key, int $referenceType)
    {
        ...
        if ('/' === $logoutPath[0]) {
            ...
            if (!$this->router instanceof \Symfony\Component\Routing\Generator\UrlGeneratorInterface) {
