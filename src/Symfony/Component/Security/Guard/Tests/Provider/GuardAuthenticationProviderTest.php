...
class GuardAuthenticationProviderTest extends TestCase
{
    ...
    public function testLegacyAuthenticate(): void
    {
        ...
        $authenticatorC = $this->getMockBuilder(\Symfony\Component\Security\Guard\GuardAuthenticatorInterface::class)->getMock();
        $authenticators = [$authenticatorA, $authenticatorB, $authenticatorC];
        ...
        $mockedUser = $this->getMockBuilder(\Symfony\Component\Security\Core\User\UserInterface::class)->getMock();
        $authenticatorB->expects($this->once())
            ->method('getUser')
            ->with($enteredCredentials, $this->userProvider)
            ->willReturn($mockedUser);
    ...
    public function testSupportsChecksGuardAuthenticatorsTokenOrigin(): void
    {
        $authenticatorA = $this->getMockBuilder(AuthenticatorInterface::class)->getMock();
        $authenticatorB = $this->getMockBuilder(AuthenticatorInterface::class)->getMock();
    ...
    public function testAuthenticateFailsOnNonOriginatingToken(): void
    {
    ...
    protected function setUp()
    {
        ...
        $this->preAuthenticationToken = $this->getMockBuilder(\Symfony\Component\Security\Guard\Token\PreAuthenticationGuardToken::class)
