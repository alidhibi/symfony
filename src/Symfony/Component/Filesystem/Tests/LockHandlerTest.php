...
class LockHandlerTest extends TestCase
{
    ...
    public function testErrorHandlingInLockIfLockPathBecomesUnwritable(): void
    {
        ...
        $this->assertInstanceOf(\Symfony\Component\Filesystem\Exception\IOException::class, $e, sprintf('Expected IOException to be thrown, got %s instead.', \get_class($e)));
