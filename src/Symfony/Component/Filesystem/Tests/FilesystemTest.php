...
class FilesystemTest extends FilesystemTestCase
{
    ...
    public function testRemoveThrowsExceptionOnPermissionDenied(): void
    {
        ...
        try {
            ...
            $this->assertStringContainsString('Failed to remove file "'.$file.'"', $ioException->getMessage());
            $this->assertStringContainsString('Permission denied', $ioException->getMessage());
        } finally {
     ...
     */
    public function testMakePathRelative(string $endPath, string $startPath, $expectedPath): void
    {
    ...
    public function providePathsForMakePathRelative(): array
    {
        $paths = [
     ...
     */
    public function testMakePathRelativeWithRelativePaths(string $endPath, string $startPath, string $expectedPath): void
    {
        $path = $this->filesystem->makePathRelative($endPath, $startPath);
    ...
    public function provideLegacyPathsForMakePathRelativeWithRelativePaths(): array
    {
        return [
            ['usr/lib/symfony/', 'var/lib/symfony/src/Symfony/Component', '../../../../../../usr/lib/symfony/'],
            ['aa/bb', 'aa/cc', '../bb/'],
     ...
     */
    public function testIsAbsolutePath(string $path, bool $expectedResult): void
    {
    ...
    public function providePathsForIsAbsolutePath(): array
    {
        return [
            ['/var/lib', true],
            ['c:\\\\var\\lib', true],
    ...
    {
        stream_wrapper_register('mock', \Symfony\Component\Filesystem\Tests\Fixtures\MockStream\MockStream::class);
    ...
    public function testDumpFileWithArray(): void
    {
        $filename = $this->workspace.\DIRECTORY_SEPARATOR.'foo'.\DIRECTORY_SEPARATOR.'baz.txt';
    ...
    public function testDumpFileWithResource(): void
    {
        $filename = $this->workspace.\DIRECTORY_SEPARATOR.'foo'.\DIRECTORY_SEPARATOR.'baz.txt';
