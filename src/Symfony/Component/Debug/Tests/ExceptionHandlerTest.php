...
class ExceptionHandlerTest extends TestCase
{
    ...
    public function testHandleWithACustomHandlerThatOutputsSomething(): void
    {
        $handler = new ExceptionHandler(true);
        ob_start();
        $handler->setHandler(static function () : void {
            echo 'ccc';
        });
    ...
    public function testHandleWithACustomHandlerThatOutputsNothing(): void
    {
        $handler = new ExceptionHandler(true);
        $handler->setHandler(static function () : void {
        });
    ...
    public function testHandleWithACustomHandlerThatFails(): void
    {
        $handler = new ExceptionHandler(true);
        $handler->setHandler(static function () : never {
    ...
    public function testHandleOutOfMemoryException(): void
    {
        $handler = new ExceptionHandler(true);
        ob_start();
        $handler->setHandler(function (): void {
    ...
    private function assertThatTheExceptionWasOutput(string|bool $content, string $expectedClass, string $expectedTitle, string $expectedMessage): void
    {
