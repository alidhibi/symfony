...
class DebugClassLoaderTest extends TestCase
{
    ...
    private \Symfony\Component\Debug\Tests\ClassLoader $loader;

    protected function setUp()
    {
        $this->errorReporting = error_reporting(E_ALL);
        $this->loader = new ClassLoader();
        spl_autoload_register(fn($class) => $this->loader->loadClass($class), true, true);
    ...
    protected function tearDown()
    {
        ...
        spl_autoload_unregister(fn($class) => $this->loader->loadClass($class));
    ...
    public function testIdempotence(): void
    {
        ...
        foreach ($functions as $function) {
            if (\is_array($function) && $function[0] instanceof DebugClassLoader) {
                ...
                $this->assertNotInstanceOf(\Symfony\Component\Debug\DebugClassLoader::class, $reflProp->getValue($function[0]));
    ...
    public function testUnsilencing(): void
    {
    ...
    public function testStacking(): void
    {
        ...
        if (class_exists(\Symfony\Component\Debug\Exception\ContextErrorException::class, false)) {
        ...
        try {
            ...
            $this->assertStringStartsWith(__FILE__, $errorException->getFile());
        } finally {
     ...
     */
    public function testDeprecatedSuper(string $class, string $super, string $type): void
    {
    ...
    public function testReservedForPhp7(): void
    {
    ...
    {
        $deprecations = [];
        set_error_handler(static function ($type, $msg) use (&$deprecations) : void {
            $deprecations[] = $msg;
        });
    ...
    public function testExtendedFinalMethod(): void
    {
        ...
        $xError = [
            'The "' . \Symfony\Component\Debug\Tests\Fixtures\FinalMethod::class . '::finalMethod()" method is considered final since version 3.3. It may change without further notice as of its next major version. You should not extend it from "Symfony\Component\Debug\Tests\Fixtures\ExtendedFinalMethod".',
            'The "' . \Symfony\Component\Debug\Tests\Fixtures\FinalMethod::class . '::finalMethod2()" method is considered final. It may change without further notice as of its next major version. You should not extend it from "Symfony\Component\Debug\Tests\Fixtures\ExtendedFinalMethod".',
        ];

        $this->assertSame($xError, $deprecations);
    }

    public function testExtendedDeprecatedMethodDoesntTriggerAnyNotice(): void
    {
        set_error_handler(static fn(): false => false);
        $e = error_reporting(0);
        trigger_error('', E_USER_NOTICE);
    ...
    public function testInternalsUse(): void
    {
        ...
        $this->assertSame($deprecations, [
            ...
            'The "' . \Symfony\Component\Debug\Tests\Fixtures\InternalClass::class . '::internalMethod()" method is considered internal since version 3.4. It may change without further notice. You should not extend it from "Test\Symfony\Component\Debug\Tests\ExtendsInternals".',
        ]);
    }

    public function testUseTraitWithInternalMethod(): void
    {
        $deprecations = [];
        set_error_handler(static function ($type, $msg) use (&$deprecations) : void {
            $deprecations[] = $msg;
    ...
    public function testEvaluatedCode(): void
    {
