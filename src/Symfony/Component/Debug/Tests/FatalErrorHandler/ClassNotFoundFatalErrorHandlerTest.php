...
class ClassNotFoundFatalErrorHandlerTest extends TestCase
{
     ...
     */
    public function testHandleClassNotFound(array $error, string $translatedMessage, \Closure|array $autoloader = null): void
    {
        if ($autoloader) {
    ...
    public function provideClassNotFoundData(): array
    {
        ...
        $debugClassLoader = new DebugClassLoader(static fn(string $class): ?true => $autoloader->loadClass($class));
        ...
        return [
            ...
            [
                ...
                static fn(string $class) => $debugClassLoader->loadClass($class),
            ],
            [
                [
                    'type' => 1,
            ...
            [
                ...
                "/^Attempted to load class \"UndefinedFunctionException\" from namespace \"Foo\\\\Bar\".\nDid you forget a \"use\" statement for \"Symfony\\\\Component\\\\Debug\\\\Exception\\\\UndefinedFunctionException\"\?$/",
                static fn(string $class): ?true => $autoloader->loadClass($class),
            ],
            [
                [
                    'type' => 1,
