...
class FlattenExceptionTest extends TestCase
{
     ...
     */
    public function testFlattenHttpException(\Exception $exception): void
    {
     ...
     * @dataProvider flattenDataProvider
     */
    public function testPrevious(\Exception $exception): void
    {
        $flattened = FlattenException::create($exception);
        $flattened2 = FlattenException::create($exception);
    ...
    public function testPreviousError(): void
    {
        ...
        $this->assertEquals(\Symfony\Component\Debug\Exception\FatalThrowableError::class, $flattened->getClass(), 'The class is set to the class of the original exception');
    }
     ...
     * @dataProvider flattenDataProvider
     */
    public function testToArray(\Exception $exception): void
    {
        $flattened = FlattenException::create($exception);
    ...
    public function testArguments(): void
    {
        ...
        $this->assertSame(['object', \Symfony\Component\HttpKernel\Exception\NotFoundHttpException::class], $array[$i++]);
