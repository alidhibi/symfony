...
class DebugClassLoader
{
    ...
    private static ?int $caseCheck = null;
    ...
    private static array $php7Reserved = ['int' => 1, 'float' => 1, 'bool' => 1, 'string' => 1, 'true' => 1, 'false' => 1, 'null' => 1];
    ...
    public static function enable(): void
    {
        ...
        foreach ($functions as $function) {
            if (!\is_array($function) || !$function[0] instanceof self) {
                $function = static fn(string $class) => (new static($function))->loadClass($class);
            }
    ...
    private function checkClass(array $class, $file = null): void
    {
    ...
    public function checkAnnotations(\ReflectionClass $refl, $class): array
    {
        ...
        foreach ($refl->getMethods(\ReflectionMethod::IS_PUBLIC | \ReflectionMethod::IS_PROTECTED) as $method) {
            ...
            if (isset(self::$internalMethods[$class][$method->name])) {
                ...
                if (strncmp($ns, $declaringClass, $len) !== 0) {
     ...
     *
     */
    public function checkCase(\ReflectionClass $refl, $file, string $class): ?array
    {
     ...
     * @return string[]
     */
    private function getOwnInterfaces($class, string|bool $parent)
    {
