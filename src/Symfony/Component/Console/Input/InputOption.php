...
class InputOption
{
    final const VALUE_NONE = 1;

    final const VALUE_REQUIRED = 2;

    final const VALUE_OPTIONAL = 4;

    final const VALUE_IS_ARRAY = 8;
     ...
     */
    public function __construct($name, $shortcut = null, $mode = null, string $description = '', string|bool|int|float|array $default = null)
    {
        if (0 === strpos($name, '--')) {
            $name = substr($name, 2);
        }
     ...
     */
    public function getShortcut(): string|array|null
    {
