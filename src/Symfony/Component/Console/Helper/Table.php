...
class Table
{
     ...
     * @return $this
     */
    public function setStyle(\Symfony\Component\Console\Helper\TableStyle|string $name): static
    {
     ...
     *
     */
    public function getStyle(): \Symfony\Component\Console\Helper\TableStyle
    {
        return $this->style;
    }
     ...
     * @return $this
     */
    public function setColumnStyle($columnIndex, \Symfony\Component\Console\Helper\TableStyle|string $name): static
    {
     ...
     * @return $this
     */
    public function setColumnWidth($columnIndex, $width): static
    {
    ...
    public function setRow($column, array $row): static
    {
     ...
     */
    private function renderColumnSeparator(): string
    {
     ...
     * @param int    $column
     */
    private function renderCell(array $row, $column, string $cellFormat): string
    {
     ...
     * @return mixed[]
     */
    private function buildTableRows(array $rows): array
    {
        $unmergedRows = [];
        $counter = \count($rows);
     ...
     * @return array
     */
    private function copyRow(array $rows, int $line)
    {
        $row = $rows[$line];
     ...
     * @return int
     */
    private function getCellWidth(array $row, int $column)
    {
        $cellWidth = 0;
    ...
    private function resolveStyle(\Symfony\Component\Console\Helper\TableStyle|string $name)
    {
