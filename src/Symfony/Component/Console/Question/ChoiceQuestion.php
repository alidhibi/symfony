...
class ChoiceQuestion extends Question
{
     ...
     */
    public function __construct(string $question, array $choices, string|bool|int|float $default = null)
    {
        if ($choices === []) {
    ...
    private function getDefaultValidator()
    {
        ...
        return static function ($selected) use ($choices, $errorMessage, $multiselect, $isAssoc) {
            if ($multiselect) {
