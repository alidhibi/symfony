...
class OutputFormatter implements OutputFormatterInterface
{
    ...
    private readonly \Symfony\Component\Console\Formatter\OutputFormatterStyleStack $styleStack;
     ...
     * {@inheritdoc}
     */
    public function getStyle($name): \Symfony\Component\Console\Formatter\OutputFormatterStyleInterface
    {
    ...
    public function format($message): ?string
    {
        ...
        preg_match_all(sprintf('#<((%s) | /(%s)?)>#ix', $tagRegex, $tagRegex), $message, $matches, \PREG_OFFSET_CAPTURE);
