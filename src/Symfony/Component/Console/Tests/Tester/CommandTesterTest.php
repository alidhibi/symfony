...
class CommandTesterTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->command->setCode(static function ($input, $output) : void {
            $output->writeln('foo');
        });
    ...
    public function testCommandFromApplication(): void
    {
        ...
        $command->setCode(static function ($input, $output) : void {
            $output->writeln('foo');
        });
    ...
    public function testCommandWithInputs(): void
    {
        ...
        $command->setCode(static function ($input, $output) use ($questions, $command) : void {
    ...
    public function testSymfonyStyleCommandWithInputs(): void
    {
        ...
        $command = new Command('foo');
        $command->setCode(static function ($input, $output) use ($questions) : void {
