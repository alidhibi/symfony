...
class AddConsoleCommandPassTest extends TestCase
{
    ...
    public function testProcess(bool $public): void
    {
        ...
        $container->setParameter('my-command.class', \Symfony\Component\Console\Tests\DependencyInjection\MyCommand::class);
    ...
    public function testProcessThrowAnExceptionIfTheServiceIsAbstract(): void
    {
        ...
        $definition = new Definition(\Symfony\Component\Console\Tests\DependencyInjection\MyCommand::class);
        $definition->addTag('console.command');
    ...
    {
        $container = new ContainerBuilder();
        $className = \Symfony\Component\Console\Tests\DependencyInjection\MyCommand::class;
