...
class ArrayInputTest extends TestCase
{
     ...
     */
    public function testParseInvalidInput(array $parameters, \Symfony\Component\Console\Input\InputDefinition $definition, string $expectedExceptionMessage): void
    {
