...
class ConsoleLoggerTest extends TestCase
{
     ...
     */
    public function getLogger(): \Symfony\Component\Console\Logger\ConsoleLogger
    {
     ...
     */
    public function testOutputMapping(string $logLevel, int $outputVerbosity, bool $isOutput, array $addVerbosityLevelMap = []): void
    {
        ...
        $logs = $out->fetch();
        $this->assertEquals($isOutput ? sprintf('[%s] foo bar', $logLevel).\PHP_EOL : '', $logs);
    }
     ...
     */
    public function testLogsAtAllLevels(string $level, string|\Stringable $message): void
    {
    ...
    {
        $dummy = $this->createPartialMock(\Symfony\Component\Console\Tests\Logger\DummyTest::class, ['__toString']);
