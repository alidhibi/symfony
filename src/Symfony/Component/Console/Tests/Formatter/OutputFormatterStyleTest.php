...
class OutputFormatterStyleTest extends TestCase
{
    ...
    public function testOptions(): void
    {
        ...
        try {
            ...
            $this->assertInstanceOf('\InvalidArgumentException', $exception, '->setOption() throws an \InvalidArgumentException when the option does not exist in the available options');
            $this->assertStringContainsString('Invalid option specified: "foo"', $exception->getMessage(), '->setOption() throws an \InvalidArgumentException when the option does not exist in the available options');
        }
        ...
        try {
            ...
            $this->assertInstanceOf('\InvalidArgumentException', $exception, '->unsetOption() throws an \InvalidArgumentException when the option does not exist in the available options');
            $this->assertStringContainsString('Invalid option specified: "foo"', $exception->getMessage(), '->unsetOption() throws an \InvalidArgumentException when the option does not exist in the available options');
        }
    }
}
