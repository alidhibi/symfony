...
class ProcessHelperTest extends TestCase
{
     ...
     */
    public function testVariousProcessRuns(string $expected, array|\Symfony\Component\Process\Process $cmd, int $verbosity, string $error): void
    {
...
EOT;
    ...
    private function getOutputStream(int $verbosity): \Symfony\Component\Console\Output\StreamOutput
    {
        return new StreamOutput(fopen('php://memory', 'r+', false), $verbosity, false);
    }

    private function getOutput(StreamOutput $output): string|bool
    {
