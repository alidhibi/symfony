...
class ProgressBarTest extends TestCase
{
    ...
    {
        ProgressBar::setPlaceholderFormatterDefinition('remaining_steps', static fn(ProgressBar $bar): int => $bar->getMaxSteps() - $bar->getProgress());
    ...
    public function testAnsiColorsAndEmojis(): void
    {
        ...
        ProgressBar::setPlaceholderFormatterDefinition('memory', static function (ProgressBar $bar) : string {
            static $i = 0;
            $mem = 100000 * $i;
        ...
        rewind($output->getStream());
        $this->assertEquals(
            ' [44;37m Starting the demo... fingers crossed  [0m
 ...
 15/15 '.str_repeat($done, 28)." 100%\n".
     ...
     */
    public function testFormatsWithoutMax(string $format): void
    {
        $bar = new ProgressBar($output = $this->getOutputStream());
    ...
    protected function getOutputStream($decorated = true, $verbosity = StreamOutput::VERBOSITY_NORMAL): \Symfony\Component\Console\Output\StreamOutput
    {
    ...
    protected function generateOutput(string $expected): string
    {
        ...
        return "\x0D\x1B[2K".($count !== 0 ? str_repeat("\x1B[1A\x1B[2K", $count) : '').$expected;
    }
