...
class TableTest extends TestCase
{
     ...
     */
    public function testRender(array $headers, array $rows, \Symfony\Component\Console\Helper\TableStyle|string $style, string $expected, bool $decorated = false): void
    {
     ...
     * @dataProvider renderProvider
     */
    public function testRenderAddRows(array $headers, array $rows, \Symfony\Component\Console\Helper\TableStyle|string $style, string $expected, bool $decorated = false): void
    {
        $table = new Table($output = $this->getOutputStream($decorated));
        $table
            ->setHeaders($headers)
     ...
     * @dataProvider renderProvider
     */
    public function testRenderAddRowsOneByOne(array $headers, array $rows, \Symfony\Component\Console\Helper\TableStyle|string $style, string $expected, bool $decorated = false): void
    {
        $table = new Table($output = $this->getOutputStream($decorated));
        $table
            ->setHeaders($headers)
...
TABLE;
    ...
    protected function getOutputStream($decorated = false): \Symfony\Component\Console\Output\StreamOutput
    {
