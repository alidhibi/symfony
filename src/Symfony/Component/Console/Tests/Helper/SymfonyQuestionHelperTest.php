...
class SymfonyQuestionHelperTest extends AbstractQuestionHelperTest
{
    ...
    public function testAskChoiceWithChoiceValueAsDefault(): void
    {
        $questionHelper = new SymfonyQuestionHelper();
        $helperSet = new HelperSet([new FormatterHelper()]);
        $questionHelper->setHelperSet($helperSet);
    ...
    public function testChoiceQuestionPadding(): void
    {
...
EOT
    ...
    public function testChoiceQuestionCustomPrompt(): void
    {
...
EOT
    ...
    private function assertOutputContains(string $expected, StreamOutput $output, bool $normalize = false): void
    {
