...
class HelperSetTest extends TestCase
{
    ...
    public function testGet(): void
    {
        ...
        try {
            ...
            $this->assertInstanceOf('\InvalidArgumentException', $exception, '->get() throws InvalidArgumentException when helper not found');
            $this->assertInstanceOf(\Symfony\Component\Console\Exception\ExceptionInterface::class, $exception, '->get() throws domain specific exception when helper not found');
            $this->assertStringContainsString('The helper "foo" is not defined.', $exception->getMessage(), '->get() throws InvalidArgumentException when helper not found');
        }
    }
    ...
    private function getGenericMockHelper(string $name, HelperSet $helperset = null)
    {
        $mock_helper = $this->getMockBuilder('\\' . \Symfony\Component\Console\Helper\HelperInterface::class)->getMock();
