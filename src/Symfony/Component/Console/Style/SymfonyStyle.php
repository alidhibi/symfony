...
{
    final const MAX_LINE_LENGTH = 120;

    private readonly \Symfony\Component\Console\Input\InputInterface $input;
    ...
    private readonly \Symfony\Component\Console\Output\TrimmedBufferOutput $bufferedOutput;
     ...
     */
    public function block($messages, string $type = null, string $style = null, string $prefix = ' ', bool $padding = false, bool $escape = true): void
    {
    ...
    public function listing(array $elements): void
    {
        ...
        $elements = array_map(static fn($element): string => sprintf(' * %s', $element), $elements);
     ...
     * {@inheritdoc}
     */
    public function ask($question, $default = null, $validator = null): mixed
    {
    ...
    private function reduceBuffer(string|iterable $messages): array
    {
        ...
        return array_map(static fn($value): string => substr($value, -4), [$this->bufferedOutput->fetch(), ...(array) $messages]);
    }
