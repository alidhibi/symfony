...
class TextDescriptor extends Descriptor
{
    ...
    protected function describeCommand(Command $command, array $options = []): void
    {
        ...
        foreach ([$command->getSynopsis(true), ...$command->getAliases(), ...$command->getUsages()] as $usage) {
            $this->writeText("\n");
...
', $options);
            ...
            $width = $this->getColumnWidth(array_merge(...array_map(static fn($namespace): array => array_intersect($namespace['commands'], array_keys($commands)), array_values($namespaces))));
     ...
     * @return string
     */
    private function formatDefaultValue($default): string|array
    {
        if (\INF === $default) {
            return 'INF';
        }
     ...
     *
     */
    private function getColumnWidth(array $commands): int|float
    {
        $widths = [];
