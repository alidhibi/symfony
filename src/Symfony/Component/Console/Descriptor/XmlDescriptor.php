...
class XmlDescriptor extends Descriptor
{
    ...
    public function getCommandDocument(Command $command): \DOMDocument
    {
        ...
        foreach ([$command->getSynopsis(), ...$command->getAliases(), ...$command->getUsages()] as $usage) {
     ...
     *
     */
    public function getApplicationDocument(Application $application, $namespace = null): \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
