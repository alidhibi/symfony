...
class Command
{
    ...
    public function run(InputInterface $input, OutputInterface $output)
    {
        ...
        $statusCode = $this->code ? \call_user_func($this->code, $input, $output) : $this->execute($input, $output);
    ...
    public function setCode(callable $code)
    {
        if ($code instanceof \Closure) {
            ...
            if (null === $r->getClosureThis()) {
                $code = \PHP_VERSION_ID < 70000 ? @\Closure::bind($code, $this) : \Closure::bind($code, $this);
            }
        }
    ...
    {
        if (!$this->application instanceof \Symfony\Component\Console\Application || ($this->applicationDefinitionMerged && ($this->applicationDefinitionMergedWithArgs || !$mergeArgs))) {
            return;
        }
