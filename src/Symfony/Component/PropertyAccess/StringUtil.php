...
class StringUtil
{
    ...
    {
        @trigger_error('StringUtil::singularify() is deprecated since Symfony 3.1 and will be removed in 4.0. Use ' . \Symfony\Component\Inflector\Inflector::class . '::singularize instead.', \E_USER_DEPRECATED);
