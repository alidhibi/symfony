...
{
    private readonly \Symfony\Component\Translation\DataCollectorTranslator $translator;
    ...
    {
        return empty($this->data['locale']) ? null : $this->data['locale'];
    }
    ...
    private function computeCount($messages): array
    {
        $count = [
    ...
    private function sanitizeString($string, $length = 80): string
    {
