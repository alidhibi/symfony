...
class MessageFormatterTest extends TestCase
{
     ...
     */
    public function testFormat(string $expected, string $message, array $parameters = []): void
    {
     ...
     */
    public function testFormatPlural(string $expected, string $message, int $number, array $parameters): void
    {
        $this->assertEquals($expected, $this->getMessageFormatter()->choiceFormat($message, $number, 'fr', $parameters));
    }

    public function getTransMessages(): array
    {
        return [
            [
                'There is one apple',
    ...
    public function getTransChoiceMessages(): array
    {
        return [
    ...
    private function getMessageFormatter(): \Symfony\Component\Translation\Formatter\MessageFormatter
    {
