...
class TranslatorCacheTest extends TestCase
{
     ...
     */
    public function testThatACacheIsUsed(bool $debug): void
    {
        $locale = 'any_locale';
        $format = 'some_format';
        $msgid = 'test';
     ...
     * @dataProvider runForDebugAndProduction
     */
    public function testDifferentTranslatorsForSameLocaleDoNotOverwriteEachOthersCache(bool $debug): void
    {
        /*
    ...
    {
        $resource = $this->getMockBuilder(\Symfony\Component\Config\Resource\SelfCheckingResourceInterface::class)->getMock();
        $loader = $this->getMockBuilder(\Symfony\Component\Translation\Loader\LoaderInterface::class)->getMock();
    ...
    public function runForDebugAndProduction(): array
    {
        return [[true], [false]];
    }
