...
class MessageSelectorTest extends TestCase
{
     ...
     */
    public function testChoose(string $expected, string $id, int|float $number): void
    {
     ...
     */
    public function testThrowExceptionIfMatchingMessageCannotBeFound(string $id, int $number): void
    {
    ...
    public function getChooseTests(): array
    {
        return [
