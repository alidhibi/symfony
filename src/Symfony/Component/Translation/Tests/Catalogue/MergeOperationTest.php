...
class MergeOperationTest extends AbstractOperationTest
{
    ...
    protected function createOperation(MessageCatalogueInterface $source, MessageCatalogueInterface $target): \Symfony\Component\Translation\Catalogue\MergeOperation
    {
