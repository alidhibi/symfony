...
class TranslationWriter implements TranslationWriterInterface
{
     ...
     */
    public function addDumper($format, DumperInterface $dumper): void
    {
     ...
     */
    public function disableBackup(): void
    {
     ...
     */
    public function write(MessageCatalogue $catalogue, $format, $options = []): void
    {
     ...
     */
    public function writeTranslations(MessageCatalogue $catalogue, $format, $options = []): void
    {
