...
final class Dotenv
{
     ...
     */
    public function load($path/*, ...$paths*/): void
    {
     ...
     * @throws FormatException when a file has a syntax error
     */
    public function parse($data, $path = '.env'): ?array
    {
        $this->path = $path;
    ...
    private function resolveVariables(array|string $value, array $loadedVars): string|array|null
    {
        if (false === strpos($value, '$')) {
            return $value;
        }
    ...
    private function createFormatException(string $message): \Symfony\Component\Dotenv\Exception\FormatException
    {
