...
class YamlFileLoader extends FileLoader
{
    ...
    {
        set_error_handler(static function ($level, $message, $script, $line) use ($path, &$prevErrorHandler) : bool {
        ...
        try {
            ...
            throw new \InvalidArgumentException(sprintf('The file "%s" does not contain valid YAML: ', $path).$parseException->getMessage(), 0, $parseException);
        } finally {
