...
class RecursiveContextualValidator implements ContextualValidatorInterface
{
    ...
    private readonly \Symfony\Component\Validator\ConstraintValidatorFactoryInterface $validatorFactory;
     ...
     * {@inheritdoc}
     */
    public function validatePropertyValue($objectOrClass, $propertyName, $value, $groups = null): static
    {
     ...
     */
    private function validateObject($object, string $propertyPath, array $groups, $traversalStrategy, ExecutionContextInterface $context): void
    {
        try {
            $classMetadata = $this->metadataFactory->getMetadataFor($object);
            ...
            if (!$object instanceof \Traversable) {
                throw $noSuchMetadataException;
            }

            // Rethrow unless IMPLICIT or TRAVERSE
            if (($traversalStrategy & (TraversalStrategy::IMPLICIT | TraversalStrategy::TRAVERSE)) === 0) {
                throw $noSuchMetadataException;
            }
     ...
     * @param ExecutionContextInterface $context      The current execution context
     */
    private function validateEachObjectIn(array|\Traversable $collection, string $propertyPath, array $groups, ExecutionContextInterface $context): void
    {
     ...
     */
    private function validateClassNode($object, ?string $cacheKey, ClassMetadataInterface $metadata = null, string $propertyPath, array $groups, ?array $cascadedGroups, $traversalStrategy, ExecutionContextInterface $context): void
    {
        ...
        if (($traversalStrategy & TraversalStrategy::IMPLICIT) !== 0) {
     ...
     * @see TraversalStrategy
     */
    private function validateGenericNode($value, ?object $object, ?string $cacheKey, MetadataInterface $metadata = null, string $propertyPath, array $groups, ?array $cascadedGroups, int $traversalStrategy, ExecutionContextInterface $context): void
    {
        ...
        if (($cascadingStrategy & CascadingStrategy::CASCADE) === 0) {
            return;
        }
     ...
     * @param ExecutionContextInterface $context           The execution context
     */
    private function stepThroughGroupSequence(object $value, ?object $object, ?string $cacheKey, MetadataInterface $metadata = null, string $propertyPath, int $traversalStrategy, GroupSequence $groupSequence, ?string $cascadedGroup, ExecutionContextInterface $context): void
    {
     ...
     * @param ExecutionContextInterface $context  The execution context
     */
    private function validateInGroup($value, ?string $cacheKey, MetadataInterface $metadata, string $group, ExecutionContextInterface $context): void
    {
