...
{
    protected \Symfony\Component\Validator\Context\ExecutionContextFactoryInterface $contextFactory;

    protected \Symfony\Component\Validator\Mapping\Factory\MetadataFactoryInterface $metadataFactory;

    protected \Symfony\Component\Validator\ConstraintValidatorFactoryInterface $validatorFactory;
     ...
     * {@inheritdoc}
     */
    public function startContext($root = null): \Symfony\Component\Validator\Validator\RecursiveContextualValidator
    {
     ...
     * {@inheritdoc}
     */
    public function inContext(ExecutionContextInterface $context): \Symfony\Component\Validator\Validator\RecursiveContextualValidator
    {
        return new RecursiveContextualValidator(
            $context,
            $this->metadataFactory,
