...
class UuidValidator extends ConstraintValidator
{
    ...
    final const STRICT_LENGTH = 36;

    final const STRICT_FIRST_HYPHEN_POSITION = 8;

    final const STRICT_LAST_HYPHEN_POSITION = 23;

    final const STRICT_VERSION_POSITION = 14;

    final const STRICT_VARIANT_POSITION = 19;
    ...
    final const LOOSE_MAX_LENGTH = 39;

    final const LOOSE_FIRST_HYPHEN_POSITION = 4;
