...
class AnnotationLoaderTest extends TestCase
{
    ...
    public function testLoadParentClassMetadata(): void
    {
        ...
        $parent_metadata = new ClassMetadata(\Symfony\Component\Validator\Tests\Fixtures\EntityParent::class);
        $loader->loadClassMetadata($parent_metadata);

        $expected_parent = new ClassMetadata(\Symfony\Component\Validator\Tests\Fixtures\EntityParent::class);
