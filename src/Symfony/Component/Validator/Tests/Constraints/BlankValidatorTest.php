...
{
    protected function createValidator(): \Symfony\Component\Validator\Constraints\BlankValidator
    {
     ...
     */
    public function testInvalidValues(string|int|bool $value, string $valueAsString): void
    {
