...
{
    protected function createValidator(): \Symfony\Component\Validator\Constraints\IssnValidator
    {
        return new IssnValidator();
    }

    public function getValidLowerCasedIssn(): array
    {
        return [
            ['2162-321x'],
            ['2160-200x'],
    ...
    public function getValidNonHyphenatedIssn(): array
    {
        return [
            ['2162321X'],
            ['01896016'],
    ...
    public function getFullValidIssn(): array
    {
        return [
            ['1550-7416'],
            ['1539-8560'],
    ...
    public function getValidIssn(): array
    {
        return array_merge(
    ...
    public function getInvalidIssn(): array
    {
        return [
     ...
     */
    public function testCaseSensitiveIssns(string $issn): void
    {
        $constraint = new Issn([
            'caseSensitive' => true,
            'message' => 'myMessage',
     ...
     */
    public function testRequireHyphenIssns(string $issn): void
    {
        $constraint = new Issn([
            'requireHyphen' => true,
            'message' => 'myMessage',
     ...
     */
    public function testInvalidIssn(int|string $issn, string $code): void
    {
        $constraint = new Issn([
            'message' => 'myMessage',
        ]);
