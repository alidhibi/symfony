...
{
    protected function createValidator(): \Symfony\Component\Validator\Constraints\IbanValidator
    {
    ...
    public function getValidIbans(): array
    {
        return [
     ...
     */
    public function testIbansWithInvalidFormat(string $iban): void
    {
        $this->assertViolationRaised($iban, Iban::INVALID_FORMAT_ERROR);
    }

    public function getIbansWithInvalidFormat(): array
    {
        return [
     ...
     */
    public function testIbansWithValidFormatButIncorrectChecksum(string $iban): void
    {
        $this->assertViolationRaised($iban, Iban::CHECKSUM_FAILED_ERROR);
    }

    public function getIbansWithValidFormatButIncorrectChecksum(): array
    {
        return [
     ...
     */
    public function testIbansWithUnsupportedCountryCode(string $countryCode): void
    {
        $this->assertViolationRaised($countryCode.'260211000000230064016', Iban::NOT_SUPPORTED_COUNTRY_CODE_ERROR);
    }

    public function getUnsupportedCountryCodes(): array
    {
        return [
            ['AG'],
            ['AI'],
     ...
     */
    public function testIbansWithInvalidCountryCode(string $iban): void
    {
        $this->assertViolationRaised($iban, Iban::INVALID_COUNTRY_CODE_ERROR);
    }

    public function getIbansWithInvalidCountryCode(): array
    {
        return [
            ['0750447346'],
            ['2X0750447346'],
    ...
    private function assertViolationRaised(string $iban, string $code): void
    {
        $constraint = new Iban([
            'message' => 'myMessage',
        ]);
