...
{
    protected function createValidator(): \Symfony\Component\Validator\Constraints\BicValidator
    {
     ...
     */
    public function testValidBics(string $bic): void
    {
     ...
     */
    public function testInvalidBics(string $bic, string $code): void
    {
        $constraint = new Bic([
            'message' => 'myMessage',
        ]);
    ...
    public function getInvalidBics(): array
    {
        return [
