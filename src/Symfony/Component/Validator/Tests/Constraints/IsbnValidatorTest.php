...
{
    protected function createValidator(): \Symfony\Component\Validator\Constraints\IsbnValidator
    {
        return new IsbnValidator();
    }

    public function getValidIsbn10(): array
    {
        return [
            ['2723442284'],
            ['2723442276'],
    ...
    public function getInvalidIsbn10(): array
    {
        return [
    ...
    public function getValidIsbn13(): array
    {
        return [
            ['978-2723442282'],
            ['978-2723442275'],
    ...
    public function getInvalidIsbn13(): array
    {
        return [
    ...
    public function getValidIsbn(): array
    {
        return array_merge(
            $this->getValidIsbn10(),
            $this->getValidIsbn13()
    ...
    public function getInvalidIsbn(): array
    {
        return array_merge(
     ...
     */
    public function testValidIsbn10(string $isbn): void
    {
        $constraint = new Isbn([
            'type' => 'isbn10',
        ]);
     ...
     */
    public function testInvalidIsbn10(string $isbn, string $code): void
    {
        $constraint = new Isbn([
            'type' => 'isbn10',
     ...
     */
    public function testValidIsbn13(string $isbn): void
    {
     ...
     */
    public function testInvalidIsbn13(string $isbn, string $code): void
    {
        $constraint = new Isbn([
            'type' => 'isbn13',
     ...
     * @dataProvider getInvalidIsbn10
     */
    public function testInvalidIsbnAnyIsbn10(string $isbn, string $code): void
    {
        $constraint = new Isbn([
     ...
     * @dataProvider getInvalidIsbn13
     */
    public function testInvalidIsbnAnyIsbn13(string $isbn, string $code): void
    {
        $constraint = new Isbn([
            'bothIsbnMessage' => 'myMessage',
        ]);
