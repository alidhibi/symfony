...
{
    protected function createValidator(): \Symfony\Component\Validator\Constraints\AllValidator
    {
     ...
     */
    public function testWalkSingleConstraint(\ArrayObject|array $array): void
    {
     ...
     * @dataProvider getValidArguments
     */
    public function testWalkMultipleConstraints(\ArrayObject|array $array): void
    {
