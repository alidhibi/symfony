...
{
    protected function createValidator(): \Symfony\Component\Validator\Constraints\IdenticalToValidator
    {
        return new IdenticalToValidator();
    }

    protected function createConstraint(array $options = null): \Symfony\Component\Validator\Constraints\IdenticalTo
    {
