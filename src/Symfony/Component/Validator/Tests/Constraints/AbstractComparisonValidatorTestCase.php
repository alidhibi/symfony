...
abstract class AbstractComparisonValidatorTestCase extends ConstraintValidatorTestCase
{
     ...
     */
    public function testThrowsOnInvalidStringDates(AbstractComparison $constraint, string $expectedMessage, \DateTimeImmutable|\DateTime $value): void
    {
        $this->expectException(ConstraintDefinitionException::class);
     ...
     */
    public function testCompareWithNullValueAtPropertyAt($dirtyValue, $dirtyValueAsString, $isValid): void
    {
        $constraint = $this->createConstraint(['propertyPath' => 'value']);
        $constraint->message = 'Constraint Message';
