...
{
    protected function createValidator(): \Symfony\Component\Validator\Constraints\IsNullValidator
    {
     ...
     */
    public function testInvalidValues(int|bool|string|\DateTime|\stdClass|array $value, string $valueAsString): void
    {
