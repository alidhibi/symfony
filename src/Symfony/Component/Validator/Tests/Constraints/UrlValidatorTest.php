...
{
    protected function createValidator(): \Symfony\Component\Validator\Constraints\UrlValidator
    {
     ...
     */
    public function testCustomProtocolIsValid(string $url): void
    {
        $constraint = new Url([
    ...
    public function getValidCustomUrls(): array
    {
        return [
            ['ftp://example.com'],
            ['file://127.0.0.1'],
     ...
     */
    public function testCheckDns(bool $violation): void
    {
    ...
    public function getCheckDns(): array
    {
        return [[true], [false]];
    }
     ...
     * @requires function Symfony\Bridge\PhpUnit\DnsMock::withMockedHosts
     */
    public function testCheckDnsByType(string $type): void
    {
    ...
    public function getCheckDnsTypes(): array
    {
        return [
            ['ANY'],
            ['A'],
     ...
     * @group legacy
     */
    public function testCheckDnsWithBoolean(): void
    {
