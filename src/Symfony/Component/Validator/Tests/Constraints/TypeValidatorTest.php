...
class TypeValidatorTest extends ConstraintValidatorTestCase
{
    ...
    protected function createValidator(): \Symfony\Component\Validator\Constraints\TypeValidator
    {
     ...
     */
    public function testValidValues($value, string $type): void
    {
     ...
     */
    public function testInvalidValues($value, string $type, string $valueAsString): void
    {
        $constraint = new Type([
            'type' => $type,
            'message' => 'myMessage',
