...
{
    protected function createValidator(): \Symfony\Component\Validator\Constraints\RangeValidator
    {
    ...
    public function getTenToTwenty(): array
    {
        return [
            [10.00001],
            [19.99999],
    ...
    public function getLessThanTen(): array
    {
        return [
            [9.99999, '9.99999'],
            ['9.99999', '"9.99999"'],
    ...
    public function getMoreThanTwenty(): array
    {
        return [
            [20.000001, '20.000001'],
            ['20.000001', '"20.000001"'],
     ...
     */
    public function testValidValuesMin(float|string|int $value): void
    {
     ...
     * @dataProvider getTenToTwenty
     */
    public function testValidValuesMax(float|string|int $value): void
    {
     ...
     * @dataProvider getTenToTwenty
     */
    public function testValidValuesMinMax(float|string|int $value): void
    {
     ...
     */
    public function testInvalidValuesMin(float|string|int $value, string $formattedValue): void
    {
     ...
     */
    public function testInvalidValuesMax(float|string|int $value, string $formattedValue): void
    {
        $constraint = new Range([
            'max' => 20,
     ...
     * @dataProvider getMoreThanTwenty
     */
    public function testInvalidValuesCombinedMax(float|string|int $value, string $formattedValue): void
    {
        $constraint = new Range([
            'min' => 10,
            'max' => 20,
     ...
     * @dataProvider getLessThanTen
     */
    public function testInvalidValuesCombinedMin(float|string|int $value, string $formattedValue): void
    {
        $constraint = new Range([
            'min' => 10,
            'max' => 20,
    ...
    public function getTenthToTwentiethMarch2014(): array
    {
    ...
    public function getSoonerThanTenthMarch2014(): array
    {
        // The provider runs before setUp(), so we need to manually fix
        // the default timezone
        $this->setDefaultTimezone('UTC');
    ...
    public function getLaterThanTwentiethMarch2014(): array
    {
        // The provider runs before setUp(), so we need to manually fix
        // the default timezone
        $this->setDefaultTimezone('UTC');
     ...
     */
    public function testValidDatesMin($value): void
    {
     ...
     * @dataProvider getTenthToTwentiethMarch2014
     */
    public function testValidDatesMax($value): void
    {
     ...
     * @dataProvider getTenthToTwentiethMarch2014
     */
    public function testValidDatesMinMax($value): void
    {
     ...
     */
    public function testInvalidDatesMin($value, $dateTimeAsString): void
    {
     ...
     */
    public function testInvalidDatesMax($value, $dateTimeAsString): void
    {
        // Conversion of dates to string differs between ICU versions
        // Make sure we have the correct version loaded
        IntlTestHelper::requireIntl($this, '57.1');
     ...
     * @dataProvider getLaterThanTwentiethMarch2014
     */
    public function testInvalidDatesCombinedMax($value, $dateTimeAsString): void
    {
        // Conversion of dates to string differs between ICU versions
        // Make sure we have the correct version loaded
        IntlTestHelper::requireIntl($this, '57.1');
     ...
     * @dataProvider getSoonerThanTenthMarch2014
     */
    public function testInvalidDatesCombinedMin($value, $dateTimeAsString): void
    {
        // Conversion of dates to string differs between ICU versions
        // Make sure we have the correct version loaded
        IntlTestHelper::requireIntl($this, '57.1');
     ...
     */
    public function testThrowsOnInvalidStringDates(string $expectedMessage, \DateTimeImmutable|\DateTime $value, ?string $min, ?string $max): void
    {
