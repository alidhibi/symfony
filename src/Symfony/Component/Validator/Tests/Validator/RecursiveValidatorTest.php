...
{
    protected function createValidator(MetadataFactoryInterface $metadataFactory, array $objectInitializers = []): \Symfony\Component\Validator\Validator\RecursiveValidator
    {
    ...
    public function testEmptyGroupsArrayDoesNotTriggerDeprecation(): void
    {
        ...
        $validator = $this
            ->getMockBuilder(\Symfony\Component\Validator\Validator\RecursiveValidator::class)
