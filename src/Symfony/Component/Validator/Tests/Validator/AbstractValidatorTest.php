...
abstract class AbstractValidatorTest extends TestCase
{
     ...
     */
    public function testArrayReference(string $constraintMethod): void
    {
        $entity = new Entity();
     ...
     * @dataProvider getConstraintMethods
     */
    public function testRecursiveArrayReference(string $constraintMethod): void
    {
        $entity = new Entity();
     ...
     * @dataProvider getConstraintMethods
     */
    public function testArrayTraversalCannotBeDisabled(string $constraintMethod): void
    {
        $entity = new Entity();
        $entity->reference = ['key' => new Reference()];
     ...
     * @dataProvider getConstraintMethods
     */
    public function testRecursiveArrayTraversalCannotBeDisabled(string $constraintMethod): void
    {
        $entity = new Entity();
        $entity->reference = [2 => ['key' => new Reference()]];
     ...
     * @dataProvider getConstraintMethods
     */
    public function testIgnoreScalarsDuringArrayTraversal(string $constraintMethod): void
    {
        $entity = new Entity();
     ...
     * @dataProvider getConstraintMethods
     */
    public function testIgnoreNullDuringArrayTraversal(string $constraintMethod): void
    {
        $entity = new Entity();
        $entity->reference = [null];
     ...
     */
    public function testReplaceDefaultGroup(\Symfony\Component\Validator\Constraints\GroupSequence|array $sequence, array $assertViolations): void
    {
