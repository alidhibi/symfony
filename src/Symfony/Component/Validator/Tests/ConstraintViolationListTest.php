...
EOF;
     ...
     */
    public function testFindByCodes(string|array $code, int $violationsCount): void
    {
        $violations = [
    ...
    public function findByCodesProvider(): array
    {
        return [
            ['code1', 2],
            [['code1', 'code2'], 3],
    ...
    protected function getViolation($message, $root = null, $propertyPath = null, $code = null): \Symfony\Component\Validator\ConstraintViolation
    {
