...
class ConstraintViolationBuilderTest extends TestCase
{
    ...
    private ?\Symfony\Component\Validator\ConstraintViolationList $violations = null;

    private string $messageTemplate = '%value% is invalid';

    private ?\Symfony\Component\Validator\Violation\ConstraintViolationBuilder $builder = null;
