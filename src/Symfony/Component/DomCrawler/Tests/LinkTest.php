...
class LinkTest extends TestCase
{
    ...
    public function testConstructorWithAnInvalidCurrentUri(): void
    {
     ...
     * @dataProvider getGetUriTests
     */
    public function testGetUriOnArea(string $url, string $currentUri, string $expected): void
    {
        $dom = new \DOMDocument();
     ...
     * @dataProvider getGetUriTests
     */
    public function testGetUriOnLink(string $url, string $currentUri, string $expected): void
    {
        $dom = new \DOMDocument();
