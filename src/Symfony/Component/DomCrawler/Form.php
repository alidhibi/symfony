...
{
    private ?\DOMElement $button = null;

    private \Symfony\Component\DomCrawler\FormFieldRegistry $fields;
    ...
    public function getMethod()
    {
        ...
        return $this->node->getAttribute('method') !== '' && $this->node->getAttribute('method') !== '0' ? strtoupper($this->node->getAttribute('method')) : 'GET';
    }
