...
class ServiceLocator implements PsrContainerInterface
{
     ...
     * @internal
     */
    public function withContext($externalId, Container $container): static
    {
        $locator = clone $this;
    ...
    private function createServiceNotFoundMessage($id): string
    {
        if ($this->loading) {
        ...
        if (!$this->container instanceof \Symfony\Component\DependencyInjection\Container) {
            $class = null;
