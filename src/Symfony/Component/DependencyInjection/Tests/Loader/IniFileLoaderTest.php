...
class IniFileLoaderTest extends TestCase
{
     ...
     */
    public function testTypeConversions(string $key, bool|string|int|float|null $value, bool $supported): void
    {
     ...
     */
    public function testTypeConversionsWithNativePhp(string $key, bool|string|int|float|null $value, bool $supported): void
    {
    ...
    public function getTypeConversions(): array
    {
        return [
