...
class FileLoaderTest extends TestCase
{
     ...
     */
    public function testRegisterClassesWithIncompatibleExclude(string $resourcePattern, string $excludePattern): void
    {
        $container = new ContainerBuilder();
        $loader = new TestFileLoader($container, new FileLocator(self::$fixturesPath.'/Fixtures'));
    ...
    public function getIncompatibleExcludeTests(): \Generator
    {
