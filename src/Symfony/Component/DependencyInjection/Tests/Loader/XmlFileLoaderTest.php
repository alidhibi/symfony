...
class XmlFileLoaderTest extends TestCase
{
    ...
    public function testLoad(): void
    {
        ...
        try {
            ...
            $this->assertInstanceOf('InvalidArgumentException', $exception, '->load() throws an InvalidArgumentException if the loaded file does not exist');
            $this->assertStringStartsWith('The file "foo.xml" does not exist (in:', $exception->getMessage(), '->load() throws an InvalidArgumentException if the loaded file does not exist');
        }
    }
    ...
    public function testParseFile(): void
    {
        ...
        try {
            ...
            $this->assertInstanceOf(\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException::class, $exception, '->parseFileToDOM() throws an InvalidArgumentException if the loaded file is not a valid XML file');
            $this->assertMatchesRegularExpression(sprintf('#^Unable to parse file ".+%s": .+.$#', 'parameters.ini'), $exception->getMessage(), '->parseFileToDOM() throws an InvalidArgumentException if the loaded file is not a valid XML file');

            $exception = $exception->getPrevious();
            $this->assertInstanceOf('InvalidArgumentException', $exception, '->parseFileToDOM() throws an InvalidArgumentException if the loaded file is not a valid XML file');
            $this->assertStringStartsWith("[ERROR 4] Start tag expected, '<' not found (in", $exception->getMessage(), '->parseFileToDOM() throws an InvalidArgumentException if the loaded file is not a valid XML file');
        }
        ...
        try {
            ...
            $this->assertInstanceOf(\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException::class, $exception, '->parseFileToDOM() throws an InvalidArgumentException if the loaded file does not validate the XSD');
            $this->assertMatchesRegularExpression(sprintf('#^Unable to parse file ".+%s": .+.$#', 'nonvalid.xml'), $exception->getMessage(), '->parseFileToDOM() throws an InvalidArgumentException if the loaded file is not a valid XML file');
    ...
    public function testLoadAnonymousServices(): void
    {
        $container = new ContainerBuilder();
        $loader = new XmlFileLoader($container, new FileLocator(self::$fixturesPath.'/xml'));
        ...
        $this->assertInstanceOf(\Symfony\Component\DependencyInjection\Reference::class, $args[0], '->load() converts anonymous services to references to "normal" services');
        ...
        $this->assertInstanceOf(\Symfony\Component\DependencyInjection\Reference::class, $property, '->load() converts anonymous services to references to "normal" services');
        ...
        foreach (array_keys($service) as $id) {
     ...
     */
    public function testLoadAnonymousServicesWithoutId(): void
    {
        $container = new ContainerBuilder();
        $loader = new XmlFileLoader($container, new FileLocator(self::$fixturesPath.'/xml'));
    ...
    public function testLoadAnonymousNestedServices(): void
    {
        $container = new ContainerBuilder();
        $loader = new XmlFileLoader($container, new FileLocator(self::$fixturesPath.'/xml'));
    ...
    public function testParsesIteratorArgument(): void
    {
        $container = new ContainerBuilder();
        $loader = new XmlFileLoader($container, new FileLocator(self::$fixturesPath.'/xml'));
    ...
    public function testParsesTags(): void
    {
        ...
        foreach ($services as $tagAttributes) {
    ...
    public function testParseTagsWithoutNameThrowsException(): void
    {
    ...
    public function testParseTagWithEmptyNameThrowsException(): void
    {
        $this->expectException(\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException::class);
    ...
    public function testConvertDomElementToArray(): void
    {
    ...
    public function testExtensions(): void
    {
        ...
        try {
            ...
            $this->assertInstanceOf(\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException::class, $exception, '->load() throws an InvalidArgumentException if the configuration does not validate the XSD');
            $this->assertMatchesRegularExpression(sprintf('#^Unable to parse file ".+%s": .+.$#', 'services3.xml'), $exception->getMessage(), '->load() throws an InvalidArgumentException if the configuration does not validate the XSD');

            $exception = $exception->getPrevious();
            $this->assertInstanceOf('InvalidArgumentException', $exception, '->load() throws an InvalidArgumentException if the configuration does not validate the XSD');
            $this->assertStringContainsString("The attribute 'bar' is not allowed", $exception->getMessage(), '->load() throws an InvalidArgumentException if the configuration does not validate the XSD');
        }
        ...
        try {
            ...
            $this->assertInstanceOf('\InvalidArgumentException', $exception, '->load() throws an InvalidArgumentException if the tag is not valid');
            $this->assertStringStartsWith('There is no extension able to load the configuration for "project:bar" (in', $exception->getMessage(), '->load() throws an InvalidArgumentException if the tag is not valid');
        }
    }

    public function testExtensionInPhar(): void
    {
        ...
        try {
            ...
            $this->assertInstanceOf(\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException::class, $exception, '->load() throws an InvalidArgumentException if the configuration does not validate the XSD');
            $this->assertMatchesRegularExpression(sprintf('#^Unable to parse file ".+%s": .+.$#', 'services7.xml'), $exception->getMessage(), '->load() throws an InvalidArgumentException if the configuration does not validate the XSD');
    ...
    public function testNoNamingConflictsForAnonymousServices(): void
    {
        $container = new ContainerBuilder();
    ...
    public function testDocTypeIsNotAllowed(): void
    {
        ...
        try {
            ...
            $this->assertInstanceOf(\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException::class, $exception, '->load() throws an InvalidArgumentException if the configuration contains a document type');
            $this->assertMatchesRegularExpression(sprintf('#^Unable to parse file ".+%s": .+.$#', 'withdoctype.xml'), $exception->getMessage(), '->load() throws an InvalidArgumentException if the configuration contains a document type');

            $exception = $exception->getPrevious();
            $this->assertInstanceOf('InvalidArgumentException', $exception, '->load() throws an InvalidArgumentException if the configuration contains a document type');
            $this->assertSame('Document types are not allowed.', $exception->getMessage(), '->load() throws an InvalidArgumentException if the configuration contains a document type');
        }
    }

    public function testXmlNamespaces(): void
    {
        $container = new ContainerBuilder();
        $loader = new XmlFileLoader($container, new FileLocator(self::$fixturesPath.'/xml'));
    ...
    public function testLoadIndexedArguments(): void
    {
        $container = new ContainerBuilder();
        $loader = new XmlFileLoader($container, new FileLocator(self::$fixturesPath.'/xml'));
    ...
    public function testLoadInlinedServices(): void
    {
        $container = new ContainerBuilder();
        $loader = new XmlFileLoader($container, new FileLocator(self::$fixturesPath.'/xml'));
     ...
     */
    public function testAliasDefinitionContainsUnsupportedElements(): void
    {
        $container = new ContainerBuilder();
        $loader = new XmlFileLoader($container, new FileLocator(self::$fixturesPath.'/xml'));
    ...
    public function testArgumentWithKeyOutsideCollection(): void
    {
        $container = new ContainerBuilder();
        $loader = new XmlFileLoader($container, new FileLocator(self::$fixturesPath.'/xml'));
    ...
    public function testInstanceOfAndChildDefinitionNotAllowed(): void
    {
        $this->expectException(\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException::class);
    ...
    public function testDefaultsAndChildDefinitionNotAllowed(): void
    {
        $this->expectException(\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException::class);
    ...
    public function testAutoConfigureInstanceof(): void
    {
        $container = new ContainerBuilder();
        $loader = new XmlFileLoader($container, new FileLocator(self::$fixturesPath.'/xml'));
    ...
    public function testBindings(): void
    {
        ...
        $this->assertEquals([
            ...
            '$quz' => 'quz',
            '$factory' => 'factory',
        ], array_map(static fn($v) => $v->getValues()[0], $definition->getBindings()));
        $this->assertEquals([
            'quz',
            null,
    ...
    public function testTsantosContainer(): void
    {
        $container = new ContainerBuilder();
        $loader = new XmlFileLoader($container, new FileLocator(self::$fixturesPath.'/xml'));
     ...
     */
    public function testOverriddenDefaultsBindings(): void
    {
        $container = new ContainerBuilder();
