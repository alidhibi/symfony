...
class LoaderResolverTest extends TestCase
{
    ...
    private \Symfony\Component\Config\Loader\LoaderResolver $resolver;
    ...
    public function provideResourcesToLoad(): array
    {
        return [
     ...
     */
    public function testResolvesForcedType(string $resource, string $type, $expectedClass): void
    {
