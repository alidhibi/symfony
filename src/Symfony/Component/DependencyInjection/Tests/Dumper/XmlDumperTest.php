...
class XmlDumperTest extends TestCase
{
    ...
    public function testExportParameters(): void
    {
    ...
    public function testAddService(): void
    {
        ...
        try {
            ...
            $this->assertInstanceOf('\RuntimeException', $exception, '->dump() throws a RuntimeException if the container to be dumped has reference to objects or resources');
    ...
    public function testDumpAnonymousServices(): void
    {
...
', $dumper->dump());
    ...
    public function testDumpEntities(): void
    {
...
", $dumper->dump());
     ...
     */
    public function testDumpDecoratedServices(string $expectedXmlDump, $container): void
    {
        $dumper = new XmlDumper($container);
        $this->assertEquals($expectedXmlDump, $dumper->dump());
    }

    public function provideDecoratedServicesData(): array
    {
...
", include $fixturesPath.'/containers/container16.php'],
     ...
     */
    public function testCompiledContainerCanBeDumped(string $containerFile): void
    {
    ...
    public function provideCompiledContainerData(): array
    {
        return [
            ['container8'],
            ['container9'],
    ...
    public function testDumpInlinedServices(): void
    {
    ...
    public function testDumpAbstractServices(): void
    {
