...
$container
    ...
    ->setFactory(static fn($arguments = []) => \Bar\FooClass::getInstance($arguments))
...
;
$container
    ->register('bar', \Bar\FooClass::class)
...
$container
    ->register('method_call1', \Bar\FooClass::class)
...
;
$container
    ->register('service_from_static_method', \Bar\FooClass::class)
    ->setFactory(static fn($arguments = []) => \Bar\FooClass::getInstance($arguments))
    ->setPublic(true)
;
$container
