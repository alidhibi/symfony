...
return static function (ContainerConfigurator $c) : void {
    ...
    $s->set('foo')
        ...
        ->factory(static fn($arguments = []) => \Bar\FooClass::getInstance($arguments))
        ->property('foo', 'bar')
    ...
    $s->set('foo_bar', '%foo_class%')
        ...
        ->share(false);
    $s->set('method_call1', \Bar\FooClass::class)
    ...
    $s->set('service_from_static_method', \Bar\FooClass::class)
        ->factory(static fn($arguments = []) => \Bar\FooClass::getInstance($arguments));
