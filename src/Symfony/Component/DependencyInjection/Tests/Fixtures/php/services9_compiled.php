...
class ProjectServiceContainer extends Container
{
    ...
    {
        return $this->services['lazy_context_ignore_invalid_ref'] = new \LazyContext(new RewindableGenerator(function (): \Generator {
            yield 0 => ${($_ = isset($this->services['foo.baz']) ? $this->services['foo.baz'] : $this->getFoo_BazService()) && false ?: '_'};
        }, 1), new RewindableGenerator(static fn(): \EmptyIterator => new \EmptyIterator(), 0));
    }
    ...
    {
        return $this->services['tagged_iterator'] = new \Bar(new RewindableGenerator(function (): \Generator {
