...
class Symfony_DI_PhpDumper_Test_Uninitialized_Reference extends Container
{
    ...
    protected function getBarService()
    {
        ...
        $instance->closures = [0 => fn() => ${($_ = isset($this->services['foo1']) ? $this->services['foo1'] : null) && false ?: '_'}, 1 => static fn(): null => null, 2 => fn() => ${($_ = isset($this->services['foo3']) ? $this->services['foo3'] : null) && false ?: '_'}];
        ...
        }, fn(): int => (int) (isset($this->services['foo1'])) + (int) (false) + (int) (isset($this->services['foo3'])));
