...
class ProjectServiceContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->normalizedIds = [
            'psr\\container\\containerinterface' => \Psr\Container\ContainerInterface::class,
            'symfony\\component\\dependencyinjection\\containerinterface' => \Symfony\Component\DependencyInjection\ContainerInterface::class,
        ];
        $this->syntheticIds = [
            'request' => true,
        ];
        ...
        $this->aliases = [
            \Psr\Container\ContainerInterface::class => 'service_container',
            \Symfony\Component\DependencyInjection\ContainerInterface::class => 'service_container',
            'alias_for_alias' => 'foo',
            'alias_for_foo' => 'foo',
        ];
    }
    ...
    protected function getFooService()
    {
        ...
        $this->services['foo'] = $instance = \Bar\FooClass::getInstance('foo');
    ...
    {
        return $this->services['lazy_context'] = new \LazyContext(new RewindableGenerator(function (): \Generator {
            yield 'k1' => ${($_ = isset($this->services['foo.baz']) ? $this->services['foo.baz'] : $this->getFoo_BazService()) && false ?: '_'};
            yield 'k2' => $this;
        }, 2), new RewindableGenerator(static fn(): \EmptyIterator => new \EmptyIterator(), 0));
    }
    ...
    protected function getLazyContextIgnoreInvalidRefService()
    {
        ...
        }, fn(): int => 1 + (int) ($this->has('invalid'))), new RewindableGenerator(static fn(): \EmptyIterator => new \EmptyIterator(), 0));
    }
    ...
    {
        include_once __DIR__ . '/%path%foo.php';
    ...
    {
        return $this->services['tagged_iterator'] = new \Bar(new RewindableGenerator(static fn(): \EmptyIterator => new \EmptyIterator(), 0));
    }
