...
{
    public function testDefaultRegisteredDefinitions(): void
    {
    ...
    public function testDefinitions(): void
    {
        $builder = new ContainerBuilder();
        $definitions = [
            'foo' => new Definition(\Bar\FooClass::class),
        ...
        $this->assertEquals([...$definitions, ...$defs], $builder->getDefinitions(), '->addDefinitions() adds the service definitions');

        try {
            $builder->getDefinition('baz');
            $this->fail('->getDefinition() throws a ServiceNotFoundException if the service definition does not exist');
        } catch (ServiceNotFoundException $serviceNotFoundException) {
            $this->assertEquals('You have requested a non-existent service "baz".', $serviceNotFoundException->getMessage(), '->getDefinition() throws a ServiceNotFoundException if the service definition does not exist');
        }
    }
     ...
     */
    public function testCreateDeprecatedService(): void
    {
    ...
    {
        $builder = new ContainerBuilder();
        $builder->register('foo', \Bar\FooClass::class);
        $this->assertTrue($builder->hasDefinition('foo'), '->register() registers a new service definition');
        $this->assertInstanceOf(\Symfony\Component\DependencyInjection\Definition::class, $builder->getDefinition('foo'), '->register() returns the newly created Definition instance');
    }

    public function testAutowire(): void
    {
        $builder = new ContainerBuilder();
        $builder->autowire('foo', \Bar\FooClass::class);
    ...
    public function testGetReturnsNullIfServiceDoesNotExistAndInvalidReferenceIsUsed(): void
    {
        $builder = new ContainerBuilder();
    ...
    public function testRegisterDoesNotOverrideExistingService(): void
    {
        $builder = new ContainerBuilder();
        $builder->set('bar', $bar = new \stdClass());
        $builder->register('bar', 'stdClass');
     ...
     */
    public function testBadAliasId(string $id): void
    {
     ...
     * @dataProvider provideBadId
     */
    public function testBadDefinitionId(string $id): void
    {
        $this->expectException(\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException::class);
        $builder = new ContainerBuilder();
    ...
    public function provideBadId(): array
    {
        return [
            [''],
            ["\0"],
    ...
    public function testGetUnsetLoadingServiceWhenCreateServiceThrowsAnException(): void
    {
    ...
    public function testAliases(): void
    {
        ...
        try {
            ...
            $this->assertEquals('An alias can not reference itself, got a circular reference on "foobar".', $invalidArgumentException->getMessage(), '->setAlias() throws an InvalidArgumentException if the alias references itself');
        }
        ...
        try {
            ...
            $this->assertEquals('The service alias "foobar" does not exist.', $invalidArgumentException->getMessage(), '->getAlias() throws an InvalidArgumentException if the alias does not exist');
        }
    }
    ...
    public function testAliasesKeepInvalidBehavior(): void
    {
        $builder = new ContainerBuilder();
    ...
    public function testAddGetCompilerPass(): void
    {
        $builder = new ContainerBuilder();
    ...
    {
        $builder = new ContainerBuilder();
        $builder->register('foo1', \Bar\FooClass::class)->setFile(__DIR__.'/Fixtures/includes/foo.php');
        $builder->register('foo2', \Bar\FooClass::class)->setFile(__DIR__.'/Fixtures/includes/%file%.php');
    ...
    public function testCreateProxyWithRealServiceInstantiator(): void
    {
        $builder = new ContainerBuilder();
        ...
        $this->assertSame(\Bar\FooClass::class, \get_class($foo1));
    }

    public function testCreateServiceClass(): void
    {
        $builder = new ContainerBuilder();
    ...
    public function testCreateServiceArguments(): void
    {
        $builder = new ContainerBuilder();
        $builder->register('bar', 'stdClass');
        $builder->register('foo1', \Bar\FooClass::class)->addArgument(['foo' => '%value%', '%value%' => 'foo', new Reference('bar'), '%%unescape_it%%']);
    ...
    {
        $builder = new ContainerBuilder();
        $builder->register('foo', \Bar\FooClass::class)->setFactory(\Bar\FooClass::class . '::getInstance');
        $builder->register('qux', \Bar\FooClass::class)->setFactory(static fn($arguments = []) => \Bar\FooClass::getInstance($arguments));
        $builder->register('bar', \Bar\FooClass::class)->setFactory([new Definition(\Bar\FooClass::class), 'getInstance']);
        $builder->register('baz', \Bar\FooClass::class)->setFactory([new Reference('bar'), 'getInstance']);
    ...
    public function testCreateServiceMethodCalls(): void
    {
        $builder = new ContainerBuilder();
        $builder->register('bar', 'stdClass');
        $builder->register('foo1', \Bar\FooClass::class)->addMethodCall('setBar', [['%value%', new Reference('bar')]]);
        $builder->setParameter('value', 'bar');
    ...
    public function testCreateServiceMethodCallsWithEscapedParam(): void
    {
        $builder = new ContainerBuilder();
        $builder->register('bar', 'stdClass');
        $builder->register('foo1', \Bar\FooClass::class)->addMethodCall('setBar', [['%%unescape_it%%']]);
        $builder->setParameter('value', 'bar');
        $this->assertEquals(['%unescape_it%'], $builder->get('foo1')->bar, '->createService() replaces the values in the method calls arguments');
    }

    public function testCreateServiceProperties(): void
    {
        $builder = new ContainerBuilder();
        $builder->register('bar', 'stdClass');
        $builder->register('foo1', \Bar\FooClass::class)->setProperty('bar', ['%value%', new Reference('bar'), '%%unescape_it%%']);
        $builder->setParameter('value', 'bar');
    ...
    public function testCreateServiceConfigurator(): void
    {
        $builder = new ContainerBuilder();
        $builder->register('foo1', \Bar\FooClass::class)->setConfigurator('sc_configure');
        $builder->register('foo2', \Bar\FooClass::class)->setConfigurator(['%class%', 'configureStatic']);
        $builder->setParameter('class', 'BazClass');
        $builder->register('baz', 'BazClass');
        $builder->register('foo3', \Bar\FooClass::class)->setConfigurator([new Reference('baz'), 'configure']);
        $builder->register('foo4', \Bar\FooClass::class)->setConfigurator([$builder->getDefinition('baz'), 'configure']);
        $builder->register('foo5', \Bar\FooClass::class)->setConfigurator('foo');
        ...
        try {
            ...
            $this->assertEquals('The configure callable for class "Bar\FooClass" is not a callable.', $invalidArgumentException->getMessage(), '->createService() throws an InvalidArgumentException if the configure callable is not a valid callable');
        }
    }

    public function testCreateServiceWithIteratorArgument(): void
    {
        $builder = new ContainerBuilder();
        $builder->register('bar', 'stdClass');
        $builder
        ...
        $i = 0;
        foreach ($lazyContext->lazyEmptyValues as $v) {
            ++$i;
        }
    ...
    public function testCreateSyntheticService(): void
    {
        $this->expectException('RuntimeException');
        $builder = new ContainerBuilder();
        $builder->register('foo', \Bar\FooClass::class)->setSynthetic(true);
        $builder->get('foo');
    }

    public function testCreateServiceWithExpression(): void
    {
        $builder = new ContainerBuilder();
        $builder->setParameter('bar', 'bar');
        $builder->register('bar', 'BarClass');
        $builder->register('foo', \Bar\FooClass::class)->addArgument(['foo' => new Expression('service("bar").foo ~ parameter("bar")')]);
    ...
    public function testResolveServicesWithDecoratedDefinition(): void
    {
        $this->expectException(\Symfony\Component\DependencyInjection\Exception\RuntimeException::class);
    ...
    public function testResolveServicesWithCustomDefinitionClass(): void
    {
        $builder = new ContainerBuilder();
    ...
    public function testMerge(): void
    {
        ...
        $container->setResourceTracking(false);
        $container->register('foo', \Bar\FooClass::class);
    ...
    public function testMergeThrowsExceptionForDuplicateAutomaticInstanceofDefinitions(): void
    {
        $this->expectException(\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException::class);
    ...
    public function testResolveEnvValues(): void
    {
    ...
    public function testResolveEnvValuesWithArray(): void
    {
        ...
        foreach (array_keys($dummyArray) as $key) {
    ...
    public function testCompileWithResolveEnv(): void
    {
    ...
    public function testCompileWithArrayResolveEnv(): void
    {
    ...
    public function testCompileWithArrayAndAnotherResolveEnv(): void
    {
    ...
    public function testCompileWithArrayInStringResolveEnv(): void
    {
        $this->expectException(\Symfony\Component\DependencyInjection\Exception\RuntimeException::class);
    ...
    public function testCompileWithResolveMissingEnv(): void
    {
    ...
    public function testDynamicEnv(): void
    {
    ...
    public function testCastEnv(): void
    {
        $container = new ContainerBuilder();
    ...
    public function testEnvAreNullable(): void
    {
        $container = new ContainerBuilder();
    ...
    public function testEnvInId(): void
    {
    ...
    public function testCircularDynamicEnv(): void
    {
    ...
    public function testMergeLogicException(): void
    {
    ...
    public function testfindTaggedServiceIds(): void
    {
        $builder = new ContainerBuilder();
        $builder
            ->register('foo', \Bar\FooClass::class)
            ->addTag('foo', ['foo' => 'foo'])
            ->addTag('bar', ['bar' => 'bar'])
    ...
    {
        $container = new ContainerBuilder();
        $container->setDefinition('foo', $definition = new Definition(\Bar\FooClass::class));
        $container->setAlias('bar', 'foo');
        $container->setAlias('foobar', 'bar');
        $this->assertEquals($definition, $container->findDefinition('foobar'), '->findDefinition() returns a Definition');
    }

    public function testAddObjectResource(): void
    {
        $container = new ContainerBuilder();
        ...
        $this->assertInstanceOf(\Symfony\Component\Config\Resource\FileResource::class, $resource);
     ...
     * @group legacy
     */
    public function testAddClassResource(): void
    {
        $container = new ContainerBuilder();
    ...
    public function testGetReflectionClassOnInternalTypes(): void
    {
        $container = new ContainerBuilder();
    ...
    public function testCompilesClassDefinitionsOfLazyServices(): void
    {
        $container = new ContainerBuilder();
        ...
        $matchingResources = array_filter(
            ...
            static fn(ResourceInterface $resource): bool => 'reflection.BarClass' === (string) $resource
        );
    ...
    public function testRegisteredButNotLoadedExtension(): void
    {
    ...
    public function testRegisteredAndLoadedExtension(): void
    {
        $extension = $this->getMockBuilder(\Symfony\Component\DependencyInjection\Extension\ExtensionInterface::class)->getMock();
    ...
    public function testPrivateServiceUser(): void
    {
    ...
    public function testThrowsExceptionWhenSetServiceOnACompiledContainer(): void
    {
    ...
    public function testNoExceptionWhenAddServiceOnACompiledContainer(): void
    {
        $container = new ContainerBuilder();
        $container->compile();
    ...
    public function testNoExceptionWhenSetSyntheticServiceOnACompiledContainer(): void
    {
        $container = new ContainerBuilder();
    ...
    public function testThrowsExceptionWhenSetDefinitionOnACompiledContainer(): void
    {
        $this->expectException('BadMethodCallException');
        $container = new ContainerBuilder();
        $container->setResourceTracking(false);
    ...
    public function testLazyLoadedService(): void
    {
    ...
    public function testInlinedDefinitions(): void
    {
        $container = new ContainerBuilder();
    ...
    public function testInitializePropertiesBeforeMethodCalls(): void
    {
        $container = new ContainerBuilder();
        $container->register('foo', 'stdClass');
    ...
    public function testClassFromId(): void
    {
        $container = new ContainerBuilder();
    ...
    public function testNoClassFromGlobalNamespaceClassId(): void
    {
        $this->expectException(\Symfony\Component\DependencyInjection\Exception\RuntimeException::class);
    ...
    public function testNoClassFromGlobalNamespaceClassIdWithLeadingSlash(): void
    {
        $this->expectException(\Symfony\Component\DependencyInjection\Exception\RuntimeException::class);
        $this->expectExceptionMessage('The definition for "\DateTime" has no class attribute, and appears to reference a class or interface in the global namespace.');
        $container = new ContainerBuilder();
    ...
    public function testNoClassFromNamespaceClassIdWithLeadingSlash(): void
    {
        $this->expectException(\Symfony\Component\DependencyInjection\Exception\RuntimeException::class);
    ...
    public function testNoClassFromNonClassId(): void
    {
        $this->expectException(\Symfony\Component\DependencyInjection\Exception\RuntimeException::class);
    ...
    public function testNoClassFromNsSeparatorId(): void
    {
        $this->expectException(\Symfony\Component\DependencyInjection\Exception\RuntimeException::class);
    ...
    public function testUninitializedReference(): void
    {
     ...
     */
    public function testAlmostCircular(string $visibility): void
    {
    ...
    public function provideAlmostCircular(): \Generator
    {
        yield ['public'];
        yield ['private'];
    }
     ...
     */
    public function testParameterWithMixedCase(): void
    {
    ...
    public function testArgumentsHaveHigherPriorityThanBindings(): void
    {
        $container = new ContainerBuilder();
        ...
        $this->assertSame(['service_container', 'class.via.bindings', 'class.via.argument', 'foo', \Psr\Container\ContainerInterface::class, \Symfony\Component\DependencyInjection\ContainerInterface::class], $container->getServiceIds());
    ...
    public function testDecoratedSelfReferenceInvolvingPrivateServices(): void
    {
        $container = new ContainerBuilder();
        $container->register('foo', 'stdClass')
            ->setPublic(false)
    ...
    public function testScalarService(): void
    {
        ...
        $c->register('foo', 'string')
            ->setPublic(true)
            ->setFactory(static fn(): string => \Symfony\Component\DependencyInjection\Tests\Fixtures\ScalarFactory::getSomeValue())
        ;
