...
class ResolveNamedArgumentsPassTest extends TestCase
{
    ...
    public function testCorrectMethodReportedInException(): void
    {
        $this->expectException(\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException::class);
        $this->expectExceptionMessage('Invalid service "Symfony\Component\DependencyInjection\Tests\Fixtures\TestDefinition1": method "' . \Symfony\Component\DependencyInjection\Tests\Fixtures\FactoryDummyWithoutReturnTypes::class . '::createTestDefinition1()" has no argument named "$notFound". Check your service definition.');
        $container = new ContainerBuilder();
        ...
        $definition->setFactory(static fn() => (new \Symfony\Component\DependencyInjection\Tests\Fixtures\FactoryDummyWithoutReturnTypes())->createTestDefinition1());
        $definition->setArguments(['$notFound' => '123']);
    ...
    public function testResolvesMultipleArgumentsOfTheSameType(): void
    {
        $container = new ContainerBuilder();
    ...
    public function testResolvePrioritizeNamedOverType(): void
    {
        $container = new ContainerBuilder();
