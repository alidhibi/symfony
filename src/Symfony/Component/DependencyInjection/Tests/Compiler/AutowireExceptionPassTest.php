...
class AutowireExceptionPassTest extends TestCase
{
    public function testThrowsException(): void
    {
        ...
        try {
            ...
            $this->assertSame($autowireException, $exception);
        }
    }

    public function testThrowExceptionIfServiceInlined(): void
    {
        $autowirePass = $this->getMockBuilder(AutowirePass::class)
            ->getMock();
    ...
    public function testDoNotThrowExceptionIfServiceInlinedButRemoved(): void
    {
        $autowirePass = $this->getMockBuilder(AutowirePass::class)
            ->getMock();
    ...
    public function testNoExceptionIfServiceRemoved(): void
    {
        $autowirePass = $this->getMockBuilder(AutowirePass::class)
            ->getMock();
