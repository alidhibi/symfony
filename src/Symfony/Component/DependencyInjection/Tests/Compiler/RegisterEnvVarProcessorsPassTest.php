...
class RegisterEnvVarProcessorsPassTest extends TestCase
{
    ...
    public function testBadProcessor(): void
    {
        ...
        $this->expectExceptionMessage('Invalid type "foo" returned by "' . \Symfony\Component\DependencyInjection\Tests\Compiler\BadProcessor::class . '::getProvidedTypes()", expected one of "array", "bool", "float", "int", "string".');
        $container = new ContainerBuilder();
