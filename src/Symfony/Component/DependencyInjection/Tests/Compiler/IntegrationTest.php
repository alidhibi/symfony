...
class IntegrationTest extends TestCase
{
    ...
    public function testCanDecorateServiceSubscriber(): void
    {
        $container = new ContainerBuilder();
     ...
     */
    public function testYamlContainerCompiles(string $directory, string $actualServiceId, string $expectedServiceId, ContainerBuilder $mainContainer = null): void
    {
    ...
    public function getYamlCompileTests(): \Generator
    {
        $container = new ContainerBuilder();
