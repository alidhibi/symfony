...
class ChildDefinition extends Definition
{
     ...
     */
    public function replaceArgument($index, $value): static
    {
        if (\is_int($index)) {
     ...
     * @internal
     */
    public function setAutoconfigured($autoconfigured): never
    {
     ...
     * @internal
     */
    public function setInstanceofConditionals(array $instanceof): never
    {
