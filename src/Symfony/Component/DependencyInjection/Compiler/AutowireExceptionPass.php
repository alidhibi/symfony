...
{
    private ?\Symfony\Component\DependencyInjection\Compiler\AutowirePass $autowirePass = null;

    private ?\Symfony\Component\DependencyInjection\Compiler\InlineServiceDefinitionsPass $inlineServicePass = null;
    ...
    public function process(ContainerBuilder $container): void
    {
        ...
        if (!$this->autowirePass instanceof \Symfony\Component\DependencyInjection\Compiler\AutowirePass || !$this->inlineServicePass instanceof \Symfony\Component\DependencyInjection\Compiler\InlineServiceDefinitionsPass) {
            return;
        }
    ...
    private function doesServiceExistInTheContainer($serviceId, ContainerBuilder $container, array $inlinedIds): bool
    {
