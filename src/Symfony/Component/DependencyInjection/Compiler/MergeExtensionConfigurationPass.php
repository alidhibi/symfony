...
class MergeExtensionConfigurationContainerBuilder extends ContainerBuilder
{
     ...
     * {@inheritdoc}
     */
    public function addCompilerPass(CompilerPassInterface $pass, $type = PassConfig::TYPE_BEFORE_OPTIMIZATION/*, int $priority = 0*/): never
    {
     ...
     * {@inheritdoc}
     */
    public function registerExtension(ExtensionInterface $extension): never
    {
     ...
     * {@inheritdoc}
     */
    public function compile($resolveEnvPlaceholders = false): never
    {
