...
class ResolveInvalidReferencesPass implements CompilerPassInterface
{
    ...
    private ?\Symfony\Component\DependencyInjection\Exception\RuntimeException $signalingException = null;
     ...
     */
    private function processValue($value, $rootLevel = 0, int|float $level = 0)
    {
