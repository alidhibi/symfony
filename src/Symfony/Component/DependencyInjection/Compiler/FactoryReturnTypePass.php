...
{
    private ?\Symfony\Component\DependencyInjection\Compiler\ResolveClassPass $resolveClassPass = null;

    public function __construct(ResolveClassPass $resolveClassPass = null)
    {
        if (!$resolveClassPass instanceof \Symfony\Component\DependencyInjection\Compiler\ResolveClassPass) {
    ...
    public function process(ContainerBuilder $container): void
    {
        ...
        $resolveClassPassChanges = $this->resolveClassPass instanceof \Symfony\Component\DependencyInjection\Compiler\ResolveClassPass ? $this->resolveClassPass->getChanges() : [];
    ...
    private function updateDefinition(ContainerBuilder $container, $id, Definition $definition, array $resolveClassPassChanges, array $previous = []): void
    {
        // circular reference
        ...
        if (\is_string($factory)) {
            ...
            if (($m = $container->getReflectionClass($class, false)) === null) {
                return;
            }
