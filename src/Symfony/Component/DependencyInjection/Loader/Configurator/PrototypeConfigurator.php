...
class PrototypeConfigurator extends AbstractServiceConfigurator
{
    ...
    private ?\Symfony\Component\DependencyInjection\Loader\PhpFileLoader $loader = null;
    ...
    public function __destruct()
    {
        ...
        if ($this->loader instanceof \Symfony\Component\DependencyInjection\Loader\PhpFileLoader) {
     ...
     * @return $this
     */
    final public function exclude($exclude): static
    {
