...
class XmlDumper extends Dumper
{
     ...
     * @param string $type
     */
    private function convertParameters(array $parameters, $type, \DOMElement $parent, string $keyAttribute = 'key'): void
    {
     ...
     */
    public static function phpToXml(string $value)
    {
        switch (true) {
            case null === $value:
                return 'null';
