...
class GraphvizDumper extends Dumper
{
     ...
     */
    private function findEdges($id, array $arguments, $required, $name, $lazy = false): array
    {
        $edges = [];
    ...
    private function cloneContainer(): \Symfony\Component\DependencyInjection\ContainerBuilder
    {
