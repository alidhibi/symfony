...
class Container implements ResettableContainerInterface
{
    ...
    private array $underscoreMap = ['_' => '', '.' => '_', '\\' => '_'];
    ...
    public function get($id, $invalidBehavior = /* self::EXCEPTION_ON_INVALID_REFERENCE */ 1)
    {
        ...
        for ($i = 2;;) {
            ...
            if (isset($this->loading[$id])) {
                throw new ServiceCircularReferenceException($id, [...array_keys($this->loading), $id]);
            }
    ...
    {
        if (isset($this->resolving[$envName = sprintf('env(%s)', $name)])) {
