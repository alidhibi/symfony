...
class UrlPackage extends Package
{
    ...
    private ?\Symfony\Component\Asset\UrlPackage $sslPackage = null;
    ...
    public function getUrl($path)
    {
        ...
        if ($this->sslPackage instanceof \Symfony\Component\Asset\UrlPackage && $this->getContext()->isSecure()) {
     ...
     */
    protected function chooseBaseUrl($path): int
    {
