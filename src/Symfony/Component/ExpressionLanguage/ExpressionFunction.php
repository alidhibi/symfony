...
class ExpressionFunction
{
    ...
    public static function fromPhp($phpFunctionName, $expressionFunctionName = null): self
    {
        ...
        $compiler = static fn(): string => sprintf('\%s(%s)', $phpFunctionName, implode(', ', \func_get_args()));

        $evaluator = static fn(...$args): mixed => \call_user_func_array($phpFunctionName, array_splice($args, 1));
