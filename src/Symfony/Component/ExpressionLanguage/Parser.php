...
class Parser
{
    final const OPERATOR_LEFT = 1;

    final const OPERATOR_RIGHT = 2;

    private ?\Symfony\Component\ExpressionLanguage\TokenStream $stream = null;
    ...
    public function parseArrayExpression(): \Symfony\Component\ExpressionLanguage\Node\ArrayNode
    {
    ...
    public function parseHashExpression(): \Symfony\Component\ExpressionLanguage\Node\ArrayNode
    {
     ...
     * Parses arguments.
     */
    public function parseArguments(): \Symfony\Component\ExpressionLanguage\Node\Node
    {
        $args = [];
