...
class ParserTest extends TestCase
{
     ...
     */
    public function testParse($node, string $expression, array $names = []): void
    {
        $lexer = new Lexer();
        $parser = new Parser([]);
    ...
    private function createGetAttrNode($node, string $item, int $type): \Symfony\Component\ExpressionLanguage\Node\GetAttrNode
    {
