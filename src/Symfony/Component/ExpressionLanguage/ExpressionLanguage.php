...
{
    private readonly \Psr\Cache\CacheItemPoolInterface|\Symfony\Component\ExpressionLanguage\ParserCache\ParserCacheAdapter|\Symfony\Component\Cache\Adapter\ArrayAdapter $cache;

    private ?\Symfony\Component\ExpressionLanguage\Lexer $lexer = null;

    private ?\Symfony\Component\ExpressionLanguage\Parser $parser = null;

    private ?\Symfony\Component\ExpressionLanguage\Compiler $compiler = null;
    ...
    {
        if ($this->parser instanceof \Symfony\Component\ExpressionLanguage\Parser) {
    ...
    {
        if (!$this->lexer instanceof \Symfony\Component\ExpressionLanguage\Lexer) {
    ...
    {
        if (!$this->compiler instanceof \Symfony\Component\ExpressionLanguage\Compiler) {
