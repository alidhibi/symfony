...
abstract class IteratorTestCase extends TestCase
{
    protected function assertIterator($expected, \Traversable $iterator)
    {
        ...
        $values = array_map(static fn(\SplFileInfo $fileinfo): array|string => str_replace('/', \DIRECTORY_SEPARATOR, $fileinfo->getPathname()), iterator_to_array($iterator, false));

        $expected = array_map(static fn($path): array|string => str_replace('/', \DIRECTORY_SEPARATOR, $path), $expected);
    ...
    {
        $values = array_map(static fn(\SplFileInfo $fileinfo) => $fileinfo->getPathname(), iterator_to_array($iterator));
