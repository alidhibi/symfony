...
class SortableIteratorTest extends RealIteratorTestCase
{
    public function testConstructor(): void
    {
        try {
            ...
            $this->assertInstanceOf('InvalidArgumentException', $exception, '__construct() throws an \InvalidArgumentException exception if the mode is not valid');
        }
    }
     ...
     */
    public function testAccept(int|\Closure $mode, array $expected): void
    {
        if (!\is_callable($mode)) {
            switch ($mode) {
    ...
    public function getAcceptData(): array
    {
        ...
        return [
            ...
            [static fn(\SplFileInfo $a, \SplFileInfo $b): int => strcmp($a->getRealPath(), $b->getRealPath()), $this->toAbsolute($customComparison)],
        ];
    }
}
