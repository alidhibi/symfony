...
class RedisProxy
{
    ...
    public function hscan($strKey, &$iIterator, $strPattern = null, $iCount = null): \Redis|bool|array
    {
        $this->ready ?: $this->ready = $this->initializer->__invoke($this->redis);
    ...
    public function scan(&$iIterator, $strPattern = null, $iCount = null): array|bool
    {
        $this->ready ?: $this->ready = $this->initializer->__invoke($this->redis);
    ...
    public function sscan($strKey, &$iIterator, $strPattern = null, $iCount = null): \Redis|array|bool
    {
        $this->ready ?: $this->ready = $this->initializer->__invoke($this->redis);
    ...
    public function zscan($strKey, &$iIterator, $strPattern = null, $iCount = null): \Redis|array|bool
    {
        $this->ready ?: $this->ready = $this->initializer->__invoke($this->redis);
