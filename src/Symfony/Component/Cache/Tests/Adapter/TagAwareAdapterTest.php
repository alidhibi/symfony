...
class TagAwareAdapterTest extends AdapterTestCase
{
    ...
    public function testTagEntryIsCreatedForItemWithoutTags(): void
    {
        $pool = $this->createCachePool();
    ...
    public function testHasItemReturnsFalseWhenPoolDoesNotHaveItemTags(): void
    {
        $pool = $this->createCachePool();
    ...
    public function testGetItemReturnsCacheMissWhenPoolDoesNotHaveItemTags(): void
    {
        $pool = $this->createCachePool();
    ...
    public function testHasItemReturnsFalseWhenPoolDoesNotHaveItemAndOnlyHasTags(): void
    {
        $pool = $this->createCachePool();
    ...
    public function testGetItemReturnsCacheMissWhenPoolDoesNotHaveItemAndOnlyHasTags(): void
    {
        $pool = $this->createCachePool();
