...
{
    protected \Symfony\Component\Templating\Loader\LoaderInterface $loader;
    ...
    private ?\Symfony\Component\Templating\Storage\Storage $evalTemplate = null;

    private ?array $evalParameters = null;
     ...
     */
    protected function evaluate(Storage $template, array $parameters = []): string|bool
    {
     ...
     */
    public function offsetUnset($name): never
    {
    ...
    protected function initializeEscapers()
    {
        ...
        $this->escapers = [
            ...
            'js' =>
                 ...
                 * @return string the escaped value
                 */
                function ($value): string|array|bool {
