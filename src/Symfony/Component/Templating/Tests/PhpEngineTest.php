...
class PhpEngineTest extends TestCase
{
    ...
    public function testOffsetGet(): void
    {
        ...
        try {
            ...
            $this->assertInstanceOf('\InvalidArgumentException', $exception, '->offsetGet() throws an InvalidArgumentException if the helper is not defined');
            $this->assertEquals('The helper "bar" is not defined.', $exception->getMessage(), '->offsetGet() throws an InvalidArgumentException if the helper is not defined');
        }
    }
    ...
    public function testGetSetHas(): void
    {
        ...
        try {
            ...
            $this->assertInstanceOf('\InvalidArgumentException', $exception, '->get() throws an InvalidArgumentException if the helper is not defined');
            $this->assertEquals('The helper "foobar" is not defined.', $exception->getMessage(), '->get() throws an InvalidArgumentException if the helper is not defined');
        }
    ...
    public function testExtendRender(): void
    {
        ...
        try {
            ...
            $this->assertInstanceOf('\InvalidArgumentException', $exception, '->render() throws an InvalidArgumentException if the template does not exist');
            $this->assertEquals('The template "name" does not exist.', $exception->getMessage(), '->render() throws an InvalidArgumentException if the template does not exist');
        }
     ...
     */
    public function testRenderForbiddenParameter(string $name): void
    {
...
class ProjectTemplateLoader extends Loader
{
    ...
    public function load(TemplateReferenceInterface $template): \Symfony\Component\Templating\Storage\StringStorage|bool
    {
