...
class RegisterListenersPassTest extends TestCase
{
    ...
    public function testValidEventSubscriber(): void
    {
        ...
        $builder->register('my_event_subscriber', \Symfony\Component\EventDispatcher\Tests\DependencyInjection\SubscriberService::class)
            ->addTag('kernel.event_subscriber');
    ...
    public function testEventSubscriberResolvableClassName(): void
    {
        ...
        $container->setParameter('subscriber.class', \Symfony\Component\EventDispatcher\Tests\DependencyInjection\SubscriberService::class);
