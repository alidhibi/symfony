...
{
    private readonly \Symfony\Component\Ldap\Adapter\ExtLdap\Connection $connection;

    private readonly \Symfony\Component\Ldap\Adapter\ExtLdap\Query $search;
    ...
    private function getSingleEntry($con, \LDAP\ResultEntry $current): \Symfony\Component\Ldap\Entry
    {
