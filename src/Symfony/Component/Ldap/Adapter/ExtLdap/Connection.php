...
class Connection extends AbstractConnection
{
    ...
    private \LDAP\Connection|bool|null $connection = null;
     ...
     * @internal
     */
    public function getResource(): \LDAP\Connection|bool|null
    {
    ...
    protected function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setNormalizer('options', static function (Options $options, array $value) : array {
        ...
        $resolver->setAllowedValues('options', static function (array $values) : bool {
