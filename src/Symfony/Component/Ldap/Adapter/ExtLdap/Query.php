...
class Query extends AbstractQuery
{
    ...
    private null|array|\LDAP\Result|bool $search = null;
     ...
     * {@inheritdoc}
     */
    public function execute(): \Symfony\Component\Ldap\Adapter\ExtLdap\Collection
    {
        if (null === $this->search) {
     ...
     * @internal
     */
    public function getResource(): \LDAP\Result|bool|array|null
    {
        return $this->search;
    }
}
