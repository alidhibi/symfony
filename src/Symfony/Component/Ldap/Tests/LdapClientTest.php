...
{
    private \Symfony\Component\Ldap\LdapClient $client;
    ...
    public function testLdapFind(): void
    {
     ...
     */
    public function testLdapClientFunctional(): void
    {
