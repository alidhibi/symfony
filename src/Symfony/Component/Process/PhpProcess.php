...
class PhpProcess extends Process
{
     ...
     */
    public function __construct(mixed $script, string $cwd = null, array $env = null, ?float $timeout = 60, array $options = null)
    {
        $executableFinder = new PhpExecutableFinder();
        $php = false === $php = $executableFinder->find(false) ? null : [$php, ...$executableFinder->findArguments()];
