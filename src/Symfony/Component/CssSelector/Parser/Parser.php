...
{
    private readonly \Symfony\Component\CssSelector\Parser\Tokenizer\Tokenizer $tokenizer;
     ...
     * @throws SyntaxErrorException
     */
    private function parserSelectorNode(TokenStream $stream): \Symfony\Component\CssSelector\Node\SelectorNode
    {
     ...
     *
     */
    private function parseElementNode(TokenStream $stream): \Symfony\Component\CssSelector\Node\ElementNode
    {
        $peek = $stream->getPeek();
     ...
     * @throws SyntaxErrorException
     */
    private function parseAttributeNode(Node\NodeInterface $selector, TokenStream $stream): \Symfony\Component\CssSelector\Node\AttributeNode
    {
        $stream->skipWhitespace();
