...
class TranslatorTest extends TestCase
{
    ...
    public function testXpathLiteral(string $value, string $literal): void
    {
        $this->assertEquals($literal, Translator::getXpathLiteral($value));
    }

    /** @dataProvider getCssToXPathTestData */
    public function testCssToXPath(string $css, string $xpath): void
    {
    ...
    public function testXmlLang(string $css, array $elementsId): void
    {
        $translator = new Translator();
    ...
    public function testHtmlIds(string $css, array $elementsId): void
    {
        $translator = new Translator();
        $translator->registerExtension(new HtmlExtension($translator));
    ...
    public function testHtmlShakespear(string $css, int $count): void
    {
        $translator = new Translator();
        $translator->registerExtension(new HtmlExtension($translator));
