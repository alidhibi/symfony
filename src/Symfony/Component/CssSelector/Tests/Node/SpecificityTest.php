...
class SpecificityTest extends TestCase
{
    ...
    public function testValue(Specificity $specificity, int $value): void
    {
        $this->assertEquals($value, $specificity->getValue());
    }

    /** @dataProvider getValueTestData */
    public function testPlusValue(Specificity $specificity, int $value): void
    {
    ...
    public function testCompareTo(Specificity $a, Specificity $b, int $result): void
    {
