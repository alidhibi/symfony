...
{
    private readonly \Symfony\Component\CssSelector\Parser\ParserInterface $mainParser;
     ...
     * {@inheritdoc}
     */
    public function selectorToXPath(SelectorNode $selector, $prefix = 'descendant-or-self::'): string
    {
