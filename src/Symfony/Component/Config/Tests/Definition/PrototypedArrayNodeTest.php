...
class PrototypedArrayNodeTest extends TestCase
{
    ...
    protected function getPrototypeNodeWithDefaultChildren(): \Symfony\Component\Config\Definition\PrototypedArrayNode
    {
        $node = new PrototypedArrayNode('root');
        $prototype = new ArrayNode(null, $node);
     ...
     */
    public function testMappedAttributeKeyIsRemovedLeftValueOnly(\Symfony\Component\Config\Definition\NodeInterface $value, array $children, array $expected): void
    {
        $node = new PrototypedArrayNode('root');
        $node->setKeyAttribute('id', true);
