...
class ArrayNodeTest extends TestCase
{
     ...
     */
    public function testIgnoreAndRemoveBehaviors(bool $ignore, bool $remove, \Symfony\Component\Config\Definition\Exception\InvalidConfigurationException|array $expected, string $message = ''): void
    {
    ...
    public function testSetDeprecated(): void
    {
        ...
        $deprecationHandler = static function ($level, $message, $file, $line) use (&$prevErrorHandler, &$deprecationTriggered) : bool {
