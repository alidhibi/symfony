...
class ReflectionClassResourceTest extends TestCase
{
     ...
     */
    public function testHashedSignature(int $changeExpected, int $changedLine, ?string $changedCode, \Closure $setContext = null): void
    {
        if ($setContext instanceof \Closure) {
            $setContext();
        }
