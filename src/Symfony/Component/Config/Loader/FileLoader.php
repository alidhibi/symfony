...
abstract class FileLoader extends Loader
{
     ...
     * @internal
     */
    protected function glob($pattern, $recursive, array &$resource = null, $ignoreErrors = false)
    {
        ...
        } catch (FileLocatorFileNotFoundException $fileLocatorFileNotFoundException) {
            if (!$ignoreErrors) {
                throw $fileLocatorFileNotFoundException;
            }

            $resource = [];
            foreach ($fileLocatorFileNotFoundException->getPaths() as $path) {
