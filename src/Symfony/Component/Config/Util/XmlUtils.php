...
class XmlUtils
{
    ...
    public static function loadFile($file, $schemaOrCallable = null)
    {
        ...
        try {
            ...
            throw new XmlParsingException(sprintf('The XML file "%s" is not valid.', $file), 0, $invalidXmlException->getPrevious());
        }
    }
    ...
    public static function phpize($value)
    {
        ...
        if (isset($value[1]) && '0b' == $value[0].$value[1] && preg_match('/^0b[01]*$/', $value)) {
            return bindec($value);
        }
        if (is_numeric($value)) {
     ...
     * @return string[]
     */
    protected static function getXmlErrors($internalErrors): array
    {
        $errors = [];
