...
class ArrayNodeDefinition extends NodeDefinition implements ParentNodeDefinitionInterface
{
     ...
     * @return $this
     */
    public function addDefaultChildrenIfNoneSet($children = null): static
    {
     ...
     * @return $this
     */
    public function fixXmlConfig($singular, $plural = null): static
    {
     ...
     * @return $this
     */
    public function useAttributeAsKey($name, $removeKeyItem = true): static
    {
        $this->key = $name;
     ...
     * @return $this
     */
    public function canBeUnset($allow = true): static
    {
     ...
     * @return $this
     */
    public function ignoreExtraKeys($remove = true): static
    {
     ...
     * @return $this
     */
    public function normalizeKeys($bool): static
    {
