...
class PrototypedArrayNode extends ArrayNode
{
     ...
     */
    public function setAddChildrenIfNoneSet($children = ['defaults']): void
    {
        if (null === $children) {
     ...
     */
    protected function normalizeValue($value): bool|array
    {
        if (false === $value) {
            return $value;
        }
                    ...
                    if (array_keys($v) === ['value']) {
                        ...
                        if ($this->prototype instanceof ArrayNode && ($children = $this->prototype->getChildren()) && \array_key_exists('value', $children)) {
                            ...
                            if (\is_array($originalClosures)) {
                                ...
                                $valuePrototype->normalizationClosures = \is_array($valuePrototypeClosures) ? [...$originalClosures, ...$valuePrototypeClosures] : $originalClosures;
                            }
