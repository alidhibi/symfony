...
class Stopwatch
{
     ...
     * @var Section[]
     */
    private ?array $activeSections = null;
    ...
    {
        $this->sections = ['__root__' => new Section(null, $this->morePrecision)];
        $this->activeSections = ['__root__' => new Section(null, $this->morePrecision)];
    }
}
