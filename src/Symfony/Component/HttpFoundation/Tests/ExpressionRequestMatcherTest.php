...
class ExpressionRequestMatcherTest extends TestCase
{
     ...
     */
    public function testMatchesWhenParentMatchesIsTrue(string $expression, bool $expected): void
    {
     ...
     * @dataProvider provideExpressions
     */
    public function testMatchesWhenParentMatchesIsFalse(string $expression): void
    {
        $request = Request::create('/foo');
