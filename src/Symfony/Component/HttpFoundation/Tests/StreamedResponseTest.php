...
class StreamedResponseTest extends TestCase
{
    ...
    public function testSendContent(): void
    {
        ...
        $response = new StreamedResponse(static function () use (&$called) : void {
            ++$called;
        });
    ...
    {
        $response = StreamedResponse::create(static function () : void {
        }, 204);
    ...
    public function testReturnThis(): void
    {
        ...
        $this->assertInstanceOf(\Symfony\Component\HttpFoundation\StreamedResponse::class, $response->sendContent());
        $this->assertInstanceOf(\Symfony\Component\HttpFoundation\StreamedResponse::class, $response->sendContent());

        $response = new StreamedResponse(static function () : void {
        });
        $this->assertInstanceOf(\Symfony\Component\HttpFoundation\StreamedResponse::class, $response->sendHeaders());
        $this->assertInstanceOf(\Symfony\Component\HttpFoundation\StreamedResponse::class, $response->sendHeaders());
    }
