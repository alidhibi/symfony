...
class NamespacedAttributeBagTest extends TestCase
{
    ...
    private ?\Symfony\Component\HttpFoundation\Session\Attribute\NamespacedAttributeBag $bag = null;
     ...
     * @dataProvider attributesProvider
     */
    public function testHasNoSideEffect(string $key, string|array|null $value, bool $expected): void
    {
     ...
     * @dataProvider attributesProvider
     */
    public function testGetNoSideEffect(string $key, string|array|null $value, bool $expected): void
    {
        $expected = json_encode($this->bag->all());
        $this->bag->get($key);
    ...
    public function testRemoveExistingNamespacedAttribute(): void
    {
        $this->assertSame('cod', $this->bag->remove('category/fishing/first'));
    }

    public function testRemoveNonexistingNamespacedAttribute(): void
    {
