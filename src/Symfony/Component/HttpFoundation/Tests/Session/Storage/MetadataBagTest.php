...
class MetadataBagTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->array = [MetadataBag::CREATED => 1_234_567, MetadataBag::UPDATED => 12_345_678, MetadataBag::LIFETIME => 0];
    ...
    {
        $bag = new MetadataBag();
        $array = [MetadataBag::CREATED => 1_234_567, MetadataBag::UPDATED => 12_345_678, MetadataBag::LIFETIME => 1000];
    ...
    {
        $this->assertEquals(1_234_567, $this->bag->getCreated());
    }

    public function testGetLastUsed(): void
    {
    ...
    public function testSkipLastUsedUpdate(): void
    {
    ...
    public function testDoesNotSkipLastUsedUpdate(): void
    {
        $bag = new MetadataBag('', 30);
        $timeStamp = time();
