...
class MongoDbSessionHandlerTest extends TestCase
{
    ...
    private \Symfony\Component\HttpFoundation\Session\Storage\Handler\MongoDbSessionHandler $storage;
    ...
    public function testConstructorShouldThrowExceptionForInvalidMongo(): void
    {
    ...
    public function testRead(): void
    {
        ...
        $collection->expects($this->once())
            ->method('findOne')
            ->willReturnCallback(function (array $criteria) use ($testTimeout): array {
    ...
    public function testWrite(): void
    {
        ...
        $collection->expects($this->once())
            ->method($methodName)
            ->willReturnCallback(function ($criteria, array $updateData, $options) use (&$data): void {
    ...
    public function testWriteWhenUsingExpiresField(): void
    {
        $this->options = [
            'id_field' => '_id',
            'data_field' => 'data',
    ...
    public function testReplaceSessionData(): void
    {
        ...
        $collection->expects($this->exactly(2))
            ->method($methodName)
            ->willReturnCallback(static function ($criteria, $updateData, $options) use (&$data) : void {
                $data = $updateData;
            });
    ...
    public function testGc(): void
    {
        ...
        $collection->expects($this->once())
            ->method($methodName)
            ->willReturnCallback(function (array $criteria): void {
                if (phpversion('mongodb')) {
    ...
    private function createMongoCollectionMock()
    {
        ...
        return $this->getMockBuilder($collectionClass)
            ->disableOriginalConstructor()
            ->getMock();
    }
}
