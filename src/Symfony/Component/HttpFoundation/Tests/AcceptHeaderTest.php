...
class AcceptHeaderTest extends TestCase
{
     ...
     */
    public function testFromString(string $string, array $items): void
    {
    ...
    public function provideFromStringData(): array
    {
        return [
            ['', []],
     ...
     */
    public function testToString(array $items, string $string): void
    {
     ...
     */
    public function testFilter(string $string, string $filter, array $values): void
    {
     ...
     */
    public function testSorting(string $string, array $values): void
    {
        $header = AcceptHeader::fromString($string);
        $this->assertEquals($values, array_keys($header->all()));
    }

    public function provideSortingData(): array
    {
        return [
