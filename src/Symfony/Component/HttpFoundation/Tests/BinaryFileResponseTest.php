...
class BinaryFileResponseTest extends ResponseTestCase
{
    ...
    public function testSetContentDispositionGeneratesSafeFallbackFilenameForWronglyEncodedFilename(): void
    {
        ...
        $iso88591EncodedFilename = mb_convert_encoding('föö.html', 'ISO-8859-1');
     ...
     */
    public function testRequests(string $requestRange, int $offset, int $length, string $responseRange): void
    {
     ...
     * @dataProvider provideRanges
     */
    public function testRequestsWithoutEtag(string $requestRange, int $offset, int $length, string $responseRange): void
    {
     ...
     */
    public function testFullFileRequests(string $requestRange): void
    {
        $response = BinaryFileResponse::create(__DIR__.'/File/Fixtures/test.gif', 200, ['Content-Type' => 'application/octet-stream'])->setAutoEtag();
    ...
    public function provideFullFileRanges(): array
    {
        return [
            ['bytes=0-'],
            ['bytes=0-34'],
    ...
    public function testRangeOnPostMethod(): void
    {
     ...
     */
    public function testInvalidRequests(string $requestRange): void
    {
        $response = BinaryFileResponse::create(__DIR__.'/File/Fixtures/test.gif', 200, ['Content-Type' => 'application/octet-stream'])->setAutoEtag();
    ...
    public function provideXSendfileFiles(): array
    {
        return [
            [__DIR__.'/../README.md'],
            ['file://'.__DIR__.'/../README.md'],
     ...
     */
    public function testXAccelMapping(string $realpath, string $mapping, ?string $virtual): void
    {
        $request = Request::create('/');
    ...
    public function getSampleXAccelMappings(): array
    {
        return [
    ...
    protected function provideResponse(): \Symfony\Component\HttpFoundation\BinaryFileResponse
    {
