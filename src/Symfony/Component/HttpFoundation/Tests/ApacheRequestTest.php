...
class ApacheRequestTest extends TestCase
{
     ...
     */
    public function testUriMethods(array $server, string $expectedRequestUri, string $expectedBaseUrl, string $expectedPathInfo): void
    {
    ...
    public function provideServerVars(): array
    {
        return [
            [
                [
