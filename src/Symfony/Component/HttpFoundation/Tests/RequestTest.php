...
class RequestTest extends TestCase
{
     ...
     */
    public function testGetRequestUri(string $serverRequestUri, string $expected, string $message): void
    {
        $request = new Request();
        $request->server->add([
    ...
    public function getRequestUriData(): \Generator
    {
     ...
     */
    public function testGetFormatFromMimeType($format, array $mimeTypes): void
    {
        $request = new Request();
    ...
    public function getFormatToMimeTypeMapProviderWithAdditionalNullFormat(): array
    {
        return array_merge(
     ...
     */
    public function testGetMimeTypeFromFormat(string $format, array $mimeTypes): void
    {
        $request = new Request();
        $this->assertEquals($mimeTypes[0], $request->getMimeType($format));
    }
     ...
     * @dataProvider getFormatToMimeTypeMapProvider
     */
    public function testGetMimeTypesFromFormat(string $format, array $mimeTypes): void
    {
    ...
    public function getFormatToMimeTypeMapProvider(): array
    {
        return [
            ['txt', ['text/plain']],
     ...
     */
    public function testGetRelativeUriForPath(string $expected, string $pathinfo, string $path): void
    {
        $this->assertEquals($expected, Request::create($pathinfo)->getRelativeUriForPath($path));
    }

    public function getRelativeUriForPathData(): array
    {
        return [
            ['me.png', '/foo', '/me.png'],
     ...
     */
    public function testGetQueryString(string $query, string $expectedQuery, string $msg): void
    {
        $request = new Request();
    ...
    public function getQueryStringNormalizationData(): array
    {
        return [
     ...
     */
    public function testGetClientIp(array $expected, string $remoteAddr, ?string $httpForwardedFor, ?array $trustedProxies): void
    {
     ...
     * @dataProvider getClientIpsProvider
     */
    public function testGetClientIps(array $expected, string $remoteAddr, ?string $httpForwardedFor, ?array $trustedProxies): void
    {
        $request = $this->getRequestInstanceForClientIpTests($remoteAddr, $httpForwardedFor, $trustedProxies);
     ...
     */
    public function testGetClientIpsForwarded(array $expected, string $remoteAddr, string $httpForwarded, ?array $trustedProxies): void
    {
    ...
    public function getClientIpsForwardedProvider(): array
    {
    ...
    public function getClientIpsProvider(): array
    {
     ...
     */
    public function testGetClientIpsWithConflictingHeaders(string $httpForwarded, string $httpXForwardedFor): void
    {
     ...
     * @dataProvider getClientIpsWithConflictingHeadersProvider
     */
    public function testGetClientIpsOnlyXHttpForwardedForTrusted(string $httpForwarded, string $httpXForwardedFor): void
    {
        $request = new Request();
    ...
    public function getClientIpsWithConflictingHeadersProvider(): array
    {
     ...
     */
    public function testGetClientIpsWithAgreeingHeaders(string $httpForwarded, string $httpXForwardedFor, array $expectedIps): void
    {
        $request = new Request();
    ...
    public function getClientIpsWithAgreeingHeadersProvider(): array
    {
        //        $httpForwarded                               $httpXForwardedFor
        return [
     ...
     */
    public function testGetContentCantBeCalledTwiceWithResources(bool $first, bool $second): void
    {
    ...
    public function getContentCantBeCalledTwiceWithResourcesProvider(): array
    {
        return [
     ...
     * @requires PHP 5.6
     */
    public function testGetContentCanBeCalledTwiceWithResources(bool $first, bool $second): void
    {
        $req = new Request();
    ...
    public function getContentCanBeCalledTwiceWithResourcesProvider(): array
    {
        return [
    ...
    public function provideOverloadedMethods(): array
    {
        return [
            ['PUT'],
            ['DELETE'],
     ...
     */
    public function testCreateFromGlobals(string $method): void
    {
     ...
     */
    public function testGetBaseUrl(string $uri, array $server, string $expectedBaseUrl, string $expectedPathInfo): void
    {
    ...
    public function getBaseUrlData(): array
    {
        return [
            [
     ...
     */
    public function testUrlencodedStringPrefix(string $string, string $prefix, string $expect): void
    {
        $request = new Request();
    ...
    public function urlencodedStringPrefixData(): array
    {
        return [
            ['foo', 'foo', 'foo'],
            ['fo%6f', 'foo', 'fo%6f'],
    ...
    {
        $class = new \ReflectionClass(\Symfony\Component\HttpFoundation\Request::class);
        $property = $class->getProperty('httpMethodParameterOverride');
        $property->setAccessible(true);
        $property->setValue(false);
    }

    private function getRequestInstanceForClientIpTests(string $remoteAddr, ?string $httpForwardedFor, ?array $trustedProxies): \Symfony\Component\HttpFoundation\Request
    {
        $request = new Request();
    ...
    private function getRequestInstanceForClientIpsForwardedTests(string $remoteAddr, string $httpForwarded, ?array $trustedProxies): \Symfony\Component\HttpFoundation\Request
    {
        $request = new Request();
     ...
     */
    public function testLegacyTrustedProxies(): void
    {
        $request = Request::create('http://example.com/');
        $request->server->set('REMOTE_ADDR', '3.3.3.3');
        $request->headers->set('X_FORWARDED_FOR', '1.1.1.1, 2.2.2.2');
     ...
     * @group legacy
     */
    public function testSetTrustedProxiesInvalidHeaderName(): void
    {
     ...
     * @group legacy
     */
    public function testGetTrustedProxiesInvalidHeaderName(): void
    {
        $this->expectException('InvalidArgumentException');
        Request::create('http://example.com/');
     ...
     */
    public function testIISRequestUri(array $headers, array $server, string $expectedRequestUri): void
    {
        $request = new Request();
    ...
    public function iisRequestUriProvider(): array
    {
        return [
            [
                [],
    ...
    public function testTrustedHosts(): void
    {
        ...
        } catch (SuspiciousOperationException $suspiciousOperationException) {
            $this->assertEquals('Untrusted Host "evil.com".', $suspiciousOperationException->getMessage());
        }
    ...
    {
        Request::setFactory(static fn(array $query = [], array $request = [], array $attributes = [], array $cookies = [], array $files = [], array $server = [], $content = null): \Symfony\Component\HttpFoundation\Tests\NewRequest => new NewRequest());
     ...
     */
    public function testVeryLongHosts($host): void
    {
     ...
     */
    public function testHostValidity(string $host, bool $isValid, string $expectedHost = null, int $expectedPort = null): void
    {
        $request = Request::create('/');
        $request->headers->set('host', $host);
    ...
    public function getHostValidities(): array
    {
        return [
            ['.a', false],
            ['a..', false],
    ...
    public function getLongHostNames(): array
    {
        return [
     ...
     */
    public function testMethodIdempotent(string $method, bool $idempotent): void
    {
        $request = new Request();
    ...
    public function methodIdempotentProvider(): array
    {
        return [
            ['HEAD', true],
            ['GET', true],
     ...
     */
    public function testMethodSafe(string $method, bool $safe): void
    {
        $request = new Request();
        $request->setMethod($method);
    ...
    public function methodSafeProvider(): array
    {
        return [
            ['HEAD', true],
            ['GET', true],
     ...
     */
    public function testMethodSafeChecksCacheable(): void
    {
        $request = new Request();
     ...
     */
    public function testMethodCacheable(string $method, bool $cacheable): void
    {
        $request = new Request();
        $request->setMethod($method);
    ...
    public function methodCacheableProvider(): array
    {
        return [
            ['HEAD', true],
            ['GET', true],
     ...
     * @group legacy
     */
    public function testGetTrustedHeaderName(): void
    {
     ...
     */
    public function testProtocolVersion(string $serverProtocol, bool $trustedProxy, string $via, string $expected): void
    {
        if ($trustedProxy) {
    ...
    public function nonstandardRequestsData(): array
    {
        return [
            ['',  '', '/', 'http://host:8080/', ''],
            ['/', '', '/', 'http://host:8080/', ''],
     ...
     */
    public function testNonstandardRequests(string $requestUri, string $queryString, string $expectedPathInfo, string $expectedUri, string $expectedBasePath = '', string $expectedBaseUrl = null): void
    {
