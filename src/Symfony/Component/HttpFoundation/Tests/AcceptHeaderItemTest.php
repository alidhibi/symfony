...
class AcceptHeaderItemTest extends TestCase
{
     ...
     */
    public function testFromString(string $string, string $value, array $attributes): void
    {
     ...
     */
    public function testToString(string $value, array $attributes, string $string): void
    {
