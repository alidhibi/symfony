...
{
    public function namesWithSpecialCharacters(): array
    {
        return [
            [',MyName'],
            [';MyName'],
     ...
     */
    public function testInstantiationThrowsExceptionIfRawCookieNameContainsSpecialCharacters(string $name): void
    {
     ...
     * @dataProvider namesWithSpecialCharacters
     */
    public function testInstantiationSucceedNonRawCookieNameContainsSpecialCharacters(string $name): void
    {
    ...
    public function testToString(): void
    {
        ...
        $this->assertEquals('foo=deleted; expires='.gmdate('D, d-M-Y H:i:s T', $expire = time() - 31_536_001).'; Max-Age=0; path=/admin/; domain=.myfoodomain.com; httponly', (string) $cookie, '->__toString() returns string representation of a cleared cookie if value is NULL');
    ...
    public function testSameSiteAttributeIsCaseInsensitive(): void
    {
