...
class IpUtilsTest extends TestCase
{
     ...
     */
    public function testIpv4(bool $matches, string $remoteAddr, string|array $cidr): void
    {
        $this->assertSame($matches, IpUtils::checkIp($remoteAddr, $cidr));
    }

    public function getIpv4Data(): array
    {
        return [
     ...
     */
    public function testIpv6(bool $matches, string $remoteAddr, string|array $cidr): void
    {
        if (!\defined('AF_INET6')) {
    ...
    public function getIpv6Data(): array
    {
        return [
     ...
     */
    public function testInvalidIpAddressesDoNotMatch(string $requestIp, string $proxyIp): void
    {
        $this->assertFalse(IpUtils::checkIp4($requestIp, $proxyIp));
    }

    public function invalidIpAddressData(): array
    {
        return [
