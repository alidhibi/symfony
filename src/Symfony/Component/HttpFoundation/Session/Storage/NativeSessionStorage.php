...
class NativeSessionStorage implements SessionStorageInterface
{
    ...
    public function save(): void
    {
        ...
        set_error_handler(function ($type, $msg, $file, $line) use (&$previousHandler): bool {
    ...
    {
        if (!$metaBag instanceof \Symfony\Component\HttpFoundation\Session\Storage\MetadataBag) {
