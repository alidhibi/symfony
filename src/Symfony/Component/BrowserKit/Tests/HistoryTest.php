...
class HistoryTest extends TestCase
{
    ...
    public function testCurrent(): void
    {
        ...
        try {
            ...
            $this->assertInstanceOf('LogicException', $exception, '->current() throws a \LogicException if the history is empty');
        }
    ...
    public function testBack(): void
    {
        ...
        try {
            ...
            $this->assertInstanceOf('LogicException', $exception, '->current() throws a \LogicException if the history is already on the first page');
        }
    ...
    public function testForward(): void
    {
        ...
        try {
            ...
            $this->assertInstanceOf('LogicException', $exception, '->forward() throws a \LogicException if the history is already on the last page');
        }
