...
class TestClient extends Client
{
    ...
    {
        $r = new \ReflectionClass(\Symfony\Component\BrowserKit\Response::class);
        $path = $r->getFileName();
...
class ClientTest extends TestCase
{
    ...
    public function testGetResponse(): void
    {
        ...
        $this->assertInstanceOf(\Symfony\Component\BrowserKit\Response::class, $client->getResponse(), '->getCrawler() returns the Response of the last request');
    }
    ...
    public function testGetInternalResponse(): void
    {
        ...
        $this->assertNotInstanceOf(\Symfony\Component\BrowserKit\Tests\SpecialResponse::class, $client->getInternalResponse());
        $this->assertInstanceOf(\Symfony\Component\BrowserKit\Tests\SpecialResponse::class, $client->getResponse());
    }
    ...
    public function testFollowRedirect(): void
    {
        ...
        try {
            ...
            $this->assertInstanceOf('LogicException', $exception, '->followRedirect() throws a \LogicException if the request was not redirected');
        }
        ...
        try {
            ...
            $this->assertInstanceOf('LogicException', $exception, '->followRedirect() throws a \LogicException if the request did not respond with 30x HTTP Code');
        }
    }
    ...
    public function testFollowRedirectWithMaxRedirects(): void
    {
        ...
        try {
            ...
            $this->assertInstanceOf('LogicException', $exception, '->followRedirect() throws a \LogicException if the request was redirected and limit of redirections was reached');
        }
    ...
    public function testInsulatedRequests(): void
    {
        ...
        try {
            ...
            $this->assertInstanceOf('RuntimeException', $exception, '->request() throws a \RuntimeException if the script has an error');
        }
    }
