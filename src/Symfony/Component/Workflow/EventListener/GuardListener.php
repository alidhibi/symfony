...
class GuardListener
{
    ...
    private \Symfony\Component\Workflow\EventListener\ExpressionLanguage $expressionLanguage;
    ...
    private \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolverInterface $trustResolver;
    ...
    private function getVariables(GuardEvent $event)
    {
        ...
        $variables = [
            ...
            'roles' => array_map(fn($role) => $role->getRole(), $roles),
