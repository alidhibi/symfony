...
class PgSqlCaster
{
    private static array $paramCodes = [
        'server_encoding',
        'client_encoding',
        'is_superuser',
    ...
    private static array $transactionStatus = [
    ...
    private static array $resultStatus = [
    ...
    private static array $diagCodes = [
    ...
    public static function castLargeObject($lo, array $a, Stub $stub, $isNested): array
    {
    ...
    public static function castLink($link, array $a, Stub $stub, $isNested): array
    {
    ...
    public static function castResult($result, array $a, Stub $stub, $isNested): array
    {
