...
class AmqpCaster
{
    ...
    private static array $exchangeTypes = [
    ...
    public static function castConnection(\AMQPConnection $c, array $a, Stub $stub, $isNested)
    {
        ...
        $timeout = method_exists($c, 'getReadTimeout') ? $c->getReadTimeout() : $c->getTimeout();
    ...
    public static function castEnvelope(\AMQPEnvelope $c, array $a, Stub $stub, $isNested, $filter = 0)
    {
        ...
        if (($filter & Caster::EXCLUDE_VERBOSE) === 0) {
    ...
    private static function extractFlags($flags): \Symfony\Component\VarDumper\Caster\ConstStub
    {
        $flagsArray = [];
