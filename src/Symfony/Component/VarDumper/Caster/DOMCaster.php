...
class DOMCaster
{
    ...
    public static function castException(\DOMException $e, array $a, Stub $stub, $isNested): array
    {
    ...
    public static function castDocument(\DOMDocument $dom, array $a, Stub $stub, $isNested, $filter = 0): array
    {
        $a += [
            'doctype' => $dom->doctype,
