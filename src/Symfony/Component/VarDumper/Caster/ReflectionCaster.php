...
class ReflectionCaster
{
    ...
    public static function castReflectionGenerator(\ReflectionGenerator $c, array $a, Stub $stub, $isNested): array
    {
        $prefix = Caster::PREFIX_VIRTUAL;
        ...
        $frame = [
            'class' => property_exists($function, 'class') && $function->class !== null ? $function->class : null,
            'type' => property_exists($function, 'class') && $function->class !== null ? ($function->isStatic() ? '::' : '->') : null,
    ...
    public static function castMethod(\ReflectionMethod $c, array $a, Stub $stub, $isNested): array
    {
    ...
    private static function addMap(array &$a, \Reflector $c, $map, string $prefix = Caster::PREFIX_VIRTUAL): void
    {
        foreach ($map as $k => $m) {
