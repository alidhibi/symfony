...
abstract class AbstractDumper implements DataDumperInterface, DumperInterface
{
    ...
    public function setOutput($output)
    {
        ...
        if (\is_callable($output)) {
            ...
            $this->lineDumper = fn(string $line, int $depth, string $indentPad) => $this->echoLine($line, $depth, $indentPad);
        }
    ...
    public function dump(Data $data, $output = null)
    {
        ...
        if ($locale = ($this->flags & (self::DUMP_COMMA_SEPARATOR | self::DUMP_TRAILING_COMMA)) !== 0 ? setlocale(\LC_NUMERIC, 0) : null) {
     ...
     */
    protected function echoLine(string $line, $depth, $indentPad)
    {
        if (-1 !== $depth) {
