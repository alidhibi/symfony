...
class VarCloner extends AbstractCloner
{
    ...
    private static int $hashMask = 0;

    private static int $hashOffset = 0;
     ...
     * {@inheritdoc}
     */
    protected function doClone($var): array
    {
        ...
        $minimumDepthReached = 0 === $minDepth;          // Unique object used to detect hard references
        ...
        for ($i = 0; $i < $len; ++$i) {
            ...
            foreach ($vals as $k => $v) {
                ...
                $zvalIsRef = \ReflectionReference::fromArrayElement($vals, $k) instanceof \ReflectionReference;
            ...
            if ($fromObjCast) {
                ...
                $vals = [];
                $j = -1;
                foreach (array_keys($queue[$i]) as $k) {
    ...
    private function initHashMask(): void
    {
        $obj = (object) [];
