...
{
    private readonly \Symfony\Component\Form\FormTypeInterface $innerType;
    ...
    private ?\Symfony\Component\Form\ResolvedFormTypeInterface $parent = null;
     ...
     * {@inheritdoc}
     */
    public function getParent(): ?\Symfony\Component\Form\ResolvedFormTypeInterface
    {
        return $this->parent;
    }
     ...
     * {@inheritdoc}
     */
    public function getInnerType(): \Symfony\Component\Form\FormTypeInterface
    {
    ...
    {
        if ($this->parent instanceof \Symfony\Component\Form\ResolvedFormTypeInterface) {
     ...
     */
    protected function newBuilder($name, $dataClass, FormFactoryInterface $factory, array $options): \Symfony\Component\Form\ButtonBuilder|\Symfony\Component\Form\SubmitButtonBuilder|\Symfony\Component\Form\FormBuilder
    {
     ...
     */
    protected function newView(FormView $parent = null): \Symfony\Component\Form\FormView
    {
