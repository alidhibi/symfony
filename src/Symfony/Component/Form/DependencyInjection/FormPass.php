...
class FormPass implements CompilerPassInterface
{
    ...
    private function processFormTypes(ContainerBuilder $container)
    {
        ...
        foreach (array_keys($container->findTaggedServiceIds($this->formTypeTag, true)) as $serviceId) {
    ...
    /**
     * @return \Symfony\Component\DependencyInjection\Argument\IteratorArgument[]|\non-empty-array<\int<0, \max>, \Symfony\Component\DependencyInjection\Reference>[]
     */
    ...
    private function processFormTypeGuessers(ContainerBuilder $container): \Symfony\Component\DependencyInjection\Argument\IteratorArgument
    {
        $guessers = [];
        $guessersClasses = [];
        foreach (array_keys($container->findTaggedServiceIds($this->formTypeGuesserTag, true)) as $serviceId) {
