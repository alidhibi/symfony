...
class Form implements \IteratorAggregate, FormInterface
{
     ...
     */
    private \Symfony\Component\Form\Util\OrderedHashMap $children;
     ...
     */
    private ?\Symfony\Component\Form\Exception\TransformationFailedException $transformationFailure = null;
     ...
     * {@inheritdoc}
     */
    public function getPropertyPath(): \Symfony\Component\PropertyAccess\PropertyPathInterface|null|\Symfony\Component\PropertyAccess\PropertyPath
    {
    ...
    {
        if (!$this->parent instanceof \Symfony\Component\Form\FormInterface || $this->parent->isRequired()) {
    ...
    {
        if (!$this->parent instanceof \Symfony\Component\Form\FormInterface || !$this->parent->isDisabled()) {
    ...
    public function setParent(FormInterface $parent = null): static
    {
        ...
        if ($parent instanceof \Symfony\Component\Form\FormInterface && '' === $this->name) {
    ...
    {
        if ($this->inheritData) {
            if (!$this->parent instanceof \Symfony\Component\Form\FormInterface) {
    ...
    public function submit($submittedData, $clearMissing = true): static
    {
        ...
        try {
            if ($this->transformationFailure instanceof \Symfony\Component\Form\Exception\TransformationFailedException) {
        ...
        } catch (TransformationFailedException $transformationFailedException) {
            $this->transformationFailure = $transformationFailedException;
    ...
    {
        return !$this->transformationFailure instanceof \Symfony\Component\Form\Exception\TransformationFailedException;
    }

    /**
     * {@inheritdoc}
     */
    public function getTransformationFailure(): ?\Symfony\Component\Form\Exception\TransformationFailedException
    {
    ...
    private function modelToNorm($value)
    {
        try {
            ...
            throw new TransformationFailedException(sprintf('Unable to transform data for property path "%s": ', $this->getPropertyPath()).$transformationFailedException->getMessage(), $transformationFailedException->getCode(), $transformationFailedException);
        }
    ...
    private function normToModel($value)
    {
        try {
            ...
            throw new TransformationFailedException(sprintf('Unable to reverse value for property path "%s": ', $this->getPropertyPath()).$transformationFailedException->getMessage(), $transformationFailedException->getCode(), $transformationFailedException);
        }
    ...
    private function normToView($value)
    {
        ...
        try {
            ...
            throw new TransformationFailedException(sprintf('Unable to transform value for property path "%s": ', $this->getPropertyPath()).$transformationFailedException->getMessage(), $transformationFailedException->getCode(), $transformationFailedException);
        }
