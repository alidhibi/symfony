...
class DefaultChoiceListFactory implements ChoiceListFactoryInterface
{
     ...
     * {@inheritdoc}
     */
    public function createListFromChoices($choices, $value = null): \Symfony\Component\Form\ChoiceList\ArrayChoiceList
    {
     ...
     * {@inheritdoc}
     */
    public function createListFromLoader(ChoiceLoaderInterface $loader, $value = null): \Symfony\Component\Form\ChoiceList\LazyChoiceList
    {
     ...
     * {@inheritdoc}
     */
    public function createView(ChoiceListInterface $list, $preferredChoices = null, $label = null, $index = null, $groupBy = null, $attr = null): \Symfony\Component\Form\ChoiceList\View\ChoiceListView
    {
        $preferredViews = [];
        $otherViews = [];
        ...
        if (!\is_callable($preferredChoices) && !empty($preferredChoices)) {
            $preferredChoices = static fn($choice): bool => \in_array($choice, $preferredChoices, true);
        }
        ...
        if (\is_callable($groupBy)) {
            foreach ($choices as $value => $choice) {
                $this->addChoiceViewGroupedBy($groupBy, $choice, (string) $value, $label, $keys, $index, $attr, $preferredChoices, $preferredViews, $otherViews);
            }
        } else {
    ...
    private static function addChoiceView($choice, $value, $label, array $keys, &$index, array $attr, $isPreferred, array &$preferredViews, array &$otherViews): void
    {
    ...
    private static function addChoiceViewsGroupedBy($groupBy, $label, array $choices, $keys, &$index, $attr, $isPreferred, array &$preferredViews, array &$otherViews): void
    {
    ...
    private function addChoiceViewGroupedBy(callable $groupBy, $choice, string $value, $label, array $keys, &$index, $attr, callable|array|null $isPreferred, array &$preferredViews, array &$otherViews): void
    {
