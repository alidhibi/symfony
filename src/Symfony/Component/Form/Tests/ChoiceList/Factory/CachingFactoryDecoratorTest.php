...
class CachingFactoryDecoratorTest extends TestCase
{
    ...
    private \Symfony\Component\Form\ChoiceList\Factory\CachingFactoryDecorator $factory;
     ...
     */
    public function testCreateFromChoicesDifferentChoices(int|string|bool|\stdClass $choice1, bool|string|\stdClass|null $choice2): void
    {
        $choices1 = [$choice1];
        $choices2 = [$choice2];
        $list1 = new ArrayChoiceList([]);
