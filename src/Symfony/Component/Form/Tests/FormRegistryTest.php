...
{
    private \Symfony\Component\Form\FormRegistry $registry;
    ...
    private \Symfony\Component\Form\Tests\Fixtures\TestExtension $extension1;

    private \Symfony\Component\Form\Tests\Fixtures\TestExtension $extension2;
    ...
    public function testLoadUnregisteredType(): void
    {
        ...
        $this->assertSame($resolvedType, $this->registry->getType(\Symfony\Component\Form\Tests\Fixtures\FooType::class));
    }
    ...
    {
        $this->assertTrue($this->registry->hasType(\Symfony\Component\Form\Tests\Fixtures\FooType::class));
    }
