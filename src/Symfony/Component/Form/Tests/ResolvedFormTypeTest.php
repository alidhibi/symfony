...
class ResolvedFormTypeTest extends TestCase
{
    ...
    private \Symfony\Component\Form\ResolvedFormType $parentResolvedType;
    ...
    public function testCreateBuilder(): void
    {
        $givenOptions = ['a' => 'a_custom', 'c' => 'c_custom'];
        $resolvedOptions = ['a' => 'a_custom', 'b' => 'b_default', 'c' => 'c_custom', 'd' => 'd_default'];
        $optionsResolver = $this->getMockBuilder(\Symfony\Component\OptionsResolver\OptionsResolver::class)->getMock();

        $this->resolvedType = $this->getMockBuilder(\Symfony\Component\Form\ResolvedFormType::class)
     ...
     */
    public function testBlockPrefixDefaultsToFQCNIfNoName($typeClass, string $blockPrefix): void
    {
    ...
    public function provideTypeClassBlockPrefixTuples(): array
    {
        return [
     ...
     * @return MockObject
     */
    private function getMockFormType($typeClass = \Symfony\Component\Form\AbstractType::class)
    {
    ...
    {
        return $this->getMockBuilder(\Symfony\Component\Form\AbstractTypeExtension::class)->setMethods(['getExtendedType', 'configureOptions', 'finishView', 'buildView', 'buildForm'])->getMock();
    }
