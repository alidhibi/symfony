...
class StringUtilTest extends TestCase
{
     ...
     */
    public function testTrimUtf8Separators(string $hex): void
    {
    ...
    public function spaceProvider(): array
    {
        return [
            // separators
            ['0020'],
...
//            ['200B'],
     ...
     */
    public function testFqcnToBlockPrefix(string $fqcn, string $expectedBlockPrefix): void
    {
    ...
    public function fqcnToBlockPrefixProvider(): array
    {
        return [
            ['TYPE', 'type'],
            ['\Type', 'type'],
            ...
            ['Vendor\Name\Space\usertype', 'user'],
            [\Symfony\Component\Form\Form::class, 'form'],
