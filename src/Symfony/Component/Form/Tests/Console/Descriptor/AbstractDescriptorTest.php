...
abstract class AbstractDescriptorTest extends TestCase
{
    ...
    public function testDescribeDefaults($object, array $options, string $fixtureName): void
    {
    ...
    public function testDescribeResolvedFormType(ResolvedFormTypeInterface $type, array $options, string $fixtureName): void
    {
    ...
    public function testDescribeOption(OptionsResolver $optionsResolver, array $options, string $fixtureName): void
    {
    ...
    {
        $options['core_types'] = [\Symfony\Component\Form\Extension\Core\Type\FormType::class];
        $options['service_types'] = ['Symfony\Bridge\Doctrine\Form\Type\EntityType'];
        $options['extensions'] = [\Symfony\Component\Form\Extension\Csrf\Type\FormTypeCsrfExtension::class];
        $options['guessers'] = [\Symfony\Component\Form\Extension\Validator\ValidatorTypeGuesser::class];
    ...
    private function getExpectedDescription(string $name)
    {
        return file_get_contents($this->getFixtureFilename($name));
    }

    private function getFixtureFilename(string $name)
    {
...
class FooType extends AbstractType
{
    public function configureOptions(OptionsResolver $resolver): void
    {
        ...
        $resolver->setNormalizer('foo', static fn(Options $options, $value): string => (string) $value);
    }
}
