...
class DependencyInjectionExtensionTest extends TestCase
{
     ...
     */
    public function testLegacyGetTypeExtensions(): void
    {
     ...
     * @expectedDeprecation Passing four arguments to the Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension::__construct() method is deprecated since Symfony 3.3 and will be disallowed in Symfony 4.0. The new constructor only accepts three arguments.
     */
    public function testLegacyThrowExceptionForInvalidExtendedType(): void
    {
        $this->expectException(\Symfony\Component\Form\Exception\InvalidArgumentException::class);
     ...
     * @group legacy
     */
    public function testLegacyGetTypeGuesser(): void
    {
        $container = new ContainerBuilder();
     ...
     * @group legacy
     */
    public function testLegacyGetTypeGuesserReturnsNullWhenNoTypeGuessersHaveBeenConfigured(): void
    {
        $extension = new DependencyInjectionExtension(new ContainerBuilder(), [], [], []);
...
{
    public function guessType($class, $property): void
    {
    }

    public function guessRequired($class, $property): void
    {
    }

    public function guessMaxLength($class, $property): void
    {
    }

    public function guessPattern($class, $property): void
    {
    }
}
