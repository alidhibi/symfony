...
class FormDataCollectorTest extends TestCase
{
    ...
    private \Symfony\Component\Form\Extension\DataCollector\FormDataCollector $dataCollector;
     ...
     * @var MockObject
     */
    private \Symfony\Component\Form\Extension\Core\DataMapper\PropertyPathMapper $dataMapper;
    ...
    private \Symfony\Component\Form\FormView $view;

    private \Symfony\Component\Form\FormView $childView;
    ...
    public function testSerializeWithFormAddedMultipleTimes(): void
    {
        ...
        $child1View->vars['is_selected'] = static fn($choice, array $values): bool => \in_array($choice, $values, true);
    ...
    public function testCollectMissingDataFromChildFormAddedOnFormEvents(): void
    {
        ...
        $this->dataExtractor->expects($extractDefaultData = $this->exactly(4))
            ->method('extractDefaultData')
            ->willReturnCallback(static function (FormInterface $form): array {
    ...
    private function createForm(string $name)
    {
