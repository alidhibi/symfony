...
class FormValidatorPerformanceTest extends FormPerformanceTestCase
{
    ...
    public function testValidationPerformance(): void
    {
        ...
        $builder = $this->factory->createBuilder(\Symfony\Component\Form\Extension\Core\Type\FormType::class);

        for ($i = 0; $i < 40; ++$i) {
            $builder->add($i, \Symfony\Component\Form\Extension\Core\Type\FormType::class);
