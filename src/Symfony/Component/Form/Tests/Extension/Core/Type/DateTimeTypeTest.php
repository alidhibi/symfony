...
{
    final const TESTED_TYPE = 'Symfony\Component\Form\Extension\Core\Type\DateTimeType';
    ...
    public function provideEmptyData(): array
    {
        ...
        $lazyEmptyData = static fn(FormInterface $form): array|string => $form->getConfig()->getCompound() ? ['date' => ['year' => '2018', 'month' => '11', 'day' => '11'], 'time' => ['hour' => '21', 'minute' => '23']] : '2018-11-11T21:23:00';
