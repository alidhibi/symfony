...
{
    final const TESTED_TYPE = 'Symfony\Component\Form\Extension\Core\Type\FileType';
    ...
    public function uploadFileErrorCodes(): array
    {
        return [
    ...
    private function createUploadedFile(RequestHandlerInterface $requestHandler, $path, string $originalName): \Symfony\Component\HttpFoundation\File\UploadedFile|array
    {
