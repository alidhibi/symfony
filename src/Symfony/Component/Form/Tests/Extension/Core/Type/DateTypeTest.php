...
class DateTypeTest extends BaseTypeTest
{
     ...
     */
    public function testDatePatternWithFormatOption(string $format, string $pattern): void
    {
     ...
     */
    public function testYearErrorsBubbleUp(string $widget): void
    {
     ...
     * @dataProvider provideCompoundWidgets
     */
    public function testMonthErrorsBubbleUp(string $widget): void
    {
        $error = new FormError('Invalid!');
        $form = $this->factory->create(static::TESTED_TYPE, null, [
            'widget' => $widget,
     ...
     * @dataProvider provideCompoundWidgets
     */
    public function testDayErrorsBubbleUp(string $widget): void
    {
        $error = new FormError('Invalid!');
        $form = $this->factory->create(static::TESTED_TYPE, null, [
            'widget' => $widget,
    ...
    public function provideEmptyData()
    {
        ...
        $lazyEmptyData = static fn(FormInterface $form): array|string => $form->getConfig()->getCompound() ? ['year' => '2018', 'month' => '11', 'day' => '11'] : '2018-11-11';
