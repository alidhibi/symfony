...
abstract class MergeCollectionListenerTest extends TestCase
{
     ...
     */
    public function testAddExtraEntriesIfAllowAdd(bool $allowDelete): void
    {
     ...
     * @dataProvider getBooleanMatrix1
     */
    public function testAddExtraEntriesIfAllowAddDontOverwriteExistingIndices(bool $allowDelete): void
    {
     ...
     * @dataProvider getBooleanMatrix1
     */
    public function testDoNothingIfNotAllowAdd(bool $allowDelete): void
    {
     ...
     * @dataProvider getBooleanMatrix1
     */
    public function testRemoveMissingEntriesIfAllowDelete(bool $allowAdd): void
    {
     ...
     * @dataProvider getBooleanMatrix1
     */
    public function testDoNothingIfNotAllowDelete(bool $allowAdd): void
    {
     ...
     */
    public function testRequireArrayOrTraversable(bool $allowAdd, bool $allowDelete): void
    {
     ...
     * @dataProvider getBooleanMatrix1
     */
    public function testDealWithNullOriginalDataIfAllowAdd(bool $allowDelete): void
    {
        $originalData = null;
        $newData = $this->getData([0 => 'first', 1 => 'second', 2 => 'third']);
     ...
     * @dataProvider getBooleanMatrix1
     */
    public function testDontDealWithNullOriginalDataIfNotAllowAdd(bool $allowDelete): void
    {
        $originalData = null;
        $newData = $this->getData([0 => 'first', 1 => 'second', 2 => 'third']);
