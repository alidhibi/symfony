...
{
    private \Symfony\Component\Form\Extension\Core\DataMapper\PropertyPathMapper $mapper;
     ...
     */
    public function testMapFormsToDataDoesNotChangeEqualDateTimeInstance(\DateTime|\DateTimeImmutable $date): void
    {
        $article = [];
        $publishedAt = $date;
