...
class ChoiceToValueTransformerTest extends TestCase
{
     ...
     */
    public function testTransform(string|bool $in, string $out, string|bool|null $inWithNull, string $outWithNull): void
    {
     ...
     */
    public function testReverseTransform(string $in, string|bool $out, string $inWithNull, string|bool|null $outWithNull): void
    {
        $this->assertSame($out, $this->transformer->reverseTransform($in));
        $this->assertSame($outWithNull, $this->transformerWithNull->reverseTransform($inWithNull));
    }

    public function reverseTransformExpectsStringOrNullProvider(): array
    {
        return [
            [0],
            [true],
     ...
     */
    public function testReverseTransformExpectsStringOrNull(int|bool|array $value): void
    {
