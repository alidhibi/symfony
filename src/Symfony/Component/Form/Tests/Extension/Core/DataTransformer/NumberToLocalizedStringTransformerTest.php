...
class NumberToLocalizedStringTransformerTest extends TestCase
{
     ...
     */
    public function testTransform(int|float|null $from, string $to, string $locale): void
    {
    ...
    public function provideTransformationsWithGrouping(): array
    {
        return [
     ...
     */
    public function testTransformWithGrouping(float $from, string $to, string $locale): void
    {
        // Since we test against other locales, we need the full implementation
        IntlTestHelper::requireFullIntl($this, false);
     ...
     */
    public function testTransformWithRounding(int $scale, float $input, string $output, int $roundingMode): void
    {
        // Since we test against "de_AT", we need the full implementation
        IntlTestHelper::requireFullIntl($this, false);
     ...
     * @dataProvider provideTransformations
     */
    public function testReverseTransform(int|float|null $to, string $from, string $locale): void
    {
        // Since we test against other locales, we need the full implementation
        IntlTestHelper::requireFullIntl($this, false);
     ...
     * @dataProvider provideTransformationsWithGrouping
     */
    public function testReverseTransformWithGrouping(float $to, string $from, string $locale): void
    {
        // Since we test against other locales, we need the full implementation
     ...
     */
    public function testReverseTransformWithRounding(int $scale, string $input, int|float $output, int $roundingMode): void
    {
        $transformer = new NumberToLocalizedStringTransformer($scale, null, $roundingMode);
     ...
     */
    public function testReverseTransformDisallowsNaN(string $nan): void
    {
        $this->expectException(\Symfony\Component\Form\Exception\TransformationFailedException::class);
        $transformer = new NumberToLocalizedStringTransformer();
    ...
    public function nanRepresentationProvider(): array
    {
        return [
            ['nan'],
