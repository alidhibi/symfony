...
class DateIntervalToStringTransformerTest extends DateIntervalTestCase
{
     ...
     */
    public function testTransform(string $format, string $output, string $input): void
    {
     ...
     * @dataProvider dataProviderISO
     */
    public function testReverseTransform(string $format, string $input, string $output): void
    {
     ...
     */
    public function testReverseTransformDateString(string $format, string $input, string $output): void
    {
        $reverseTransformer = new DateIntervalToStringTransformer($format, true);
        $interval = new \DateInterval($output);
