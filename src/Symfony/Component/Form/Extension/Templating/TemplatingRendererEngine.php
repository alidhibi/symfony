...
class TemplatingRendererEngine extends AbstractRendererEngine
{
    ...
    protected function loadResourceForBlockName($cacheKey, FormView $view, $blockName): bool
    {
        ...
        if (!$view->parent && (!isset($this->useDefaultThemes[$cacheKey]) || $this->useDefaultThemes[$cacheKey])) {
     ...
     * @return bool True if the resource could be loaded, false otherwise
     */
    protected function loadResourceFromTheme($cacheKey, string $blockName, string $theme): bool
    {
