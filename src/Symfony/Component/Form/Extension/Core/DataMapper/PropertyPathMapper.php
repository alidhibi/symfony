...
class PropertyPathMapper implements DataMapperInterface
{
    ...
    private function getPropertyValue($data, $propertyPath)
    {
        try {
            ...
            if (!$accessException instanceof UninitializedPropertyException
                // For versions without UninitializedPropertyException check the exception message
                && (class_exists(UninitializedPropertyException::class) || false === strpos($accessException->getMessage(), 'You should initialize it'))
            ) {
