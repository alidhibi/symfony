...
class DateTimeToLocalizedStringTransformer extends BaseDateTimeTransformer
{
    ...
    public function reverseTransform($value): ?\DateTime
    {
        ...
        try {
            ...
            throw new TransformationFailedException($intlException->getMessage(), $intlException->getCode(), $intlException);
        }

        if (0 != intl_get_error_code()) {
            throw new TransformationFailedException(intl_get_error_message(), intl_get_error_code());
        } elseif ($timestamp > 253_402_214_400) {
     ...
     */
    protected function getIntlDateFormatter($ignoreTimezone = false): \IntlDateFormatter
    {
