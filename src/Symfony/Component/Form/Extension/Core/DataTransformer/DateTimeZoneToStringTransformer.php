...
class DateTimeZoneToStringTransformer implements DataTransformerInterface
{
    ...
    public function transform($dateTimeZone)
    {
        ...
        if ($this->multiple) {
            ...
            return array_map(static fn($dateTimeZone) => (new self())->transform($dateTimeZone), $dateTimeZone);
        }
    ...
    public function reverseTransform($value)
    {
        ...
        if ($this->multiple) {
            ...
            return array_map(static fn($value) => (new self())->reverseTransform($value), $value);
        }
