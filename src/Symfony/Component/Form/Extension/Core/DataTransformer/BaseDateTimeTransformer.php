...
abstract class BaseDateTimeTransformer implements DataTransformerInterface
{
    ...
    public function __construct($inputTimezone = null, $outputTimezone = null)
    {
        ...
        try {
            ...
            throw new InvalidArgumentException(sprintf('Input timezone is invalid: "%s".', $this->inputTimezone), $exception->getCode(), $exception);
        }

        try {
            new \DateTimeZone($this->outputTimezone);
        } catch (\Exception $exception) {
            throw new InvalidArgumentException(sprintf('Output timezone is invalid: "%s".', $this->outputTimezone), $exception->getCode(), $exception);
        }
    }
}
