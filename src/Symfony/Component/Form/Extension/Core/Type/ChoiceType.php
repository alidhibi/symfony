...
{
    private readonly \Symfony\Component\Form\ChoiceList\Factory\ChoiceListFactoryInterface $choiceListFactory;
    ...
    {
        $emptyData = static function (Options $options) : string|array|null {
        ...
        $choicesAsValuesNormalizer = static function (Options $options, $choicesAsValues) : bool {
            // Not set by the user
        ...
        $resolver->setAllowedTypes('choice_loader', ['null', \Symfony\Component\Form\ChoiceList\Loader\ChoiceLoaderInterface::class]);
        $resolver->setAllowedTypes('choice_label', ['null', 'bool', 'callable', 'string', \Symfony\Component\PropertyAccess\PropertyPath::class]);
        $resolver->setAllowedTypes('choice_name', ['null', 'callable', 'string', \Symfony\Component\PropertyAccess\PropertyPath::class]);
        $resolver->setAllowedTypes('choice_value', ['null', 'callable', 'string', \Symfony\Component\PropertyAccess\PropertyPath::class]);
        $resolver->setAllowedTypes('choice_attr', ['null', 'array', 'callable', 'string', \Symfony\Component\PropertyAccess\PropertyPath::class]);
        $resolver->setAllowedTypes('preferred_choices', ['array', '\Traversable', 'callable', 'string', \Symfony\Component\PropertyAccess\PropertyPath::class]);
        $resolver->setAllowedTypes('group_by', ['null', 'callable', 'string', \Symfony\Component\PropertyAccess\PropertyPath::class]);
    }
    ...
    private function addSubForm(FormBuilderInterface $builder, string|int $name, ChoiceView $choiceView, array $options): void
    {
        $choiceOpts = [
