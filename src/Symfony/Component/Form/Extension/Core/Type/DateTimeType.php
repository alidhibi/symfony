...
{
    final const DEFAULT_DATE_FORMAT = \IntlDateFormatter::MEDIUM;

    final const DEFAULT_TIME_FORMAT = \IntlDateFormatter::MEDIUM;

    /**
     * The HTML5 datetime-local format as defined in
     * http://w3c.github.io/html-reference/datatypes.html#form.data.datetime-local.
     */
    final const HTML5_FORMAT = "yyyy-MM-dd'T'HH:mm:ss";
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        ...
        $dateWidget = static fn(Options $options): mixed => $options['widget'];

        // Defaults to the value of "widget"
        $timeWidget = static fn(Options $options): mixed => $options['widget'];
