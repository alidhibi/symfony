...
class TimezoneType extends AbstractType implements ChoiceLoaderInterface
{
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'choice_loader' => function (Options $options): ?\Symfony\Component\Form\ChoiceList\Loader\CallbackChoiceLoader {
                if ($options['choices']) {
                ...
                return new CallbackChoiceLoader(fn() => $this->getTimezones($regions));
            },
    ...
    public function loadChoiceList($value = null)
    {
        ...
        return $this->choiceList = new ArrayChoiceList($this->getTimezones(\DateTimeZone::ALL), $value);
    }
     ...
     */
    private function getTimezones($regions)
    {
        $timezones = [];
