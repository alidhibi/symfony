...
class FormValidator extends ConstraintValidator
{
    ...
    private ?array $fieldFormConstraints = null;

    /**
     * {@inheritdoc}
     */
    public function validate($form, Constraint $formConstraint): void
    {
        ...
        if ($form->isSubmitted() && $form->isSynchronized()) {
            ...
            if ($groups instanceof GroupSequence) {
                ...
                foreach ($groups->groups as $group) {
                    ...
                    if ($groupedConstraints = $this->getConstraintsInGroups($constraints, $group)) {
                    ...
                    foreach ($form->all() as $field) {
                        if ($field->isSubmitted()) {
                            ...
                            $this->context->setNode($this->context->getValue(), $field, $this->context->getPropertyPath(), $this->context->getMetadata());
            ...
            foreach ($form as $child) {
                if (!$child->isSynchronized()) {
                    ...
                    $fieldFormConstraint = new Form();
                    $this->fieldFormConstraints[] = $fieldFormConstraint;
                    $this->context->setNode($this->context->getValue(), $child, $this->context->getPropertyPath(), $this->context->getMetadata());
     ...
     */
    private function resolveValidationGroups($groups, FormInterface $form): \Symfony\Component\Validator\Constraints\GroupSequence|array
    {
    ...
    private function getConstraintsInGroups($constraints, $group): ?array
    {
        return array_filter($constraints, static fn(Constraint $constraint): bool => \in_array($group, $constraint->groups, true));
    }
}
