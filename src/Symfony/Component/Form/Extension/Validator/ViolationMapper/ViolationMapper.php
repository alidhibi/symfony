...
class ViolationMapper implements ViolationMapperInterface
{
    ...
    public function mapViolation(ConstraintViolation $violation, FormInterface $form, $allowNonSynchronized = false): void
    {
        ...
        if (!$violationPath instanceof \Symfony\Component\Form\Extension\Validator\ViolationMapper\ViolationPath) {
            $scope = $form;
        }
        ...
        if ($violationPath instanceof \Symfony\Component\Form\Extension\Validator\ViolationMapper\ViolationPath && !$match) {
     ...
     */
    private function reconstructPath(ViolationPath $violationPath, FormInterface $origin): ?\Symfony\Component\Form\Extension\Validator\ViolationMapper\RelativePath
    {
