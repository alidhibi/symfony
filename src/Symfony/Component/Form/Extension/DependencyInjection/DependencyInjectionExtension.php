...
{
    private ?\Symfony\Component\Form\FormTypeGuesserChain $guesser = null;

    private bool $guesserLoaded = false;

    private readonly \Psr\Container\ContainerInterface $typeContainer;
    ...
    private ?array $typeServiceIds = null;

    private ?array $guesserServiceIds = null;
    ...
    public function getTypeGuesser(): ?\Symfony\Component\Form\FormTypeGuesserChain
    {
