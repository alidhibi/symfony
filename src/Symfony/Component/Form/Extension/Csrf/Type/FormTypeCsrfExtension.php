...
{
    private readonly \Symfony\Component\Security\Csrf\CsrfTokenManagerInterface $defaultTokenManager;
    ...
    private ?\Symfony\Component\Form\Util\ServerParams $serverParams = null;
    ...
    public function finishView(FormView $view, FormInterface $form, array $options): void
    {
        if ($options['csrf_protection'] && !$view->parent && $options['compound']) {
            ...
            $csrfForm = $factory->createNamed($options['csrf_field_name'], \Symfony\Component\Form\Extension\Core\Type\HiddenType::class, $data, [
                'mapped' => false,
            ]);
