...
{
    private readonly \Symfony\Component\Form\Extension\DataCollector\FormDataExtractorInterface $dataExtractor;
     ...
     *
     */
    private ?array $formsByView = null;
    ...
    {
        $this->data['forms'][$form->getName()] = &$this->recursiveBuildFinalFormTree($view, $this->data['forms_by_hash'], $form);
    }
    ...
    protected function getCasters()
    {
        return parent::getCasters() + [
            ...
            FormView::class => static fn($obj, array $a, \Symfony\Component\VarDumper\Cloner\Stub $stub, $isNested) => \Symfony\Component\VarDumper\Caster\StubCaster::cutInternals($obj, $a, $stub, $isNested),
    ...
    private function &recursiveBuildFinalFormTree(FormView $view, array &$outputByHash, FormInterface $form = null)
    {
        ...
        foreach ($view->children as $name => $childView) {
            ...
            $childForm = $form instanceof \Symfony\Component\Form\FormInterface && $form->has($name)
                ? $form->get($name)
                : null;

            $output['children'][$name] = &$this->recursiveBuildFinalFormTree($childView, $outputByHash, $childForm);
        }
