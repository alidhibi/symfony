...
{
    private readonly \Symfony\Component\Form\ResolvedFormTypeFactoryInterface $proxiedFactory;

    private readonly \Symfony\Component\Form\Extension\DataCollector\FormDataCollectorInterface $dataCollector;
     ...
     * {@inheritdoc}
     */
    public function createResolvedType(FormTypeInterface $type, array $typeExtensions, ResolvedFormTypeInterface $parent = null): \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeDataCollectorProxy
    {
