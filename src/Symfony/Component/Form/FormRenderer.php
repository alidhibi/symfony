...
{
    final const CACHE_KEY_VAR = 'unique_block_prefix';

    private readonly \Symfony\Component\Form\FormRendererEngineInterface $engine;
     ...
     * {@inheritdoc}
     */
    public function getEngine(): \Symfony\Component\Form\FormRendererEngineInterface
    {
        return $this->engine;
    }
     ...
     * @internal
     */
    public function encodeCurrency(Environment $environment, $text, $widget = ''): string
    {
