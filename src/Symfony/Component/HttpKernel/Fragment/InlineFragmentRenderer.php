...
class InlineFragmentRenderer extends RoutableFragmentRenderer
{
    ...
    public function render($uri, Request $request, array $options = [])
    {
        ...
        if ($reference instanceof \Symfony\Component\HttpKernel\Controller\ControllerReference) {
        ...
        try {
            ...
            if (isset($options['ignore_errors']) && $options['ignore_errors'] && $this->dispatcher) {
                $event = new GetResponseForExceptionEvent($this->kernel, $request, HttpKernelInterface::SUB_REQUEST, $exception);
