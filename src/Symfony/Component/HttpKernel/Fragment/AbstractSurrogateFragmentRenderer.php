...
abstract class AbstractSurrogateFragmentRenderer extends RoutableFragmentRenderer
{
    ...
    private readonly \Symfony\Component\HttpKernel\Fragment\FragmentRendererInterface $inlineStrategy;

    private ?\Symfony\Component\HttpKernel\UriSigner $signer = null;
     ...
     */
    public function __construct(FragmentRendererInterface $inlineStrategy, SurrogateInterface $surrogate = null, UriSigner $signer = null)
    {
    ...
    private function generateSignedFragmentUri(\Symfony\Component\HttpKernel\Controller\ControllerReference $uri, Request $request)
    {
        if (!$this->signer instanceof \Symfony\Component\HttpKernel\UriSigner) {
