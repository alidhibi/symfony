...
class RequestDataCollector extends DataCollector implements EventSubscriberInterface, LateDataCollectorInterface
{
    ...
    public function getRequestRequest(): \Symfony\Component\HttpFoundation\ParameterBag
    {
        return new ParameterBag($this->data['request_request']->getValue());
    }

    public function getRequestQuery(): \Symfony\Component\HttpFoundation\ParameterBag
    {
        return new ParameterBag($this->data['request_query']->getValue());
    }

    public function getRequestHeaders(): \Symfony\Component\HttpFoundation\ParameterBag
    {
        return new ParameterBag($this->data['request_headers']->getValue());
    }

    public function getRequestServer($raw = false): \Symfony\Component\HttpFoundation\ParameterBag
    {
        return new ParameterBag($this->data['request_server']->getValue($raw));
    }

    public function getRequestCookies($raw = false): \Symfony\Component\HttpFoundation\ParameterBag
    {
        return new ParameterBag($this->data['request_cookies']->getValue($raw));
    }

    public function getRequestAttributes(): \Symfony\Component\HttpFoundation\ParameterBag
    {
        return new ParameterBag($this->data['request_attributes']->getValue());
    }

    public function getResponseHeaders(): \Symfony\Component\HttpFoundation\ParameterBag
    {
        return new ParameterBag($this->data['response_headers']->getValue());
    }

    public function getResponseCookies(): \Symfony\Component\HttpFoundation\ParameterBag
    {
