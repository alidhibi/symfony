...
class ConfigDataCollector extends DataCollector implements LateDataCollectorInterface
{
    ...
    public function collect(Request $request, Response $response, \Exception $exception = null): void
    {
        $this->data = [
            ...
            'name' => $this->kernel instanceof \Symfony\Component\HttpKernel\KernelInterface ? $this->kernel->getName() : 'n/a',
            'env' => $this->kernel instanceof \Symfony\Component\HttpKernel\KernelInterface ? $this->kernel->getEnvironment() : 'n/a',
            'debug' => $this->kernel instanceof \Symfony\Component\HttpKernel\KernelInterface ? $this->kernel->isDebug() : 'n/a',
