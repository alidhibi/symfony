...
{
    private readonly \Symfony\Component\HttpKernel\HttpKernelInterface $kernel;

    private readonly \Symfony\Component\HttpKernel\HttpCache\StoreInterface $store;
    ...
    public function __construct(HttpKernelInterface $kernel, StoreInterface $store, SurrogateInterface $surrogate = null, array $options = [])
    {
        ...
        $this->options = ['debug' => false, 'default_ttl' => 0, 'private_headers' => ['Authorization', 'Cookie'], 'allow_reload' => false, 'allow_revalidate' => false, 'stale_while_revalidate' => 2, 'stale_if_error' => 60, ...$options];
    }
    ...
    public function handle(Request $request, $type = HttpKernelInterface::MASTER_REQUEST, $catch = true)
    {
        ...
        if (HttpKernelInterface::MASTER_REQUEST === $type) {
            ...
            if ($this->surrogate instanceof \Symfony\Component\HttpKernel\HttpCache\SurrogateInterface) {
    ...
    protected function forward(Request $request, $catch = false, Response $entry = null)
    {
         ...
         */
        if ($entry instanceof \Symfony\Component\HttpFoundation\Response
    ...
    {
        if ($this->surrogate instanceof \Symfony\Component\HttpKernel\HttpCache\SurrogateInterface && $this->surrogate->needsParsing($response)) {
