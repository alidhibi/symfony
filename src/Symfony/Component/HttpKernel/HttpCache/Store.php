...
class Store implements StoreInterface
{
    ...
    private \SplObjectStorage|array $keyCache;
     ...
     */
    private function requestsMatch(string|array|null $vary, array $env1, array $env2): bool
    {
        if ($vary === '' || $vary === [] || $vary === null) {
            return true;
        }
     ...
     */
    private function doPurge(array|string|null $url): bool
    {
     ...
     *
     */
    private function restoreResponse(array $headers, $path = null): \Symfony\Component\HttpFoundation\Response
    {
