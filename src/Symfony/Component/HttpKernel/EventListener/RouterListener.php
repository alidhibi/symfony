...
{
    private readonly \Symfony\Component\Routing\Matcher\RequestMatcherInterface|\Symfony\Component\Routing\Matcher\UrlMatcherInterface $matcher;
    ...
    public function __construct($matcher, RequestStack $requestStack, RequestContext $context = null, LoggerInterface $logger = null, $projectDir = null, $debug = true)
    {
        ...
        if (!$context instanceof \Symfony\Component\Routing\RequestContext && !$matcher instanceof RequestContextAwareInterface) {
    ...
    private function setCurrentRequest(Request $request = null): void
    {
    ...
    private function createWelcomeResponse(): \Symfony\Component\HttpFoundation\Response
    {
