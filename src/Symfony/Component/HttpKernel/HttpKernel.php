...
class HttpKernel implements HttpKernelInterface, TerminableInterface
{
    ...
    protected \Symfony\Component\HttpKernel\Controller\ControllerResolverInterface $resolver;

    protected \Symfony\Component\HttpFoundation\RequestStack $requestStack;

    private \Symfony\Component\HttpKernel\Controller\ArgumentResolverInterface|null|\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface $argumentResolver = null;
     ...
     * @internal
     */
    public function terminateWithException(\Exception $exception, Request $request = null): void
    {
     ...
     * @param int $type
     */
    private function finishRequest(Request $request, $type): void
    {
     ...
     * @throws \Exception
     */
    private function handleException(\Exception $e, \Symfony\Component\HttpFoundation\Request $request, $type)
    {
