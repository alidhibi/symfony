...
class Profiler
{
    private readonly \Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface $storage;
    ...
    public function __construct(ProfilerStorageInterface $storage, LoggerInterface $logger = null, $enable = true)
    {
        ...
        $this->logger = $logger;
        $this->initiallyEnabled = (bool) $enable;
    ...
    public function saveProfile(Profile $profile)
    {
        ...
        if (!($ret = $this->storage->write($profile)) && $this->logger instanceof \Psr\Log\LoggerInterface) {
     ...
     */
    public function collect(Request $request, Response $response, \Exception $exception = null): ?\Symfony\Component\HttpKernel\Profiler\Profile
    {
        ...
        } catch (ConflictingHeadersException $conflictingHeadersException) {
