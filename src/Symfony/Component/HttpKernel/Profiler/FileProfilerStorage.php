...
class FileProfilerStorage implements ProfilerStorageInterface
{
    ...
    public function write(Profile $profile): bool
    {
        ...
        $childrenToken = array_filter(array_map(static fn($p) => $profileToken !== $p->getToken() ? $p->getToken() : null, $profile->getChildren()));
    ...
    protected function createProfileFromData($token, array $data, $parent = null): \Symfony\Component\HttpKernel\Profiler\Profile
    {
