...
class BundleTest extends TestCase
{
    public function testGetContainerExtension(): void
    {
        ...
        $this->assertInstanceOf(
            \Symfony\Component\HttpKernel\Tests\Fixtures\ExtensionPresentBundle\DependencyInjection\ExtensionPresentExtension::class,
    ...
    public function testHttpKernelRegisterCommandsIgnoresCommandsThatAreRegisteredAsServices(): void
    {
        $container = new ContainerBuilder();
        $container->register('console.command.symfony_component_httpkernel_tests_fixtures_extensionpresentbundle_command_foocommand', \Symfony\Component\HttpKernel\Tests\Fixtures\ExtensionPresentBundle\Command\FooCommand::class);

        $application = $this->getMockBuilder(\Symfony\Component\Console\Application::class)->getMock();
