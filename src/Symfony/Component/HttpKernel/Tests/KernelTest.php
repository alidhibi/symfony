...
class KernelTest extends TestCase
{
    ...
    public function testInitializeContainerClearsOldContainers(): void
    {
        ...
        $kernel = new CustomProjectDirKernel(static function ($container) : void {
    ...
    public function testBootInitializesBundlesAndContainer(): void
    {
    ...
    public function testBootSetsTheContainerToTheBundles(): void
    {
     ...
     * @group legacy
     */
    public function testClassCacheIsLoaded(): void
    {
    ...
    public function testClassCacheIsNotLoadedByDefault(): void
    {
        $kernel = $this->getKernel(['initializeBundles', 'initializeContainer', 'doLoadClassCache']);
     ...
     * @group legacy
     */
    public function testClassCacheIsNotLoadedWhenKernelIsNotBooted(): void
    {
        $kernel = $this->getKernel(['initializeBundles', 'initializeContainer', 'doLoadClassCache']);
    ...
    public function testEnvParametersResourceIsAdded(): void
    {
        $container = new ContainerBuilder();
        $kernel = $this->getMockBuilder(\Symfony\Component\HttpKernel\Tests\Fixtures\KernelForTest::class)
    ...
    public function testShutdownCallsShutdownOnAllBundles(): void
    {
        $bundle = $this->getMockBuilder(\Symfony\Component\HttpKernel\Bundle\Bundle::class)->getMock();
        $bundle->expects($this->once())
            ->method('shutdown');
    ...
    public function testShutdownGivesNullContainerToAllBundles(): void
    {
        $bundle = $this->getMockBuilder(\Symfony\Component\HttpKernel\Bundle\Bundle::class)->getMock();
    ...
    public function testHandleCallsHandleOnHttpKernel(): void
    {
    ...
    public function testHandleBootsTheKernel(): void
    {
        $type = HttpKernelInterface::MASTER_REQUEST;
        $catch = true;
        $request = new Request();
...
EOF;
    ...
    public function testOverrideGetName(): void
    {
    ...
    public function testLocateResourceThrowsExceptionWhenNameIsNotValid(): void
    {
        $this->expectException('InvalidArgumentException');
        $this->getKernel()->locateResource('Foo');
    }

    public function testLocateResourceThrowsExceptionWhenNameIsUnsafe(): void
    {
        $this->expectException('RuntimeException');
        $this->getKernel()->locateResource('@FooBundle/../bar');
    }

    public function testLocateResourceThrowsExceptionWhenBundleDoesNotExist(): void
    {
        $this->expectException('InvalidArgumentException');
        $this->getKernel()->locateResource('@FooBundle/config/routing.xml');
    }

    public function testLocateResourceThrowsExceptionWhenResourceDoesNotExist(): void
    {
        $this->expectException('InvalidArgumentException');
    ...
    public function testLocateResourceReturnsTheFirstThatMatches(): void
    {
        $kernel = $this->getKernel(['getBundle']);
        $kernel
            ->expects($this->once())
     ...
     * @group legacy
     */
    public function testLocateResourceReturnsTheFirstThatMatchesWithParent(): void
    {
     ...
     * @group legacy
     */
    public function testLocateResourceReturnsAllMatches(): void
    {
        $parent = $this->getBundle(__DIR__.'/Fixtures/Bundle1Bundle');
        $child = $this->getBundle(__DIR__.'/Fixtures/Bundle2Bundle');
     ...
     * @group legacy
     */
    public function testLocateResourceReturnsAllMatchesBis(): void
    {
        $kernel = $this->getKernel(['getBundle']);
        $kernel
            ->expects($this->once())
    ...
    public function testLocateResourceIgnoresDirOnNonResource(): void
    {
        $kernel = $this->getKernel(['getBundle']);
        $kernel
            ->expects($this->once())
    ...
    public function testLocateResourceReturnsTheDirOneForResources(): void
    {
        $kernel = $this->getKernel(['getBundle']);
        $kernel
            ->expects($this->once())
     ...
     * @group legacy
     */
    public function testLocateResourceReturnsTheDirOneForResourcesAndBundleOnes(): void
    {
        $kernel = $this->getKernel(['getBundle']);
        $kernel
            ->expects($this->once())
     ...
     * @group legacy
     */
    public function testLocateResourceOverrideBundleAndResourcesFolders(): void
    {
    ...
    public function testLocateResourceOnDirectories(): void
    {
        $kernel = $this->getKernel(['getBundle']);
        $kernel
            ->expects($this->exactly(2))
     ...
     * @group legacy
     */
    public function testInitializeBundles(): void
    {
     ...
     * @group legacy
     */
    public function testInitializeBundlesSupportInheritanceCascade(): void
    {
     ...
     * @group legacy
     */
    public function testInitializeBundlesThrowsExceptionWhenAParentDoesNotExists(): void
    {
     ...
     * @group legacy
     */
    public function testInitializeBundlesSupportsArbitraryBundleRegistrationOrder(): void
    {
     ...
     * @group legacy
     */
    public function testInitializeBundlesThrowsExceptionWhenABundleIsDirectlyExtendedByTwoBundles(): void
    {
        $this->expectException('LogicException');
     ...
     * @group legacy
     */
    public function testInitializeBundleThrowsExceptionWhenRegisteringTwoBundlesWithTheSameName(): void
    {
        $this->expectException('LogicException');
     ...
     * @group legacy
     */
    public function testInitializeBundleThrowsExceptionWhenABundleExtendsItself(): void
    {
        $this->expectException('LogicException');
    ...
    public function testTerminateReturnsSilentlyIfKernelIsNotBooted(): void
    {
        $kernel = $this->getKernel(['getHttpKernel']);
        $kernel->expects($this->never())
            ->method('getHttpKernel');
    ...
    public function testKernelWithoutBundles(): void
    {
    ...
    public function testKernelRootDirNameStartingWithANumber(): void
    {
     ...
     */
    public function testSymfonyEnvironmentVariables(): void
    {
    ...
    public function testProjectDirExtension(): void
    {
        $kernel = new CustomProjectDirKernel();
        $kernel->boot();
    ...
    public function testKernelReset(): void
    {
    ...
    public function testKernelPass(): void
    {
    ...
    public function testServicesResetter(): void
    {
     ...
     */
    public function testKernelStartTimeIsResetWhileBootingAlreadyBootedKernel(): void
    {
    ...
    {
        $bundle = $this
            ->getMockBuilder(\Symfony\Component\HttpKernel\Bundle\BundleInterface::class)
...
{
    private string $baseDir = 'foo';

    private ?\Closure $buildContainer = null;
    ...
    {
        if (($build = $this->buildContainer) instanceof \Closure) {
            $build($container);
        }
    }
