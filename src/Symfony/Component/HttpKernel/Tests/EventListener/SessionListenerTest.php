...
{
    public function testOnlyTriggeredOnMasterRequest(): void
    {
    ...
    public function testSessionIsSet(): void
    {
    ...
    public function testResponseIsPrivate(): void
    {
        $session = $this->getMockBuilder(Session::class)->disableOriginalConstructor()->getMock();
    ...
    public function testSurrogateMasterRequestIsPublic(): void
    {
        $session = $this->getMockBuilder(Session::class)->disableOriginalConstructor()->getMock();
