...
class ValidateRequestListenerTest extends TestCase
{
    ...
    public function testListenerThrowsWhenMasterRequestHasInconsistentClientIps(): void
    {
        ...
        $dispatcher->addListener(KernelEvents::REQUEST, static fn(\Symfony\Component\HttpKernel\Event\GetResponseEvent $event) => (new ValidateRequestListener())->onKernelRequest($event));
