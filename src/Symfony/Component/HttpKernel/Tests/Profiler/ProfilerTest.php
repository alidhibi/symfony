...
{
    private string|bool $tmp;

    private ?\Symfony\Component\HttpKernel\Profiler\FileProfilerStorage $storage = null;
    ...
    {
        if ($this->storage instanceof \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage) {
            $this->storage->purge();
            $this->storage = null;
