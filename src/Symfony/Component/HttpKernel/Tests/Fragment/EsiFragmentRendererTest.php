...
class EsiFragmentRendererTest extends TestCase
{
    ...
    {
        $strategy = new EsiFragmentRenderer($this->getInlineStrategy(true), new Esi());
     ...
     */
    public function testRenderFallbackWithObjectAttributesIsDeprecated(): void
    {
        $strategy = new EsiFragmentRenderer($this->getInlineStrategy(true), new Esi(), new UriSigner('foo'));
        $request = Request::create('/');
        $reference = new ControllerReference('main_controller', ['foo' => new \stdClass()], []);
        $strategy->render($reference, $request);
    }

    public function testRenderFallbackWithScalarIsNotDeprecated(): void
    {
        $strategy = new EsiFragmentRenderer($this->getInlineStrategy(true), new Esi(), new UriSigner('foo'));
        $request = Request::create('/');
    ...
    {
        $strategy = new EsiFragmentRenderer($this->getInlineStrategy(), new Esi());
    ...
    public function testRenderControllerReference(): void
    {
        ...
        $strategy = new EsiFragmentRenderer($this->getInlineStrategy(), new Esi(), $signer);
