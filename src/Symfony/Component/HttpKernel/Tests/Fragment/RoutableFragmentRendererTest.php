...
class RoutableFragmentRendererTest extends TestCase
{
     ...
     */
    public function testGenerateFragmentUri(string $uri, \Symfony\Component\HttpKernel\Controller\ControllerReference $controller): void
    {
     ...
     * @dataProvider getGenerateFragmentUriData
     */
    public function testGenerateAbsoluteFragmentUri(string $uri, \Symfony\Component\HttpKernel\Controller\ControllerReference $controller): void
    {
        $this->assertEquals('http://localhost'.$uri, $this->callGenerateFragmentUriMethod($controller, Request::create('/'), true));
    }

    public function getGenerateFragmentUriData(): array
    {
        return [
     ...
     */
    public function testGenerateFragmentUriWithNonScalar(\Symfony\Component\HttpKernel\Controller\ControllerReference $controller): void
    {
        $this->expectException('LogicException');
        $this->callGenerateFragmentUriMethod($controller, Request::create('/'));
    }

    public function getGenerateFragmentUriDataWithNonScalar(): array
    {
        return [
    ...
    private function callGenerateFragmentUriMethod(ControllerReference $reference, Request $request, bool $absolute = false)
    {
