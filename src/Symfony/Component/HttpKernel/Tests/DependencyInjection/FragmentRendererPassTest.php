...
class FragmentRendererPassTest extends TestCase
{
    ...
    public function testContentRendererWithoutInterface(): void
    {
        ...
        $builder->register('my_content_renderer', \Symfony\Component\DependencyInjection\Definition::class)
    ...
    public function testValidContentRenderer(): void
    {
        ...
        $fragmentHandlerDefinition = $builder->register('fragment.handler')
            ->addArgument(null);
        $builder->register('my_content_renderer', \Symfony\Component\HttpKernel\Tests\DependencyInjection\RendererService::class)
            ->addTag('kernel.fragment_renderer', ['alias' => 'foo']);
...
{
    public function render($uri, Request $request = null, array $options = []): void
    {
    }
