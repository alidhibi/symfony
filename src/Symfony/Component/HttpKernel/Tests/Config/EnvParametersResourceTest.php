...
class EnvParametersResourceTest extends TestCase
{
    ...
    public function testIsFreshNotChanged(): void
    {
        $this->assertTrue(
    ...
    public function testIsFreshValueChanged(): void
    {
    ...
    public function testIsFreshValueRemoved(): void
    {
        reset($this->initialEnv);
    ...
    public function testIsFreshValueAdded(): void
    {
