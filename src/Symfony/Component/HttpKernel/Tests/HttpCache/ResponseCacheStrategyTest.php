...
class ResponseCacheStrategyTest extends TestCase
{
    ...
    public function testEmbeddingPublicResponseDoesNotMakeMainResponsePublic(): void
    {
        $cacheStrategy = new ResponseCacheStrategy();
     ...
     */
    public function testCacheControlMerging(array $expects, array $master, array $surrogates): void
    {
        $cacheStrategy = new ResponseCacheStrategy();
        $buildResponse = static function ($config) : \Symfony\Component\HttpFoundation\Response {
            $response = new Response();
    ...
    public function cacheControlMergingProvider(): \Generator
    {
