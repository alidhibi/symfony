...
class LoggerDataCollectorTest extends TestCase
{
    ...
    {
        $logger = $this
            ->getMockBuilder(\Symfony\Component\HttpKernel\Log\DebugLoggerInterface::class)
        ...
        ], $compilerLogs[\Symfony\Component\DependencyInjection\Compiler\RemovePrivateAliasesPass::class]);
    ...
    public function testCollect($nb, $logs, $expectedLogs, $expectedDeprecationCount, $expectedScreamCount, $expectedPriorities = null): void
    {
        ...
        $logs = array_map(static function (array $v) : array {
