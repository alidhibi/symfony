...
abstract class AbstractNumberFormatterTest extends TestCase
{
     ...
     */
    public function testFormatCurrencyWithDecimalStyle(int|float $value, string $currency, string $expected): void
    {
     ...
     */
    public function testFormatCurrencyWithCurrencyStyle(int|float $value, string $currency, string $expected): void
    {
     ...
     */
    public function testFormatCurrencyWithCurrencyStyleCostaRicanColonsRounding(int|float $value, string $currency, string $symbol, string $expected): void
    {
        IntlTestHelper::requireIntl($this, '63.1');
     ...
     */
    public function testFormatCurrencyWithCurrencyStyleBrazilianRealRounding(int|float $value, string $currency, string $symbol, string $expected): void
    {
        $formatter = $this->getNumberFormatter('en', NumberFormatter::CURRENCY);
        $this->assertEquals(sprintf($expected, $symbol), $formatter->formatCurrency($value, $currency));
    }
     ...
     */
    public function testFormatCurrencyWithCurrencyStyleSwissRounding(int|float|string $value, string $currency, string $symbol, string $expected): void
    {
    ...
    public function formatCurrencyWithCurrencyStyleSwissRoundingProvider()
    {
        return [
            ...
            [1_200_000.00, 'CHF', 'CHF', "%s\xc2\xa01,200,000.00"],
            [1_200_000.1, 'CHF', 'CHF', "%s\xc2\xa01,200,000.10"],
            [1_200_000.10, 'CHF', 'CHF', "%s\xc2\xa01,200,000.10"],
            [1_200_000.101, 'CHF', 'CHF', "%s\xc2\xa01,200,000.10"],
        ];
    }
    ...
    public function formatTypeInt32Provider()
    {
        ...
        return [
            [$formatter, 1, '1'],
            [$formatter, 1.1, '1'],
            [$formatter, 2_147_483_648, '-2,147,483,648', $message],
            [$formatter, -2_147_483_649, '2,147,483,647', $message],
        ];
    }
    ...
    public function formatTypeInt32WithCurrencyStyleProvider()
    {
        ...
        return [
            [$formatter, 1, '¤1.00'],
            [$formatter, 1.1, '¤1.00'],
            [$formatter, 2_147_483_648, '-¤2,147,483,648.00', $message],
            [$formatter, -2_147_483_649, '¤2,147,483,647.00', $message],
        ];
    }
    ...
    public function formatTypeInt64Provider()
    {
        ...
        return [
            [$formatter, 1, '1'],
            [$formatter, 1.1, '1'],
            [$formatter, 2_147_483_648, '2,147,483,648'],
            [$formatter, -2_147_483_649, '-2,147,483,649'],
        ];
    }
    ...
    public function formatTypeInt64WithCurrencyStyleProvider()
    {
        ...
        return [
            [$formatter, 1, '¤1.00'],
            [$formatter, 1.1, '¤1.00'],
            [$formatter, 2_147_483_648, '¤2,147,483,648.00'],
            [$formatter, -2_147_483_649, '-¤2,147,483,649.00'],
        ];
    }
     ...
     */
    public function testFormatTypeCurrency(\NumberFormatter $formatter, int $value): void
    {
     ...
     * @dataProvider formatTypeCurrencyProvider
     */
    public function testFormatTypeCurrencyReturn(\NumberFormatter $formatter, int $value): void
    {
        $this->expectException(\ValueError::class);
     ...
     */
    public function testFormatFractionDigits(float $value, string $expected, int|string|null $fractionDigits = null, int $expectedFractionDigits = 1): void
    {
        IntlTestHelper::requireIntl($this, '62.1');
     ...
     */
    public function testFormatGroupingUsed(int $value, string $expected, int|string|null $groupingUsed = null, int $expectedGroupingUsed = 1): void
    {
        $formatter = $this->getNumberFormatter('en', NumberFormatter::DECIMAL);
     ...
     */
    public function testFormatRoundingModeHalfUp(float $value, string $expected): void
    {
        $formatter = $this->getNumberFormatter('en', NumberFormatter::DECIMAL);
     ...
     */
    public function testFormatRoundingModeHalfDown(float $value, string $expected): void
    {
        $formatter = $this->getNumberFormatter('en', NumberFormatter::DECIMAL);
        $formatter->setAttribute(NumberFormatter::FRACTION_DIGITS, 2);
     ...
     */
    public function testFormatRoundingModeHalfEven(float $value, string $expected): void
    {
        $formatter = $this->getNumberFormatter('en', NumberFormatter::DECIMAL);
        $formatter->setAttribute(NumberFormatter::FRACTION_DIGITS, 2);
     ...
     */
    public function testFormatRoundingModeCeiling(float $value, string $expected): void
    {
        $formatter = $this->getNumberFormatter('en', NumberFormatter::DECIMAL);
        $formatter->setAttribute(NumberFormatter::FRACTION_DIGITS, 2);
     ...
     */
    public function testFormatRoundingModeFloor(float $value, string $expected): void
    {
        $formatter = $this->getNumberFormatter('en', NumberFormatter::DECIMAL);
        $formatter->setAttribute(NumberFormatter::FRACTION_DIGITS, 2);
     ...
     */
    public function testFormatRoundingModeDown(float $value, string $expected): void
    {
        $formatter = $this->getNumberFormatter('en', NumberFormatter::DECIMAL);
        $formatter->setAttribute(NumberFormatter::FRACTION_DIGITS, 2);
     ...
     */
    public function testFormatRoundingModeUp(float $value, string $expected): void
    {
        $formatter = $this->getNumberFormatter('en', NumberFormatter::DECIMAL);
        $formatter->setAttribute(NumberFormatter::FRACTION_DIGITS, 2);
    ...
    public function testGetSymbol(): void
    {
        ...
        $r = new \ReflectionProperty(\Symfony\Component\Intl\NumberFormatter\NumberFormatter::class, 'enSymbols');
    ...
    public function testGetTextAttribute(): void
    {
        ...
        $r = new \ReflectionProperty(\Symfony\Component\Intl\NumberFormatter\NumberFormatter::class, 'enTextAttributes');
        $r->setAccessible(true);
     ...
     */
    public function testParse(string $value, bool|float $expected, string $message, int $expectedPosition, bool $groupingUsed = true): void
    {
        IntlTestHelper::requireIntl($this, '62.1');
    ...
    public function parseProvider()
    {
        return [
            ...
            ['-123,456,789', -123_456_789.0, '->parse() parses a number with grouping.', 12],
            ['-123,456,789', -123.0, '->parse() truncates a group if grouping is disabled.', 4, false],
            ['-123,456,789.66', -123_456_789.66, '->parse() parses a number with grouping.', 15],
    ...
    public function testParseTypeDefault(): void
    {
        $this->expectException(\ValueError::class);
     ...
     */
    public function testParseTypeInt32(string $value, int|bool $expected, string $message = ''): void
    {
        $formatter = $this->getNumberFormatter('en', NumberFormatter::DECIMAL);
    ...
    public function testParseTypeInt64With32BitIntegerInPhp32Bit(): void
    {
        ...
        $this->assertEquals(2_147_483_647, $parsedValue);

        $parsedValue = $formatter->parse('-2,147,483,648', NumberFormatter::TYPE_INT64);
        $this->assertIsInt($parsedValue);
        $this->assertEquals(-2_147_483_648, $parsedValue);
    }

    public function testParseTypeInt64With32BitIntegerInPhp64Bit(): void
    {
        ...
        $parsedValue = $formatter->parse('-2,147,483,648', NumberFormatter::TYPE_INT64);
        $this->assertIsInt($parsedValue);
        $this->assertEquals(-2_147_483_647 - 1, $parsedValue);
    }

    /**
     * If PHP is compiled in 32bit mode, the returned value for a 64bit integer are float numbers.
     */
    public function testParseTypeInt64With64BitIntegerInPhp32Bit(): void
    {
        IntlTestHelper::require32Bit($this);
        ...
        $this->assertEquals(2_147_483_648, $parsedValue, '->parse() TYPE_INT64 does not use true 64 bit integers, using only the 32 bit range.');

        $parsedValue = $formatter->parse('-2,147,483,649', NumberFormatter::TYPE_INT64);
        $this->assertIsFloat($parsedValue);
        $this->assertEquals(-2_147_483_649, $parsedValue, '->parse() TYPE_INT64 does not use true 64 bit integers, using only the 32 bit range.');
    }

    /**
     * If PHP is compiled in 64bit mode, the returned value for a 64bit integer are 32bit integer numbers.
     */
    public function testParseTypeInt64With64BitIntegerInPhp64Bit(): void
    {
        IntlTestHelper::require64Bit($this);
        ...
        $this->assertEquals(2_147_483_648, $parsedValue, '->parse() TYPE_INT64 uses true 64 bit integers (PHP >= 5.3.14 and PHP >= 5.4.4).');

        $parsedValue = $formatter->parse('-2,147,483,649', NumberFormatter::TYPE_INT64);
        $this->assertIsInt($parsedValue);

        $this->assertEquals(-2_147_483_649, $parsedValue, '->parse() TYPE_INT64 uses true 64 bit integers (PHP >= 5.3.14 and PHP >= 5.4.4).');
    }

    /**
     * @dataProvider parseTypeDoubleProvider
     */
    public function testParseTypeDouble(string $value, float $expectedValue): void
    {
        $formatter = $this->getNumberFormatter('en', NumberFormatter::DECIMAL);
    ...
    public function parseTypeDoubleProvider()
    {
        return [
            ['1', (float) 1],
            ['1.1', 1.1],
            ['9,223,372,036,854,775,808', 9_223_372_036_854_775_808.0],
            ['-9,223,372,036,854,775,809', -9_223_372_036_854_775_809.0],
        ];
    }

    public function testParseTypeCurrency(): void
    {
        $this->expectException(\ValueError::class);
