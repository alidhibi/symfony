...
abstract class AbstractIntlDateFormatterTest extends TestCase
{
    ...
    public function testConstructorWithoutDateType(): void
    {
    ...
    public function testConstructorWithoutTimeType(): void
    {
    ...
    public function formatProvider()
    {
        ...
        $formatData = [
            ...
            ['QQ', 7_776_000, '02'],
            ['QQQ', 7_776_000, 'Q2'],
            ['QQQQ', 7_776_000, '2nd quarter'],

            // 7 months
            ['QQQQ', 15_638_400, '3rd quarter'],

            // 10 months
            ['QQQQ', 23_587_200, '4th quarter'],
            ...
            ['D', 0, '1'],
            ['D', 86400, '2'], // 1 day
            ['D', 31_536_000, '1'], // 1 year
            ['D', 31_622_400, '2'], // 1 year + 1 day
            ...
            ['E', 1_296_540_000, 'Tue'], // 2011-02-01
            ['E', 1_296_950_400, 'Sun'], // 2011-02-06
     ...
     */
    public function testFormatIllegalArgumentError(string $pattern, string $timestamp, string $errorMessage): void
    {
    ...
    public function formatTimezoneProvider()
    {
        ...
        if (!\defined('HHVM_VERSION')) {
            ...
            $cases = [...$cases, ['z', 'GMT+03:00', 'GMT+3'], ['zz', 'GMT+03:00', 'GMT+3'], ['zzz', 'GMT+03:00', 'GMT+3'], ['zzzz', 'GMT+03:00', 'GMT+03:00'], ['zzzzz', 'GMT+03:00', 'GMT+03:00']];
        }
     ...
     */
    public function testDateAndTimeType(int $timestamp, int $datetype, int $timetype, string $expected): void
    {
    ...
    public function parseQuarterProvider()
    {
        return [
            ...
            ['QQ', '02', 7_776_000],
            ['QQQ', 'Q2', 7_776_000],
            ['QQQQ', '2nd quarter', 7_776_000],
            ['QQQQQ', '2nd quarter', 7_776_000],
     ...
     */
    public function testParseError(string $pattern, string $value): void
    {
     ...
     */
    public function testSetTimeZoneId(?string $timeZoneId, string $expectedTimeZoneId): void
    {
        $formatter = $this->getDefaultDateFormatter();
