...
class IcuVersionTest extends TestCase
{
     ...
     */
    public function testNormalize(?int $precision, string $version, string $result): void
    {
     ...
     */
    public function testCompare(?int $precision, string $version1, string $operator, string $version2, bool $result): void
    {
