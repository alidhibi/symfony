...
class GitRepositoryTest extends TestCase
{
    ...
    final const REPO_URL = 'https://github.com/symfony/intl.git';
    ...
    public function testItClonesTheRepository(): void
    {
        ...
        $this->assertStringMatchesFormat('v3%s', $git->getLastTag(static fn($tag): bool => 0 === strpos($tag, 'v3')));
    }
    ...
    public function testItCheckoutsToTheLastTag(): void
    {
        ...
        $lastV3Tag = $git->getLastTag(static fn($tag): bool => 0 === strpos($tag, 'v3'));
