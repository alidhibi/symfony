...
abstract class AbstractDataProviderTest extends TestCase
{
    ...
    {
        return array_map(
            static fn($alias, $ofLocale): array => [$alias, $ofLocale],
    ...
    protected function getRootLocales()
    {
        if (null === self::$rootLocales) {
            self::$rootLocales = array_filter(static::getLocales(), static fn($locale): bool => false === strpos($locale, '_'));
        }
