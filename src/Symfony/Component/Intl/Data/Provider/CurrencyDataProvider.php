...
{
    final const INDEX_SYMBOL = 0;

    final const INDEX_NAME = 1;

    final const INDEX_FRACTION_DIGITS = 0;

    final const INDEX_ROUNDING_INCREMENT = 1;

    private $path;

    private readonly \Symfony\Component\Intl\Data\Bundle\Reader\BundleEntryReaderInterface $reader;
    ...
    public function getNames($displayLocale = null)
    {
        ...
        array_walk($names, static function (array &$value) use ($index) : void {
            $value = $value[$index];
        });
