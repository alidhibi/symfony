...
class TextBundleWriter implements BundleWriterInterface
{
     ...
     * @see http://source.icu-project.org/repos/icu/icuhtml/trunk/design/bnf_rb.txt
     */
    private function writeResource($file, $value, int|float $indentation, bool $requireBraces = true): void
    {
        if (\is_int($value)) {
     ...
     * @see http://source.icu-project.org/repos/icu/icuhtml/trunk/design/bnf_rb.txt
     */
    private function writeString($file, string $value, $requireBraces = true): void
    {
        if ($requireBraces) {
