...
final class Intl
{
    ...
    private static ?\Symfony\Component\Intl\ResourceBundle\CurrencyBundle $currencyBundle = null;

    private static ?\Symfony\Component\Intl\ResourceBundle\LanguageBundle $languageBundle = null;

    private static ?\Symfony\Component\Intl\ResourceBundle\LocaleBundle $localeBundle = null;

    private static ?\Symfony\Component\Intl\ResourceBundle\RegionBundle $regionBundle = null;
    ...
    private static ?\Symfony\Component\Intl\Data\Bundle\Reader\BundleEntryReader $entryReader = null;
     ...
     */
    public static function getCurrencyBundle(): ?\Symfony\Component\Intl\ResourceBundle\CurrencyBundle
    {
        if (!self::$currencyBundle instanceof \Symfony\Component\Intl\ResourceBundle\CurrencyBundle) {
     ...
     */
    public static function getLanguageBundle(): ?\Symfony\Component\Intl\ResourceBundle\LanguageBundle
    {
        if (!self::$languageBundle instanceof \Symfony\Component\Intl\ResourceBundle\LanguageBundle) {
     ...
     */
    public static function getLocaleBundle(): ?\Symfony\Component\Intl\ResourceBundle\LocaleBundle
    {
        if (!self::$localeBundle instanceof \Symfony\Component\Intl\ResourceBundle\LocaleBundle) {
     ...
     */
    public static function getRegionBundle(): ?\Symfony\Component\Intl\ResourceBundle\RegionBundle
    {
        if (!self::$regionBundle instanceof \Symfony\Component\Intl\ResourceBundle\RegionBundle) {
     ...
     */
    private static function getEntryReader(): ?\Symfony\Component\Intl\Data\Bundle\Reader\BundleEntryReader
    {
        if (!self::$entryReader instanceof \Symfony\Component\Intl\Data\Bundle\Reader\BundleEntryReader) {
