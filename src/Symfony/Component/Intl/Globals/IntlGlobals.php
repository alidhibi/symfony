...
abstract class IntlGlobals
{
     ...
     */
    final const U_ZERO_ERROR = 0;

    /**
     * Indicates that an invalid argument was passed.
     */
    final const U_ILLEGAL_ARGUMENT_ERROR = 1;

    /**
     * Indicates that the parse() operation failed.
     */
    final const U_PARSE_ERROR = 9;
    ...
    public static function setError($code, $message = ''): void
    {
        ...
        self::$errorMessage = $message !== '' && $message !== '0' ? sprintf('%s: %s', $message, self::$errorCodes[$code]) : self::$errorCodes[$code];
        self::$errorCode = $code;
    }
}
