...
class IntlDateFormatter
{
    ...
    final const MEDIUM = 2;

    final const SHORT = 3;

    /* calendar formats */
    final const TRADITIONAL = 0;

    final const GREGORIAN = 1;
    ...
    private bool $uninitializedTimeZoneId = false;
     ...
     * @throws MethodArgumentValueNotImplementedException When $calendar different than GREGORIAN is passed
     */
    public static function create($locale, $datetype, $timetype, $timezone = null, $calendar = self::GREGORIAN, $pattern = null): self
    {
     ...
     */
    public function formatObject($object, $format = null, $locale = null): never
    {
     ...
     * @throws MethodNotImplementedException
     */
    public function getCalendarObject(): never
    {
        throw new MethodNotImplementedException(__METHOD__);
    }
     ...
     * @throws MethodNotImplementedException
     */
    public function getTimeZone(): never
    {
        throw new MethodNotImplementedException(__METHOD__);
    }
     ...
     * @throws MethodNotImplementedException
     */
    public function localtime($value, &$position = 0): never
    {
        throw new MethodNotImplementedException(__METHOD__);
    }
     ...
     * @throws MethodNotImplementedException
     */
    public function setCalendar($calendar): never
    {
        throw new MethodNotImplementedException(__METHOD__);
    }
     ...
     */
    public function setTimeZoneId($timeZoneId): bool
    {
        if (null === $timeZoneId) {
     ...
     *
     */
    protected function createDateTime($timestamp): \DateTime
    {
