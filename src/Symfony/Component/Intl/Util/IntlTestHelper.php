...
class IntlTestHelper
{
     ...
     */
    public static function requireIntl(TestCase $testCase, $minimumIcuVersion = null): void
    {
     ...
     * implementation.
     */
    public static function requireFullIntl(TestCase $testCase, $minimumIcuVersion = null): void
    {
