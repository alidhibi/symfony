...
class TypeTest extends TestCase
{
    public function testConstruct(): void
    {
        ...
        $this->assertInstanceOf(\Symfony\Component\PropertyInfo\Type::class, $collectionKeyType);
        $this->assertEquals(Type::BUILTIN_TYPE_INT, $collectionKeyType->getBuiltinType());

        $collectionValueType = $type->getCollectionValueType();
        $this->assertInstanceOf(\Symfony\Component\PropertyInfo\Type::class, $collectionValueType);
