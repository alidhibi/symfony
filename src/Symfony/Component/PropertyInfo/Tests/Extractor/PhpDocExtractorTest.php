...
{
    private \Symfony\Component\PropertyInfo\Extractor\PhpDocExtractor $extractor;
     ...
     */
    public function testExtract(string $property, ?string $shortDescription, ?string $longDescription, array $type = null): void
    {
        $this->assertEquals($type, $this->extractor->getTypes(\Symfony\Component\PropertyInfo\Tests\Fixtures\Dummy::class, $property));
        $this->assertSame($shortDescription, $this->extractor->getShortDescription(\Symfony\Component\PropertyInfo\Tests\Fixtures\Dummy::class, $property));
        $this->assertSame($longDescription, $this->extractor->getLongDescription(\Symfony\Component\PropertyInfo\Tests\Fixtures\Dummy::class, $property));
    }
    ...
    public function testExtractTypesWithCustomPrefixes(string $property, array $type = null): void
    {
        ...
        $this->assertEquals($type, $customExtractor->getTypes(\Symfony\Component\PropertyInfo\Tests\Fixtures\Dummy::class, $property));
    }
    ...
    public function testExtractTypesWithNoPrefixes(string $property, array $type = null): void
    {
        ...
        $this->assertEquals($type, $noPrefixExtractor->getTypes(\Symfony\Component\PropertyInfo\Tests\Fixtures\Dummy::class, $property));
    }
    ...
    public function typesProvider(): array
    {
        return [
            ...
            ['parent', [new Type(Type::BUILTIN_TYPE_OBJECT, false, \Symfony\Component\PropertyInfo\Tests\Fixtures\ParentDummy::class)], null, null],
            ...
            ['b', [new Type(Type::BUILTIN_TYPE_OBJECT, true, \Symfony\Component\PropertyInfo\Tests\Fixtures\ParentDummy::class)], 'B.', null],
    ...
    {
        $this->assertEquals($types, $this->extractor->getTypes(\Symfony\Component\PropertyInfo\Tests\Fixtures\DockBlockFallback::class, $property));
    }
}
