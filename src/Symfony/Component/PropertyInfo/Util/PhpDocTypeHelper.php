...
final class PhpDocTypeHelper
{
    ...
    public function getTypes(DocType $varType): array
    {
        ...
        $nullKey = array_search(Type::BUILTIN_TYPE_NULL, $varTypes, true);
     ...
     *
     */
    private function createType(string $docType, $nullable): ?\Symfony\Component\PropertyInfo\Type
    {
        // Cannot guess
     ...
     *
     */
    private function getPhpTypeAndClass($docType): array
    {
