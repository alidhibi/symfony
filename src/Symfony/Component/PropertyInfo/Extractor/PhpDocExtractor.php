...
{
    final const PROPERTY = 0;

    final const ACCESSOR = 1;

    final const MUTATOR = 2;
    ...
    private function getDocBlockFromProperty($class, $property): ?\phpDocumentor\Reflection\DocBlock
    {
        ...
        try {
            ...
            return null;
        } catch (\RuntimeException $reflectionException) {
            return null;
        }
    }
     ...
     *
     */
    private function getDocBlockFromMethod($class, string $ucFirstProperty, int $type): ?array
    {
