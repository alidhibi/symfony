...
class ReflectionExtractor implements PropertyListExtractorInterface, PropertyTypeExtractorInterface, PropertyAccessExtractorInterface
{
    ...
    private readonly bool $supportsParameterType;
     ...
     *
     */
    private function getAccessorMethod($class, $property): ?array
    {
     ...
     *
     */
    private function getMutatorMethod($class, $property): ?array
    {
        $ucProperty = ucfirst($property);
