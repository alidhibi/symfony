...
class CacheClearCommand extends ContainerAwareCommand
{
     ...
     */
    public function __construct(string $cacheClearer = null)
    {
...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            ...
            if ($output->isVerbose()) {
                $io->warning($ioException->getMessage());
            }
        }
     ...
     */
    protected function warmup(string $warmupDir, $realCacheDir, $enableOptionalWarmers = true)
    {
     ...
     */
    protected function getTempKernel(KernelInterface $parent, $namespace, $parentClass, string|iterable $warmupDir)
    {
        $projectDir = '';
