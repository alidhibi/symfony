...
{
    final const MESSAGE_MISSING = 0;

    final const MESSAGE_UNUSED = 1;
    ...
    public function __construct(string $translator = null)
    {
...
EOF
    ...
    private function formatId(int|string $id): string
    {
        return sprintf('<fg=cyan;options=bold>%s</>', $id);
    }

    private function sanitizeString($string, $length = 40): string
    {
     ...
     */
    private function extractMessages($locale, $transPaths): \Symfony\Component\Translation\MessageCatalogue
    {
     ...
     * @return MessageCatalogue
     */
    private function loadCurrentMessages($locale, $transPaths): \Symfony\Component\Translation\MessageCatalogue
    {
     ...
     * @return MessageCatalogue[]
     */
    private function loadFallbackCatalogues($locale, $transPaths): array
    {
        $fallbackCatalogues = [];
