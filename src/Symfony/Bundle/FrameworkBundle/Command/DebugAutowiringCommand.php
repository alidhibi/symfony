...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output): ?int
    {
        ...
        $serviceIds = array_filter($serviceIds, fn($serviceId) => $this->filterToServiceTypes($serviceId));

        if ($search = $input->getArgument('search')) {
            $serviceIds = array_filter($serviceIds, static fn($serviceId): bool => false !== stripos($serviceId, $search));
