...
{
    final const METHOD_COPY = 'copy';

    final const METHOD_ABSOLUTE_SYMLINK = 'absolute symlink';

    final const METHOD_RELATIVE_SYMLINK = 'relative symlink';
     ...
     */
    public function __construct(string $filesystem = null)
    {
...
EOT
     ...
     * @return string
     */
    private function relativeSymlinkWithFallback(string $originDir, $targetDir)
    {
        try {
     ...
     * @return string
     */
    private function absoluteSymlinkWithFallback(string $originDir, $targetDir)
    {
        try {
     ...
     */
    private function symlink($originDir, $targetDir, bool $relative = false): void
    {
        if ($relative) {
     ...
     *
     */
    private function hardCopy(string|array $originDir, $targetDir): string
    {
