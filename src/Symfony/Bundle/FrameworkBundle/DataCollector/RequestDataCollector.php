...
class RequestDataCollector extends BaseRequestCollector implements EventSubscriberInterface
{
    ...
    public function collect(Request $request, Response $response, \Exception $exception = null): void
    {
        ...
        if (($parentRequestAttributes = $request->attributes->get('_forwarded')) && $parentRequestAttributes instanceof ParameterBag) {
    ...
    public function onKernelController(FilterControllerEvent $event): void
    {
        ...
        if (($parentRequestAttributes = $event->getRequest()->attributes->get('_forwarded')) && $parentRequestAttributes instanceof ParameterBag) {
