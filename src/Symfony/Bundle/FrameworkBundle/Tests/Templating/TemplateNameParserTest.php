...
class TemplateNameParserTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $kernel
            ->expects($this->any())
            ->method('getBundle')
            ->willReturnCallback(static function ($bundle) {
     ...
     */
    public function testParse(string $name, string $logicalName, string $path, \Symfony\Bundle\FrameworkBundle\Templating\TemplateReference|BaseTemplateReference $ref): void
    {
     ...
     */
    public function testAbsolutePathsAreDeprecated(string $name, string $logicalName, string $path, BaseTemplateReference $ref): void
    {
        $template = $this->parser->parse($name);
