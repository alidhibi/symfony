...
class TimedPhpEngineTest extends TestCase
{
    ...
    {
        return $this->getMockBuilder(\Symfony\Bundle\FrameworkBundle\Templating\GlobalVariables::class)
    ...
    {
        return $this->getMockBuilder(\Symfony\Component\Stopwatch\StopwatchEvent::class)
            ->disableOriginalConstructor()
            ->getMock();
    }
    ...
    {
        return $this->getMockBuilder(\Symfony\Component\Stopwatch\Stopwatch::class)->getMock();
    }
}
