...
class DelegatingEngineTest extends TestCase
{
    ...
    private function getFrameworkEngineMock(string $template, bool $supports)
    {
    ...
    private function getContainerMock($services): \Symfony\Component\DependencyInjection\ContainerBuilder
    {
