...
class TemplateFilenameParserTest extends TestCase
{
     ...
     */
    public function testParseFromFilename(string $file, \Symfony\Bundle\FrameworkBundle\Templating\TemplateReference|bool $ref): void
    {
    ...
    public function getFilenameToTemplateProvider(): array
    {
        return [
