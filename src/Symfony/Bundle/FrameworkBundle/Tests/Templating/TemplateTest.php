...
class TemplateTest extends TestCase
{
     ...
     */
    public function testGetPathForTemplate(\Symfony\Bundle\FrameworkBundle\Templating\TemplateReference $template, string $path): void
    {
        $this->assertSame($template->getPath(), $path);
    }

    public function getTemplateToPathProvider(): array
    {
        return [
