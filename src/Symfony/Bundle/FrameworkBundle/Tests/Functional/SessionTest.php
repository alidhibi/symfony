...
class SessionTest extends AbstractWebTestCase
{
     ...
     */
    public function testWelcome(string $config, bool $insulate): void
    {
     ...
     * @dataProvider getConfigs
     */
    public function testFlash(string $config, bool $insulate): void
    {
        $client = $this->createClient(['test_case' => 'Session', 'root_config' => $config]);
        if ($insulate) {
            $client->insulate();
     ...
     * @dataProvider getConfigs
     */
    public function testFlashOnInjectedFlashbag(string $config, bool $insulate): void
    {
        $client = $this->createClient(['test_case' => 'Session', 'root_config' => $config]);
        if ($insulate) {
            $client->insulate();
     ...
     * @dataProvider getConfigs
     */
    public function testTwoClients(string $config, bool $insulate): void
    {
        // start first client
     ...
     * @dataProvider getConfigs
     */
    public function testCorrectCacheControlHeadersForCacheableAction(string $config, bool $insulate): void
    {
        $client = $this->createClient(['test_case' => 'Session', 'root_config' => $config]);
        if ($insulate) {
            $client->insulate();
