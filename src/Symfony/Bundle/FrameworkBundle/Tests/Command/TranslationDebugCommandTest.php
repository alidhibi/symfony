...
class TranslationDebugCommandTest extends TestCase
{
    ...
    private function createCommandTester($extractedMessages = [], $loadedMessages = [], $kernel = null): \Symfony\Component\Console\Tester\CommandTester
    {
     ...
     */
    public function testLegacyDebugCommand(): void
    {
        $translator = $this->getMockBuilder('Symfony\Component\Translation\Translator')
            ->disableOriginalConstructor()
            ->getMock();
