...
EOF;
     ...
     */
    private function createFile(string $content): string|bool
    {
    ...
    private function createCommandTester($application = null): \Symfony\Component\Console\Tester\CommandTester
    {
        if (!$application) {
