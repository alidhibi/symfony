...
class ObjectsProvider
{
    ...
    public static function getContainerParameters(): array
    {
        return [
    ...
    public static function getEventDispatchers(): array
    {
        ...
        $eventDispatcher->addListener('event1', static fn(): string => 'Closure', -1);
    ...
    public static function getCallables(): array
    {
        $callables = [
            ...
            'callable_2' => static fn() => \Symfony\Bundle\FrameworkBundle\Tests\Console\Descriptor\CallableClass::staticMethod(),
            'callable_3' => static fn() => (new CallableClass())->method(),
            'callable_4' => \Symfony\Bundle\FrameworkBundle\Tests\Console\Descriptor\CallableClass::class . '::staticMethod',
            'callable_5' => [\Symfony\Bundle\FrameworkBundle\Tests\Console\Descriptor\ExtendedCallableClass::class, 'parent::staticMethod'],
            'callable_6' => static fn(): string => 'Closure',
