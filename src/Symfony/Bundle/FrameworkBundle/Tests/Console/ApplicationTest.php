...
class ApplicationTest extends TestCase
{
    ...
    public function testBundleCommandsHaveRightContainer(): void
    {
        ...
        $command->setCode(static function () : void {
        });
    ...
    public function testRunOnlyWarnsOnUnregistrableCommand(): void
    {
        ...
        $kernel
            ...
            ->willReturn([$this->createBundleMock(
                [(new Command('fine'))->setCode(static function (InputInterface $input, OutputInterface $output) : void {
                    $output->write('fine');
                })]
            )]);
        $kernel
    ...
    public function testRegistrationErrorsAreDisplayedOnCommandNotFound(): void
    {
        ...
        $kernel
            ->method('getBundles')
            ->willReturn([$this->createBundleMock(
                [(new Command(null))->setCode(static function (InputInterface $input, OutputInterface $output) : void {
                    $output->write('fine');
                })]
            )]);
        $kernel
    ...
    private function getKernel(array $bundles, bool $useDispatcher = false)
    {
