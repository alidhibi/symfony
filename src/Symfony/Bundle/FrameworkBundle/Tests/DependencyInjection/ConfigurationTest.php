...
class ConfigurationTest extends TestCase
{
     ...
     */
    public function testTrustedProxiesSetToNullIsDeprecated(): void
    {
        $processor = new Processor();
     ...
     * @expectedDeprecation The "framework.trusted_proxies" configuration key has been deprecated in Symfony 3.3. Use the Request::setTrustedProxies() method in your front controller instead.
     */
    public function testTrustedProxiesSetToEmptyArrayIsDeprecated(): void
    {
        $processor = new Processor();
        $configuration = new Configuration(true);
     ...
     * @expectedDeprecation The "framework.trusted_proxies" configuration key has been deprecated in Symfony 3.3. Use the Request::setTrustedProxies() method in your front controller instead.
     */
    public function testTrustedProxiesSetToNonEmptyArrayIsInvalid(): void
    {
        $processor = new Processor();
        $configuration = new Configuration(true);
     ...
     * @group legacy
     */
    public function testValidTrustedProxies(bool|array|null $trustedProxies, array $processedProxies): void
    {
        $processor = new Processor();
        $configuration = new Configuration(true);
    ...
    public function getTestValidTrustedProxiesData(): array
    {
        return [
            [['127.0.0.1'], ['127.0.0.1']],
            [['::1'], ['::1']],
     ...
     * @group legacy
     */
    public function testInvalidTypeTrustedProxies(): void
    {
        $this->expectException('Symfony\Component\Config\Definition\Exception\InvalidConfigurationException');
        $processor = new Processor();
        $configuration = new Configuration(true);
     ...
     * @group legacy
     */
    public function testInvalidValueTrustedProxies(): void
    {
        $this->expectException('Symfony\Component\Config\Definition\Exception\InvalidConfigurationException');
        $processor = new Processor();
        $configuration = new Configuration(true);
     ...
     */
    public function testValidAssetsPackageNameConfiguration(string $packageName): void
    {
        $processor = new Processor();
        $configuration = new Configuration(true);
        $config = $processor->processConfiguration($configuration, [
    ...
    public function provideValidAssetsPackageNameConfigurationTests(): array
    {
        return [
            ['foobar'],
            ['foo-bar'],
     ...
     */
    public function testInvalidAssetsConfiguration(array $assetConfig, string $expectedMessage): void
    {
    ...
    public function provideInvalidAssetConfigurationTests(): \Generator
    {
        // helper to turn config into embedded package config
        $createPackageConfig = static fn(array $packageConfig): array => [
     ...
     */
    public function testValidLockConfiguration(string|array|null $lockConfig, array $processedConfig): void
    {
        $processor = new Processor();
        $configuration = new Configuration(true);
        $config = $processor->processConfiguration($configuration, [
    ...
    public function provideValidLockConfigurationTests(): \Generator
    {
