...
class TranslatorTest extends TestCase
{
     ...
     */
    public function testTransWithoutCachingOmittingLocale(): void
    {
        $translator = $this->getTranslator($this->getLoader(), [], 'loader', '\\' . \Symfony\Bundle\FrameworkBundle\Translation\Translator::class, null);
     ...
     * @expectedDeprecation The "Symfony\Bundle\FrameworkBundle\Translation\Translator::__construct()" method takes the default locale as the 3rd argument since Symfony 3.3. Not passing it is deprecated and will trigger an error in 4.0.
     */
    public function testTransWithCachingOmittingLocale(): void
    {
        // prime the cache
        $translator = $this->getTranslator($this->getLoader(), ['cache_dir' => $this->tmpDir], 'loader', '\\' . \Symfony\Bundle\FrameworkBundle\Translation\Translator::class, null);
        $translator->setLocale('fr');
        $translator->setFallbackLocales(['en', 'es', 'pt-PT', 'pt_BR', 'fr.UTF-8', 'sr@latin']);
        ...
        $translator = $this->getTranslator($loader, ['cache_dir' => $this->tmpDir], 'loader', '\\' . \Symfony\Bundle\FrameworkBundle\Translation\Translator::class, null);
        $translator->setLocale('fr');
        $translator->setFallbackLocales(['en', 'es', 'pt-PT', 'pt_BR', 'fr.UTF-8', 'sr@latin']);
     ...
     * @expectedDeprecation The "Symfony\Bundle\FrameworkBundle\Translation\Translator::__construct()" method takes the default locale as the 3rd argument since Symfony 3.3. Not passing it is deprecated and will trigger an error in 4.0.
     */
    public function testTransWithCachingWithInvalidLocaleOmittingLocale(): void
    {
        $this->expectException('InvalidArgumentException');
        $loader = $this->getMockBuilder('Symfony\Component\Translation\Loader\LoaderInterface')->getMock();
        $translator = $this->getTranslator($loader, ['cache_dir' => $this->tmpDir], 'loader', '\\' . \Symfony\Bundle\FrameworkBundle\Tests\Translation\TranslatorWithInvalidLocale::class, null);
     ...
     * @expectedDeprecation The "Symfony\Bundle\FrameworkBundle\Translation\Translator::__construct()" method takes the default locale as the 3rd argument since Symfony 3.3. Not passing it is deprecated and will trigger an error in 4.0.
     */
    public function testLoadResourcesWithoutCachingOmittingLocale(): void
    {
        ...
        $translator = $this->getTranslator($loader, ['resource_files' => $resourceFiles], 'yml', '\\' . \Symfony\Bundle\FrameworkBundle\Translation\Translator::class, null);
        $translator->setLocale('fr');
     ...
     * @expectedDeprecation The "Symfony\Bundle\FrameworkBundle\Translation\Translator::__construct()" method takes the default locale as the 3rd argument since Symfony 3.3. Not passing it is deprecated and will trigger an error in 4.0.
     */
    public function testGetDefaultLocaleOmittingLocale(): void
    {
     ...
     * @group legacy
     */
    public function testGetDefaultLocaleOmittingLocaleWithPsrContainer(): void
    {
        $this->expectException('InvalidArgumentException');
     ...
     * @expectedDeprecation The "Symfony\Bundle\FrameworkBundle\Translation\Translator::__construct()" method takes the default locale as the 3rd argument since Symfony 3.3. Not passing it is deprecated and will trigger an error in 4.0.
     */
    public function testWarmupOmittingLocale(): void
    {
        $loader = new YamlFileLoader();
        $resourceFiles = [
            'fr' => [
        ...
        // prime the cache
        $translator = $this->getTranslator($loader, ['cache_dir' => $this->tmpDir, 'resource_files' => $resourceFiles], 'yml', '\\' . \Symfony\Bundle\FrameworkBundle\Translation\Translator::class, null);
    ...
    public function testTransWithCachingWithInvalidLocale(): void
    {
        ...
        $loader = $this->getMockBuilder('Symfony\Component\Translation\Loader\LoaderInterface')->getMock();
        $translator = $this->getTranslator($loader, ['cache_dir' => $this->tmpDir], 'loader', '\\' . \Symfony\Bundle\FrameworkBundle\Tests\Translation\TranslatorWithInvalidLocale::class);
    ...
    public function testResourceFilesOptionLoadsBeforeOtherAddedResources(bool $debug, bool $enableCache): void
    {
    ...
    public function getDebugModeAndCacheDirCombinations(): array
    {
        return [
            [false, false],
            [true, false],
    ...
    protected function getCatalogue($locale, $messages, $resources = []): \Symfony\Component\Translation\MessageCatalogue
    {
    ...
    public function getTranslator($loader, $options = [], $loaderFomat = 'loader', $translatorClass = '\\' . \Symfony\Bundle\FrameworkBundle\Translation\Translator::class, $defaultLocale = 'en')
    {
    ...
    private function createTranslator($loader, $options, $translatorClass = '\\' . \Symfony\Bundle\FrameworkBundle\Translation\Translator::class, $loaderFomat = 'loader', $defaultLocale = 'en')
    {
