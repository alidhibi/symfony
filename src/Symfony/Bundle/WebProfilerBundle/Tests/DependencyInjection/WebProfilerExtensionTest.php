...
class WebProfilerExtensionTest extends TestCase
{
    ...
    public static function assertSaneContainer(Container $container, $message = '', array $knownPrivates = []): void
    {
        $errors = [];
    ...
    private function getCompiledContainer(): ?\Symfony\Component\DependencyInjection\ContainerBuilder
    {
