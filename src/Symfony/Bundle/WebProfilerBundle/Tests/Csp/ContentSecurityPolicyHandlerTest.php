...
class ContentSecurityPolicyHandlerTest extends TestCase
{
     ...
     */
    public function testGetNonces(string $nonce, array $expectedNonce, Request $request, Response $response): void
    {
     ...
     */
    public function testOnKernelResponse(string $nonce, array $expectedNonce, Request $request, Response $response, array $expectedCsp): void
    {
        $cspHandler = new ContentSecurityPolicyHandler($this->mockNonceGenerator($nonce));
    ...
    public function provideRequestAndResponses(): array
    {
    ...
    public function provideRequestAndResponsesForOnKernelResponse(): array
    {
        $nonce = bin2hex(random_bytes(16));
    ...
    private function createRequest(array $headers = []): \Symfony\Component\HttpFoundation\Request
    {
        $request = new Request();
    ...
    private function createResponse(array $headers = []): \Symfony\Component\HttpFoundation\Response
    {
    ...
    private function mockNonceGenerator(string $value)
    {
