...
{
    private ?\Symfony\Component\HttpKernel\DataCollector\Util\ValueExporter $valueExporter = null;

    private readonly \Symfony\Component\VarDumper\Dumper\HtmlDumper $dumper;
    ...
    {
        $profilerDump = fn(Environment $env, $value, $maxDepth = 0) => $value instanceof Data ? $this->dumpData($env, $value, $maxDepth) : twig_escape_filter($env, $this->dumpValue($value));

        return [
            new TwigFunction('profiler_dump', $profilerDump, ['is_safe' => ['html'], 'needs_environment' => true]),
            new TwigFunction('profiler_dump_log', fn(\Twig\Environment $env, $message, ?\Symfony\Component\VarDumper\Cloner\Data $context = null) => $this->dumpLog($env, $message, $context), ['is_safe' => ['html'], 'needs_environment' => true]),
        ];
    }
    ...
    public function dumpLog(Environment $env, $message, Data $context = null)
    {
        ...
        if (!$context instanceof \Symfony\Component\VarDumper\Cloner\Data || false === strpos($message, '{')) {
    ...
    public function dumpValue($value)
    {
        ...
        if (!$this->valueExporter instanceof \Symfony\Component\HttpKernel\DataCollector\Util\ValueExporter) {
