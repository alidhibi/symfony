...
class WebDebugToolbarListener implements EventSubscriberInterface
{
    ...
    private ?\Symfony\Bundle\WebProfilerBundle\Csp\ContentSecurityPolicyHandler $cspHandler = null;
    ...
    public function onKernelResponse(FilterResponseEvent $event): void
    {
        ...
        $nonces = $this->cspHandler instanceof \Symfony\Bundle\WebProfilerBundle\Csp\ContentSecurityPolicyHandler ? $this->cspHandler->updateResponseHeaders($request, $response) : [];
