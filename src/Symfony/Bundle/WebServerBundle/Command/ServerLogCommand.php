...
{
    private static array $bgColor = ['black', 'blue', 'cyan', 'green', 'magenta', 'red', 'white', 'yellow'];

    private ?\Symfony\Component\ExpressionLanguage\ExpressionLanguage $el = null;

    private ?\Symfony\Bridge\Monolog\Handler\ConsoleHandler $handler = null;
...
EOF
    ...
    private function displayLog(OutputInterface $output, $clientId, array $record): void
    {
