...
class SecurityDataCollector extends DataCollector implements LateDataCollectorInterface
{
    ...
    private ?\Symfony\Component\Security\Http\Logout\LogoutUrlGenerator $logoutUrlGenerator = null;

    private ?\Symfony\Component\Security\Core\Authorization\AccessDecisionManagerInterface $accessDecisionManager = null;

    private ?\Symfony\Component\Security\Http\FirewallMapInterface $firewallMap = null;

    private ?\Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener $firewall = null;
    ...
    {
        if (!$this->tokenStorage instanceof \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorageInterface) {
            $this->data = [
                'enabled' => false,
                'authenticated' => false,
                'impersonated' => false,
                ...
                'roles' => [],
                'inherited_roles' => [],
                'supports_role_hierarchy' => $this->roleHierarchy instanceof \Symfony\Component\Security\Core\Role\RoleHierarchyInterface,
            ];
            ...
            $logoutUrl = null;
            try {
                if ($this->logoutUrlGenerator instanceof \Symfony\Component\Security\Http\Logout\LogoutUrlGenerator) {
            ...
            $extractRoles = static function ($role) {
        ...
        $this->data['listeners'] = [];
        if ($this->firewall instanceof \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener) {
