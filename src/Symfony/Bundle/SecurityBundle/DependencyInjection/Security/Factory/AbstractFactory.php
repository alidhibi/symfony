...
abstract class AbstractFactory implements SecurityFactoryInterface
{
    ...
    protected function createListener($container, string $id, $config, $userProvider)
    {
    ...
    protected function createAuthenticationSuccessHandler($container, $id, array $config)
    {
    ...
    protected function createAuthenticationFailureHandler($container, $id, array $config)
    {
