...
class GuardAuthenticationFactoryTest extends TestCase
{
    ...
    public function getValidConfigurationTests(): array
    {
        return [
            // completely basic
            [
    ...
    public function getInvalidConfigurationTests(): array
    {
        return [
            // testing not empty
            [
    ...
    private function executeCreate(array $config, ?string $defaultEntryPointId): array
    {
