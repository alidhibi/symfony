...
class AbstractFactoryTest extends TestCase
{
     ...
     */
    public function testDefaultFailureHandler(?string $serviceId, bool $defaultHandlerInjection): void
    {
        $options = [
            'remember_me' => true,
            'login_path' => '/bar',
    ...
    public function getFailureHandlers(): array
    {
        return [
            [null, true],
     ...
     */
    public function testDefaultSuccessHandler(?string $serviceId, bool $defaultHandlerInjection): void
    {
        $options = [
            'remember_me' => true,
    ...
    public function getSuccessHandlers(): array
    {
        return [
            [null, true],
    ...
    protected function callFactory($id, $config, $userProviderId, $defaultEntryPointId): array
    {
