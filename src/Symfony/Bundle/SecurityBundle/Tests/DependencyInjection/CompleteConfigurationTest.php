...
abstract class CompleteConfigurationTest extends TestCase
{
     ...
     */
    public function testRolesHierarchyWithAcl(): void
    {
    ...
    public function testUserProviders(): void
    {
        ...
        $providers = array_values(array_filter($container->getServiceIds(), static fn($key): bool => 0 === strpos($key, 'security.user.provider.concrete')));
     ...
     * @group legacy
     */
    public function testFirewallsWithDigest(): void
    {
     ...
     * @expectedDeprecation The "security.acl" configuration key is deprecated since Symfony 3.4 and will be removed in 4.0. Install symfony/acl-bundle and use the "acl" key instead.
     */
    public function testCustomAclProvider(): void
    {
    ...
    protected function getContainer(string $file)
    {
