...
class SecurityExtensionTest extends TestCase
{
    ...
    public function testGuardHandlerIsPassedStatelessFirewalls(): void
    {
        $container = $this->getRawContainer();
     ...
     */
    public function testConfiguresLogoutOnUserChangeForContextListenersCorrectly(): void
    {
        $container = $this->getRawContainer();
     ...
     * @group legacy
     */
    public function testThrowsIfLogoutOnUserChangeDifferentForSharedContext(): void
    {
        $this->expectException('Symfony\Component\Config\Definition\Exception\InvalidConfigurationException');
     ...
     */
    public function testDeprecationForAmbiguousProvider(): void
    {
        $container = $this->getRawContainer();
    ...
    public function testPerListenerProviderWithRememberMe(): void
    {
        $container = $this->getRawContainer();
        $container->loadFromExtension('security', [
            'providers' => [
    ...
    protected function getRawContainer(): \Symfony\Component\DependencyInjection\ContainerBuilder
    {
