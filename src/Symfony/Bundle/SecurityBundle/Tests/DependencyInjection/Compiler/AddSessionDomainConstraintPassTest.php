...
class AddSessionDomainConstraintPassTest extends TestCase
{
    ...
    private function createContainer(?array $sessionStorageOptions): \Symfony\Component\DependencyInjection\ContainerBuilder
    {
        ...
        $ext->load(['framework' => ['csrf_protection' => false]], $container);
