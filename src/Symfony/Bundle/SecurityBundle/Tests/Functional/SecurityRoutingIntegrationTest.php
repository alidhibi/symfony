...
class SecurityRoutingIntegrationTest extends AbstractWebTestCase
{
     ...
     */
    public function testRoutingErrorIsNotExposedForProtectedResourceWhenAnonymous(string $config): void
    {
     ...
     * @dataProvider getConfigs
     */
    public function testRoutingErrorIsExposedWhenNotProtected(string $config): void
    {
        $client = $this->createClient(['test_case' => 'StandardFormLogin', 'root_config' => $config]);
     ...
     * @dataProvider getConfigs
     */
    public function testRoutingErrorIsNotExposedForProtectedResourceWhenLoggedInWithInsufficientRights(string $config): void
    {
        $client = $this->createClient(['test_case' => 'StandardFormLogin', 'root_config' => $config]);
     ...
     * @dataProvider getConfigs
     */
    public function testSecurityConfigurationForSingleIPAddress(string $config): void
    {
     ...
     * @dataProvider getConfigs
     */
    public function testSecurityConfigurationForMultipleIPAddresses(string $config): void
    {
     ...
     * @dataProvider getConfigs
     */
    public function testSecurityConfigurationForExpression(string $config): void
    {
    ...
    private function assertAllowed($client, string $path): void
    {
        $client->request('GET', $path);
        $this->assertEquals(404, $client->getResponse()->getStatusCode());
    }

    private function assertRestricted($client, string $path): void
    {
        $client->request('GET', $path);
