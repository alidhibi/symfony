...
{
    final const OBJECT_CLASS = 'Symfony\Bundle\SecurityBundle\Tests\Functional\Bundle\AclBundle\Entity\Car';

    final const SECURITY_CLASS = 'Symfony\Component\Security\Core\User\User';

    public function testSetAclUser(): void
    {
        $objectId = 1;
    ...
    public function testSetAclRole(): void
    {
        $objectId = 1;
    ...
    public function testSetAclClassScope(): void
    {
        $objectId = 1;
        $grantedPermission = 'VIEW';
        $role = 'ROLE_USER';
    ...
    private function getApplication(): \Symfony\Bundle\FrameworkBundle\Console\Application
    {
