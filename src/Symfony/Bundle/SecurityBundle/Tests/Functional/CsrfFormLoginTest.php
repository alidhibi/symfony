...
class CsrfFormLoginTest extends AbstractWebTestCase
{
     ...
     */
    public function testFormLoginAndLogoutWithCsrfTokens(string $config): void
    {
     ...
     * @dataProvider getConfigs
     */
    public function testFormLoginWithInvalidCsrfToken(string $config): void
    {
        $client = $this->createClient(['test_case' => 'CsrfFormLogin', 'root_config' => $config]);
     ...
     * @dataProvider getConfigs
     */
    public function testFormLoginWithCustomTargetPath(string $config): void
    {
        $client = $this->createClient(['test_case' => 'CsrfFormLogin', 'root_config' => $config]);
     ...
     * @dataProvider getConfigs
     */
    public function testFormLoginRedirectsToProtectedResourceAfterLogin(string $config): void
    {
        $client = $this->createClient(['test_case' => 'CsrfFormLogin', 'root_config' => $config]);
