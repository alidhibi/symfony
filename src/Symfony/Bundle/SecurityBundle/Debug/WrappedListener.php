...
final class WrappedListener implements ListenerInterface
{
    ...
    private readonly \Symfony\Component\Security\Http\Firewall\ListenerInterface $listener;

    private $time;

    private \Symfony\Component\VarDumper\Caster\ClassStub|string|null $stub = null;

    private static ?bool $hasVarDumper = null;
    ...
    public function getWrappedListener(): \Symfony\Component\Security\Http\Firewall\ListenerInterface
    {
