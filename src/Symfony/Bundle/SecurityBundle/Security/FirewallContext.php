...
class FirewallContext
{
    ...
    private ?\Symfony\Component\Security\Http\Firewall\ExceptionListener $exceptionListener = null;

    private $logoutListener;

    private ?\Symfony\Bundle\SecurityBundle\Security\FirewallConfig $config = null;
    ...
    public function getConfig(): ?\Symfony\Bundle\SecurityBundle\Security\FirewallConfig
    {
        return $this->config;
    }
    ...
    public function getExceptionListener(): ?\Symfony\Component\Security\Http\Firewall\ExceptionListener
    {
