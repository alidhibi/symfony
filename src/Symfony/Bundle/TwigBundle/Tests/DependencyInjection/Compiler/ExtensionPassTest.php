...
class ExtensionPassTest extends TestCase
{
    public function testProcessDoesNotDropExistingFileLoaderMethodCalls(): void
    {
        ...
        $container->register('templating', '\\' . \Symfony\Bundle\TwigBundle\TwigEngine::class);
        ...
        $filesystemLoader = new Definition('\\' . \Symfony\Bundle\TwigBundle\Loader\FilesystemLoader::class);
